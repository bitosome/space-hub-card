 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ji=i=>!(i=>null===i||"object"!=typeof i&&"function"!=typeof i)(i)&&"function"==typeof i.then,yi=1073741823;const zi=ri(class extends ui{constructor(){super(...arguments),this._$C_t=yi,this._$Cwt=[],this._$Cq=new Di(this),this._$CK=new hi}render(...i){var e;return null!==(e=i.find((i=>!ji(i))))&&void 0!==e?e:Z}update(i,e){const t=this._$Cwt;let a=t.length;this._$Cwt=e;const n=this._$Cq,o=this._$CK;this.isConnected||this.disconnected();for(let i=0;i<e.length&&!(i>this._$C_t);i++){const c=e[i];if(!ji(c))return this._$C_t=i,c;i<a&&c===t[i]||(this._$C_t=yi,a=0,Promise.resolve(c).then((async i=>{for(;o.get();)await o.get();const e=n.deref();if(void 0!==e){const t=e._$Cwt.indexOf(c);t>-1&&t<e._$C_t&&(e._$C_t=t,e.setValue(i))}})))}return Z}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),pi=i=>e=>"function"==typeof e?((i,e)=>(customElements.define(i,e),e))(i,e):((i,e)=>{const{kind:t,elements:a}=e;return{kind:t,elements:a,finisher(e){customElements.define(i,e)}}})(i,e)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var bi;null===(bi=window.HTMLSlotElement)||void 0===bi||bi.prototype.assignedElements;var Ti="[^\\s]+";function Oi(i,e){for(var t=[],a=0,n=i.length;a<n;a++)t.push(i[a].substr(0,e));return t}var xi=function(i){return function(e,t){var a=t[i].map((function(i){return i.toLowerCase()})),n=a.indexOf(e.toLowerCase());return n>-1?n:null}};function vi(i){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var a=0,n=e;a<n.length;a++){var o=n[a];for(var c in o)i[c]=o[c]}return i}var Si=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Li=["January","February","March","April","May","June","July","August","September","October","November","December"],ki=Oi(Li,3),Ci={dayNamesShort:Oi(Si,3),dayNames:Si,monthNamesShort:ki,monthNames:Li,amPm:["am","pm"],DoFn:function(i){return i+["th","st","nd","rd"][i%10>3?0:(i-i%10!=10?1:0)*i%10]}},Yi=(vi({},Ci),function(i){return+i-1}),fi=[null,"[1-9]\\d?"],_i=[null,Ti],Qi=["isPm",Ti,function(i,e){var t=i.toLowerCase();return t===e.amPm[0]?0:t===e.amPm[1]?1:null}],Ui=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(i){var e=(i+"").match(/([+-]|\d\d)/gi);if(e){var t=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?t:-t}return 0}];xi("monthNamesShort"),xi("monthNames");var Ei,Zi;!function(){try{(new Date).toLocaleDateString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(i){return"RangeError"===i.name}}(),function(i){i.language="language",i.system="system",i.comma_decimal="comma_decimal",i.decimal_comma="decimal_comma",i.space_comma="space_comma",i.none="none"}(Ei||(Ei={})),function(i){i.language="language",i.system="system",i.am_pm="12",i.twenty_four="24"}(Zi||(Zi={}));var Gi=function(i,e,t,a){a=a||{},t=null==t?{}:t;var n=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return n.detail=t,i.dispatchEvent(n),n},Wi=new Set(["call-service","divider","section","weblink","cast","select"]),Pi={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},$i=function(i,e){void 0===e&&(e=!1);var t=function(i,e){return a("hui-error-card",{type:"error",error:i,config:e})},a=function(i,e){var a=window.document.createElement(i);try{a.setConfig(e)}catch(a){return console.error(i,a),t(a.message,e)}return a};if(!i||"object"!=typeof i||!e&&!i.type)return t("No type defined",i);var n=i.type;if(n&&n.startsWith("custom:"))n=n.substr("custom:".length);else if(e)if(Wi.has(n))n="hui-"+n+"-row";else{if(!i.entity)return t("Invalid config given.",i);var o=i.entity.split(".",1)[0];n="hui-"+(Pi[o]||"text")+"-entity-row"}else n="hui-"+n+"-card";if(customElements.get(n))return a(n,i);var c=t("Custom element doesn't exist: "+i.type+".",i);c.style.display="None";var r=setTimeout((function(){c.style.display=""}),2e3);return customElements.whenDefined(i.type).then((function(){clearTimeout(r),Gi(c,"ll-rebuild",{},c)})),c};function Ri(i){return JSON.parse(JSON.stringify(i))}const Vi=new Set(["more-info","toggle","perform-action","navigate","url","assist","none","fire-dom-event","call-service"]),Fi=i=>!!i&&"object"==typeof i&&!Array.isArray(i),Bi=i=>!!((null==i?void 0:i.tap_action)||(null==i?void 0:i.hold_action)||(null==i?void 0:i.double_tap_action)),Hi=i=>{if(null==i||!1===i)return;if(!0===i)return!0;if("string"==typeof i){const e=i.trim();return!e||{text:e}}if(!Fi(i))return;const e={};if("string"==typeof i.text&&i.text.trim()&&(e.text=i.text),"string"==typeof i.title&&i.title.trim()&&(e.title=i.title),"string"==typeof i.confirm_text&&i.confirm_text.trim()&&(e.confirm_text=i.confirm_text),"string"==typeof i.dismiss_text&&i.dismiss_text.trim()&&(e.dismiss_text=i.dismiss_text),Array.isArray(i.exemptions)){const t=i.exemptions.filter((i=>!!i&&"object"==typeof i&&"string"==typeof i.user)).map((i=>({user:i.user})));t.length&&(e.exemptions=t)}return!Object.keys(e).length||e},Ji=i=>{if(Fi(i)&&"string"==typeof i.action&&Vi.has(i.action)){if("call-service"===i.action||"perform-action"===i.action){return Object.assign(Object.assign({},i),{action:"perform-action",perform_action:"string"==typeof i.perform_action?i.perform_action:"string"==typeof i.service?i.service:void 0,data:Fi(i.data)?i.data:Fi(i.service_data)?i.service_data:void 0,target:Fi(i.target)?i.target:void 0,confirmation:Hi(i.confirmation)})}return Object.assign(Object.assign({},i),{confirmation:Hi(i.confirmation)})}},Xi=["lock","door","presence","illuminance","gate","sliding_gate","smart_plug","custom"],Ki=["switch","smart_plug","lock"],qi=["static","pulse","none"],ie=["more-info","toggle","perform-action","navigate","url","assist","none"],ee="M4,12L5.41,13.41L11,7.83V20H13V7.83L18.59,13.42L20,12L12,4L4,12Z",te="M4,12L5.41,10.59L11,16.17V4H13V16.17L18.59,10.58L20,12L12,20L4,12Z",ae="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";let ne=class extends ni{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.type="text",this.disabled=!1}_onInput(i){i.stopPropagation(),this.disabled||(this.value=i.currentTarget.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}render(){return U`
    ...
    `:U``}_renderYamlEditor(){return U`
      ...
      ></ha-yaml-editor>
      ${this._yamlError?U`<div class="yaml-error">${this._yamlError}</div>`:G}
    `}_yamlChanged(i){i.stopPropagation();const e=i.detail.value;e&&"object"==typeof e?(this._yamlError="",this._config=Ri(e),this._fireConfigChanged()):this._yamlError="Invalid YAML"}_renderVisualEditor(){return U`
    ...
    `}_renderWeatherConfig(i,e){var t,a,n,o,c,r,s,l,M;const g=i||{};return U`
      <ha-expansion-panel outlined .header=${"Weather Tile"}>
        <div class="section-content">
          ${!!i?U`
            <div class="side-by-side">
              ${this._renderEntityField("Weather Entity",`${e}.entity`,g.entity,{domain:"weather"})}
            </div>
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="18"
                max="56"
                .value=${String(null!==(t=g.temp_size)&&void 0!==t?t:"")}
              ...
              <space-hub-textfield
                ...
                min="28"
                max="160"
                .value=${String(null!==(a=g.icon_size)&&void 0!==a?a:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                .value=${String(null!==(n=g.icon_offset_x)&&void 0!==n?n:"")}
              ...
              <space-hub-textfield
                ...
                type="number"
                .value=${String(null!==(o=g.icon_offset_y)&&void 0!==o?o:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                min="0"
                .value=${String(null!==(c=g.stale_minutes)&&void 0!==c?c:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(r=g.conditions_icon_size)&&void 0!==r?r:"")}
              ...
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(s=g.daily_icon_size)&&void 0!==s?s:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="1"
                max="72"
                .value=${String(null!==(l=g.forecast_slots)&&void 0!==l?l:"")}
              ...
              <space-hub-textfield
                ...
                min="82"
                max="260"
                .value=${String(null!==(M=g.graph_height)&&void 0!==M?M:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.graph_height`,Number.isFinite(t)&&t>0?t:void 0)}}
              ></space-hub-textfield>
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("Temperature Sensor",`${e}.temp_sensor`,g.temp_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Humidity Sensor",`${e}.humidity_sensor`,g.humidity_sensor,{domain:"sensor"})}
            </div>
            ${this._renderEntityField("Feels Like Sensor",`${e}.feels_like_sensor`,g.feels_like_sensor,{domain:"sensor"})}
            ${this._renderMetricsConfig(g.metrics&&g.metrics.length?g.metrics:this._defaultWeatherMetrics(g),e)}
            ${this._renderChipsConfig(g.chips||[],e)}
    ...
    `}_defaultWeatherMetrics(i){const e=[{entity:i.wind_speed_sensor,name:"Wind"},{entity:i.wind_gust_sensor,name:"Gust"},{entity:i.temp_min_24h_sensor,name:"24h Min"},{entity:i.temp_max_24h_sensor,name:"24h Max"},{entity:i.uv_sensor,name:"UV"},{entity:i.solar_lux_sensor,name:"Solar"},{entity:i.pressure_sensor,name:"Pressure"}].filter((i=>i.entity));return(i.rain_state_sensor||i.rain_rate_sensor)&&e.splice(4,0,{type:"rain",name:"Rain",rain_state_sensor:i.rain_state_sensor,rain_rate_sensor:i.rain_rate_sensor,rain_rate_threshold:i.rain_rate_threshold}),e}_renderMetricItem(i,e,t,a){var n;const o=i=>{const n=[...this._getNestedValue(e)||t];n[a]=Object.assign(Object.assign({},n[a]),i),this._valueChanged(e,n)},c="rain"===i.type,r=c?this._entitySummary(i.rain_state_sensor||i.rain_rate_sensor):this._entitySummary(i.entity);return U`
      <div class="sub-item">
        <div class="sub-item-header">
          ...
          <div class="sub-item-heading">
            <span class="sub-item-title">${c?"Rain":"Metric"} ${a+1}</span>
            <span class="sub-item-meta">${r}</span>
          </div>
          <ha-icon-button
            .path=${"M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z"}
    ...
    `}_renderSwitchItem(i,e,t,a,n){const o=Hi(null==i?void 0:i.confirmation),c=void 0!==o,r=o&&"object"==typeof o&&o.title||"",s=o&&"object"==typeof o&&o.text||"",l=o&&"object"==typeof o&&o.confirm_text||"",M=o&&"object"==typeof o&&o.dismiss_text||"",g=`${e}.confirmation`;return U`
      <div class="sub-item">
        <div class="sub-item-header">
          <div class="sub-item-heading">
    ...
    `}_renderActionConfig(i,e,t){const a=Ji(t),n=!!a,o=Hi(null==a?void 0:a.confirmation),c=void 0!==o,r=o&&"object"==typeof o&&o.title||"",s=o&&"object"==typeof o&&o.text||"",l=o&&"object"==typeof o&&o.confirm_text||"",M=o&&"object"==typeof o&&o.dismiss_text||"";return U`
  ...
  `}const de={weak:"rgba(255,193,7,0.16)",strong:"rgba(255,193,7,0.30)"},ue={weak:"rgba(0,200,83,0.16)",strong:"rgba(0,200,83,0.30)"},De={weak:"rgba(229,57,53,0.16)",strong:"rgba(229,57,53,0.30)"};const he={weak:"rgba(255,112,67,0.12)",strong:"rgba(255,112,67,0.26)"};function je(i,e="static",t=!1){if(!i||"none"===e||!t)return{style:"",overlay:G};return{style:`${`--pulse-weak: ${i.weak}; --pulse-strong: ${i.strong};`} ${"pulse"===e?"animation: glowPulse 2.4s ease-in-out infinite;":""} ${`box-shadow: 0 18px 40px var(--pulse-strong, ${i.strong}), 0 6px 18px var(--pulse-weak, ${i.weak});`}`,overlay:U`<div class="glow-overlay" aria-hidden="true"></div>`}}function ye(i,e){var t;const a=(null==e?void 0:e.icon)||"mdi:sofa-outline",n=(null==e?void 0:e.name)||"",o="function"==typeof(null==i?void 0:i._fmt2)?i._fmt2(null==e?void 0:e.temp_sensor,2,"°"):"—°",c="function"==typeof(null==i?void 0:i._fmt2)?i._fmt2(null==e?void 0:e.humidity_sensor,2,"%"):"—%",r=!(!(null==e?void 0:e.double_tap_action)&&!(null===(t=null==i?void 0:i._config)||void 0===t?void 0:t.double_tap_action)),s=!!(null==e?void 0:e.light_group_entity),l=(null==e?void 0:e.light_group_entity)||(null==e?void 0:e.tap_entity)||(null==e?void 0:e.entity),M=s&&"function"==typeof(null==i?void 0:i._isOn)&&i._isOn(l),g=(null==e?void 0:e.light_group_entity)||(null==e?void 0:e.tap_entity)||(null==e?void 0:e.entity),I=(null==e?void 0:e.glow_mode)||"static",N=!!(null==e?void 0:e.light_group_entity)&&M&&"none"!==I,d=de,{style:u,overlay:D}=je(d,I,N),h="chip main-light-chip "+(M?"on":"off"),j=Array.isArray(null==e?void 0:e.chips)?e.chips:[],y=j.find((i=>"illuminance"===String((null==i?void 0:i.type)||"").toLowerCase())),z=j.filter((i=>"illuminance"!==String((null==i?void 0:i.type)||"").toLowerCase())).map((e=>Ne(i,e))),p=y?function(i,e){const t=(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity),a=(null==e?void 0:e.icon)||"mdi:brightness-5",n="function"==typeof(null==i?void 0:i._fmt2)?i._fmt2(t,0," lx"):"— lx";return U`
  ...
  `}(i,y):G;return U`
    <div class="tile-wrap">
      ...
      <ha-control-button
        ...
        .actionHandler=${Me({hasHold:!0,hasDoubleClick:r})}
  ...
  `}const ze={barometer:"data:image/svg+xml;base64,","clear-day":"data:image/svg+xml;base64,","clear-night":"data:image/svg+xml;base64,",cloudy:"data:image/svg+xml;base64,",drizzle:"data:image/svg+xml;base64,",fog:"data:image/svg+xml;base64,",hail:"data:image/svg+xml;base64,","not-available":"data:image/svg+xml;base64,","partly-cloudy-day":"data:image/svg+xml;base64,","partly-cloudy-night":"data:image/svg+xml;base64,","pressure-high":"data:image/svg+xml;base64,",rain:"data:image/svg+xml;base64,",raindrop:"data:image/svg+xml;base64,",raindrops:"data:image/svg+xml;base64,",sleet:"data:image/svg+xml;base64,",snow:"data:image/svg+xml;base64,","sun-hot":"data:image/svg+xml;base64,","thermometer-colder":"data:image/svg+xml;base64,","thermometer-warmer":"data:image/svg+xml;base64,",thunderstorms:"data:image/svg+xml;base64,","thunderstorms-rain":"data:image/svg+xml;base64,","uv-index":"data:image/svg+xml;base64,","weather-alarm":"data:image/svg+xml;base64,",wind:"data:image/svg+xml;base64,","wind-alert":"data:image/svg+xml;base64,"},pe=new Set(["","unknown","unavailable"]),Ae=["temperature","precipitation_probability"],me={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability",rain:"precipitation",precipitation:"precipitation",humidity:"humidity",hum:"humidity",wind:"wind_speed",wind_speed:"wind_speed",gust:"wind_gust_speed",wind_gust:"wind_gust_speed",wind_gust_speed:"wind_gust_speed",uv:"uv_index",uv_index:"uv_index",cloud:"cloud_coverage",clouds:"cloud_coverage",cloud_coverage:"cloud_coverage"},we={"clear-night":"clear-night",cloudy:"cloudy",exceptional:"weather-alarm",fog:"fog",hail:"hail",lightning:"thunderstorms","lightning-rainy":"thunderstorms-rain",partlycloudy:"partly-cloudy-day",pouring:"rain",rainy:"rain",snowy:"snow","snowy-rainy":"sleet",sunny:"clear-day",windy:"wind","windy-variant":"wind-alert"};function be(i){return i<=0?"#3aa7ff":i<=8?"#50c5d8":i<=15?"#9bd57b":i<=22?"#ffd34a":i<=28?"#ff9d24":"#ff5d38"}function Te(i,e){var t;if(e&&(null==i?void 0:i.hass))return null===(t=i.hass.states)||void 0===t?void 0:t[e]}function Oe(i){const e=void 0===(null==i?void 0:i.state)||null===(null==i?void 0:i.state)?"":String(i.state);return pe.has(e.toLowerCase())?"":e}function xe(i,e){const t=Oe(Te(i,e));if(!t)return;const a=Number(t);return Number.isFinite(a)?a:void 0}function ve(i,e,t=!1){if(null==i||""===i)return"—";const a=Number(i);return Number.isFinite(a)?t&&Math.abs(a)>=1e3?`${(a/1e3).toFixed(1)}k`:a.toFixed(e):String(i)}function Se(i,e){var t;const a=Te(i,e),n=Oe(a);if(!n)return"—";const o=(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.unit_of_measurement)||"",c=Number(n);if(!Number.isFinite(c))return o?`${n} ${o}`:n;const r=ve(c,Number.isInteger(c)?0:1);return o?`${r} ${o}`:r}function Le(i,e){const t=xe(i,e);return void 0===t?"—°":`${t.toFixed(1)}°`}function ke(i,e,t){const a=Number(i);if(Number.isFinite(a)&&!(a<=0))return Math.max(e,Math.min(t,a))}function Ce(i){if(!i)return"Weather";const e={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Storm rain","snowy-rainy":"Sleet","windy-variant":"Windy"};return e[i]?e[i]:i.replace(/[-_]/g," ").replace(/\b\w/g,(i=>i.toUpperCase()))}function Ye(i){return(i||"unknown").replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function fe(i){return we[i]||"partly-cloudy-day"}function _e(i,e,t,a="img"){return"object"===a?U`
    ...
    <img
      ...
      draggable="false"
    />
  `}function Qe(i,e){return i&&i.includes(":")?i:e}function Ue(i,e){const t=function(i,e){const t=Number.isFinite(Number(e.rain_rate_threshold))?Number(e.rain_rate_threshold):0,a=xe(i,e.rain_rate_sensor);return void 0!==a?a>t:"on"===Oe(Te(i,e.rain_state_sensor)).toLowerCase()}(i,e),a=e.name||"Rain",n=e.rain_state_sensor||e.rain_rate_sensor,o=t?Qe(e.icon_active||e.icon,"mdi:weather-rainy"):Qe(e.icon_inactive||e.icon,"mdi:water-off-outline");let c;if(t){const t=function(i,e,t,a=!1){var n;const o=Te(i,e),c=Oe(o);if(!c)return"—";const r=(null===(n=null==o?void 0:o.attributes)||void 0===n?void 0:n.unit_of_measurement)||"",s=ve(c,t,a);return r?`${s} ${r}`:s}(i,e.rain_rate_sensor,1);c="—"===t?"Raining":t}else c="No rain";return{label:a,value:c,entity:n,stateEntity:n,active:t,mdi:o}}function Ee(i){return Array.isArray(i)?i.filter((i=>!!i&&"object"==typeof i)).map((i=>({condition:"string"==typeof i.condition?i.condition:void 0,datetime:"string"==typeof i.datetime?i.datetime:void 0,temperature:i.temperature,precipitation_probability:i.precipitation_probability,precipitation:i.precipitation,humidity:i.humidity,wind_speed:i.wind_speed,wind_gust_speed:i.wind_gust_speed,uv_index:i.uv_index,cloud_coverage:i.cloud_coverage,templow:i.templow}))):[]}function Ze(i,e){if(!e.datetime)return"";const t=new Date(e.datetime);if(Number.isNaN(t.getTime()))return"";const{locale:a,options:n}=function(i){var e;const t=null===(e=null==i?void 0:i.hass)||void 0===e?void 0:e.locale,a=String((null==t?void 0:t.time_format)||"").toLowerCase(),n={hour:"2-digit",minute:"2-digit"};return"12"===a&&(n.hour12=!0),"24"===a&&(n.hour12=!1),{locale:null==t?void 0:t.language,options:n}}(i);return new Intl.DateTimeFormat(a,n).format(t)}function Ge(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function We(i,e,t){const a=i.map(((i,t)=>({item:i,index:t,value:Ge(i,e)}))).filter((i=>void 0!==i.value));if(!a.length)return{points:[],min:0,max:1};const n=a.map((i=>i.value)),{min:o,max:c}=function(i,e){if("precipitation_probability"===i)return{min:0,max:100};let t=Math.min(...e),a=Math.max(...e);if("temperature"===i)t=5*Math.floor((t-2)/5),a=5*Math.ceil((a+2)/5);else{const i=Math.max(.18*(a-t),1);t=Math.max(0,t-i),a+=i}return a<=t&&(a=t+1),{min:t,max:a}}(e,n),r=t.width-t.left-t.right,s=t.height-t.top-t.bottom,l=a.map(((i,e)=>{const n=1===a.length?t.left+r/2:t.left+e/(a.length-1)*r,l=t.top+(c-i.value)/(c-o)*s;return Object.assign(Object.assign({},i),{x:n,y:l})}));return{points:l,min:o,max:c}}function Pe(i){return i<=0?[]:Array.from(new Set([0,Math.floor((i-1)/3),Math.floor(2*(i-1)/3),i-1])).filter((e=>e>=0&&e<i))}function $e(i){return i.replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Re(i){if(!i.length)return"";if(1===i.length)return`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;let e=`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;for(let t=0;t<i.length-1;t+=1){const a=i[t],n=i[t+1],o=i[t-1]||a,c=i[t+2]||n,r=a.x+(n.x-o.x)/6,s=a.y+(n.y-o.y)/6,l=n.x-(c.x-a.x)/6,M=n.y-(c.y-a.y)/6;e+=` C ${r.toFixed(2)} ${s.toFixed(2)}, ${l.toFixed(2)} ${M.toFixed(2)}, ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return e}function Ve(i,e){if(!i.length)return"";const t=i[0],a=i[i.length-1];return`${Re(i)} L ${a.x.toFixed(2)} ${e.toFixed(2)} L ${t.x.toFixed(2)} ${e.toFixed(2)} Z`}function Fe(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";return`${e.getFullYear()}-${`${e.getMonth()+1}`.padStart(2,"0")}-${`${e.getDate()}`.padStart(2,"0")}`}function Be(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function He(i,e,t){return Math.max(0,Math.min(100,(i-e)/(t-e)*100))}function Je(i){return ke(i.graph_height,82,260)||118}function Xe(i,e,t,a){const n=t.slice(0,7);if(!n.length)return G;const o=function(i){const e=new Map;return i.forEach(((i,t)=>{const a=Fe(i.datetime),n=Ge(i,"temperature");if(!a||void 0===n)return;const o={item:i,value:n,x:0,y:0,index:t},c=e.get(a)||{};(!c.low||n<c.low.value)&&(c.low=o),(!c.high||n>c.high.value)&&(c.high=o),e.set(a,c)})),e}(a),{min:c,max:r}=function(i,e){const t=[];if(i.forEach((i=>{const e=Be(i,"templow"),a=Be(i,"temperature");void 0!==e&&t.push(e),void 0!==a&&t.push(a)})),e.forEach((i=>{const e=Ge(i,"temperature");void 0!==e&&t.push(e)})),!t.length)return{min:0,max:1};let a=5*Math.floor((Math.min(...t)-2)/5),n=5*Math.ceil((Math.max(...t)+2)/5);return n<=a&&(n=a+1),{min:a,max:n}}(n,a),s=Fe((new Date).toISOString()),l=function(i,e){return xe(i,e.temp_sensor)}(i,e);return U`
    <section class="weather-daily-forecast">
      ...
      ${n.map((e=>{var t,a,n,M;const g=Fe(e.datetime),I=o.get(g),N=null!==(t=Be(e,"templow"))&&void 0!==t?t:null===(a=null==I?void 0:I.low)||void 0===a?void 0:a.value,d=null!==(n=Be(e,"temperature"))&&void 0!==n?n:null===(M=null==I?void 0:I.high)||void 0===M?void 0:M.value;if(void 0===N||void 0===d)return G;const u=He(N,c,r),D=He(d,c,r),h=Math.max(4,D-u),j=String(e.condition||""),y=Number(e.precipitation_probability),z=Number.isFinite(y)?`Rain ${Math.round(y)}%`:"",p=g===s&&void 0!==l?He(l,c,r):void 0;return U`
          <div class="weather-daily-row">
            <div class="weather-daily-day">
              <span class="weather-daily-day-name">${function(i,e){var t,a;if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";const o=Fe((new Date).toISOString()),c=new Date;c.setDate(c.getDate()+1);const r=Fe(e);return r===o?"Today":r===Fe(c.toISOString())?"Tomorrow":new Intl.DateTimeFormat(null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.locale)||void 0===a?void 0:a.language,{weekday:"long"}).format(n)}(i,e.datetime)}</span>
              <span class="weather-daily-date">${function(i,e){var t,a;if(!e)return"";const n=new Date(e);return Number.isNaN(n.getTime())?"":new Intl.DateTimeFormat(null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.locale)||void 0===a?void 0:a.language,{day:"numeric",month:"short"}).format(n)}(i,e.datetime)}</span>
            </div>
            <div class="weather-daily-condition">
              ${_e(fe(j),`weather-daily-icon weather-condition-${Ye(j)}`,Ce(j))}
              ${z?U`<span title="Chance of precipitation">${z}</span>`:G}
            </div>
            <div class="weather-daily-low">
              <span>${N.toFixed(0)}°</span>
              ${(null==I?void 0:I.low)?U`<small>${Ze(i,I.low.item)}</small>`:G}
            </div>
            <div class="weather-daily-range">
              <div class="weather-daily-track"></div>
              <div
                class="weather-daily-segment"
                style=${`left:${u.toFixed(1)}%;width:${h.toFixed(1)}%;background:linear-gradient(90deg, ${be(N)}, ${be(d)});`}
              ></div>
              ${void 0!==p?U`
            ...
            <div class="weather-daily-high">
              ...
              ${(null==I?void 0:I.high)?U`<small>${Ze(i,I.high.item)}</small>`:G}
            </div>
          </div>
        `}))}
    </section>
  `}function Ke(i,e){if(!e.length)return"";const t=e[0],a=e.slice(0,12).reduce(((i,e)=>{const t=Number(i.precipitation_probability)||0,a=Number(e.precipitation_probability)||0,n=Number(i.precipitation)||0,o=Number(e.precipitation)||0;return o>n||o===n&&a>t?e:i}),t),n=Number(a.precipitation_probability)||0,o=Number(a.precipitation)||0;if(n>=25||o>0){const e=a===t,c=Ze(i,a);let r;r=n>=80||o>=2?"Rain likely":n>=50||o>=.5?"Showers possible":"Slight chance of rain";const s=e?"shortly":c?`around ${c}`:"";return`${s?`${r} ${s}`:r} (${n>0?`${Math.round(n)}% chance`:`${o.toFixed(1)} mm`})`}return`${Ce(String(t.condition||""))}, ${c=t,`${ve(c.temperature,0)}°`}`;var c}function qe(i){i.stopPropagation()}function it(i,e,t){e.preventDefault(),e.stopPropagation(),t&&"function"==typeof(null==i?void 0:i._openMoreInfo)&&i._openMoreInfo(t)}function et(i,e,t){"Enter"!==e.key&&" "!==e.key||it(i,e,t)}function tt(i,e,t,a,n){if(e.stopPropagation(),!a||"function"!=typeof(null==i?void 0:i._setWeatherForecastGraphSelection))return;const o=e.currentTarget.getBoundingClientRect();if(!o.width)return;const c=(e.clientX-o.left)/o.width,r=n.left/n.width,s=(n.width-n.right)/n.width,l=Math.max(0,Math.min(1,(c-r)/(s-r))),M=Math.round(l*(a-1));t.forEach((e=>i._setWeatherForecastGraphSelection(e,M)))}function at(i,e,t){const a="function"==typeof(null==i?void 0:i._getWeatherForecastGraphSelection)?i._getWeatherForecastGraphSelection(e):void 0,n=function(i){const e=Date.now();let t=0,a=Number.POSITIVE_INFINITY;return i.forEach(((i,n)=>{const o=i.item.datetime?new Date(i.item.datetime).getTime():Number.NaN;if(!Number.isFinite(o))return;const c=Math.abs(o-e);c<a&&(a=c,t=n)})),t}(t);return t[Math.max(0,Math.min(t.length-1,Number.isFinite(Number(a))?Number(a):n))]||t[0]}function nt(i,e,t,a){const n=e.height-e.bottom;return[...[0,1,2].map((i=>{const t=e.top+i*((n-e.top)/2);return E`<line class="weather-conditions-grid-line" x1=${e.left} x2=${e.width-e.right} y1=${t} y2=${t}></line>`})),...t.map((t=>{const o=a[t];return E`
        <line class="weather-conditions-time-line" x1=${o.x} x2=${o.x} y1=${e.top} y2=${n}></line>
        <text class="weather-conditions-time-label" x=${o.x} y=${e.height-6}>${Ze(i,o.item)}</text>
      `}))]}function ot(i,e,t,a,n,o){if(t.length<2)return G;const c=`${n}-temperature`,r=`${n}-precipitation`,s=o?[c,r]:null,l=a.includes("temperature")?function(i,e,t,a,n){const o={width:360,height:Je(e),left:14,right:30,top:15,bottom:24},{points:c,min:r,max:s}=We(t,"temperature",o);if(c.length<2)return G;const l=o.height-o.bottom,M=at(i,a,c),g=c.reduce(((i,e)=>e.value<i.value?e:i),c[0]),I=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),N=Pe(c.length),d=c,u=Re(c),D=Ve(c,l),h=$e(a),j=`weather-conditions-temp-line-${h}`,y=`weather-conditions-temp-fill-${h}`,z=(r+s)/2;return U`
    <section class="weather-conditions-card weather-conditions-temp">
      ...
      ${d.length?U`
        <div class="weather-conditions-icons">
          ${d.map((i=>{const e=String(i.item.condition||""),t=i.x/o.width*100;return U`
              <span class="weather-conditions-icon-slot" style=${`left:${t.toFixed(2)}%;`}>
                ${_e(fe(e),`weather-conditions-icon weather-condition-${Ye(e)}`,Ce(e))}
              </span>
            `}))}
        </div>
      `:G}
      ...
      <div class="weather-conditions-chart-frame">
        <svg
          ...
          @pointerdown=${qe}
          @pointermove=${e=>tt(i,e,n,c.length,o)}
          @click=${e=>tt(i,e,n,c.length,o)}
        >
          <defs>
            ...
            <linearGradient id=${j} x1=${o.left} x2=${o.width-o.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
              ${c.map(((i,e)=>E`
                <stop offset=${e/(c.length-1)*100+"%"} stop-color=${be(i.value)}></stop>
              `))}
            </linearGradient>
          </defs>
          ${nt(i,o,N,c)}
          <path class="weather-conditions-area" d=${D} fill=${`url(#${y})`}></path>
          <path class="weather-conditions-line-shadow" d=${u}></path>
          <path class="weather-conditions-temp-line" d=${u} stroke=${`url(#${j})`}></path>
          <text class="weather-conditions-extreme" x=${g.x} y=${Math.max(12,g.y-9)}>L</text>
          <text class="weather-conditions-extreme" x=${I.x} y=${Math.max(12,I.y-9)}>H</text>
          ...
          <text class="weather-conditions-axis" x=${o.width-5} y=${o.top+(l-o.top)/2}>${z.toFixed(0)}°</text>
  ...
  `}(i,e,t,c,s||[c]):G,M=a.includes("precipitation_probability")?function(i,e,t,a,n){const o={width:360,height:Je(e),left:14,right:30,top:10,bottom:22},{points:c}=We(t,"precipitation_probability",o);if(c.length<2)return G;const r=o.height-o.bottom,s=at(i,a,c),l=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),M=Pe(c.length),g=Re(c),I=Ve(c,r),N=`weather-conditions-rain-fill-${$e(a)}`;return U`
    <section class="weather-conditions-card weather-conditions-rain">
      ...
      <div class="weather-conditions-chart-frame">
        ...
        >
          ...
          ${nt(i,o,M,c)}
          <path class="weather-conditions-rain-area" d=${I} fill=${`url(#${N})`}></path>
  ...
  `}(i,e,t,r,s||[r]):G;return l===G&&M===G?G:U`
    <div class="weather-conditions-panel">
      ${l}
      ${M}
    </div>
  `}function ct(i,e){var t,a;const n=Oe(Te(i,e.entity)).toLowerCase(),o=e.name||"Weather",c=Le(i,e.temp_sensor),r=function(i,e){const t=xe(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),s=Le(i,e.feels_like_sensor),l=function(i,e){const t=Array.isArray(e.metrics)&&e.metrics.length?e.metrics:function(i){const e=[{entity:i.wind_speed_sensor,name:"Wind"},{entity:i.wind_gust_sensor,name:"Gust"},{entity:i.temp_min_24h_sensor,name:"24h Min"},{entity:i.temp_max_24h_sensor,name:"24h Max"},{entity:i.uv_sensor,name:"UV"},{entity:i.solar_lux_sensor,name:"Solar"},{entity:i.pressure_sensor,name:"Pressure"}].filter((i=>i.entity));return(i.rain_state_sensor||i.rain_rate_sensor)&&e.splice(4,0,{type:"rain",name:"Rain",rain_state_sensor:i.rain_state_sensor,rain_rate_sensor:i.rain_rate_sensor,rain_rate_threshold:i.rain_rate_threshold}),e}(e);return t.filter((i=>i&&("rain"===i.type?i.rain_state_sensor||i.rain_rate_sensor:i.entity))).map((e=>{var t;if("rain"===e.type)return Ue(i,e);const a=Te(i,e.entity);return{label:e.name||(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.friendly_name)||e.entity||"",value:Se(i,e.entity),entity:e.entity,mdi:e.icon||void 0,stateEntity:e.entity}}))}(i,e),M=!1===e.show_forecast?[]:Ee(e.forecast),g=!1===e.show_forecast?[]:Ee(e.daily_forecast),I=Number(e.forecast_slots),N=Number.isFinite(I)&&I>0?Math.min(Math.floor(I),72):8,d=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):Ae,t=[];return e.forEach((i=>{const e=me[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:Ae}(e.forecast_fields),u=M.slice(0,N),D=Ke(i,M),h=String((null===(t=M[0])||void 0===t?void 0:t.condition)||n||"").toLowerCase(),j=h||n,y=`weather-icon weather-condition-${Ye(j)}`,z=D||Ce(h||n),p=U`<span class="weather-source-badge" title="Forecast data" aria-label="Forecast data"></span>`,A=e.forecast_graph_key||`weather-${e.entity||o}`,m=!1!==e.sync_graphs,w=ot(i,e,u,d,A,m),b=Xe(i,e,g,M),T=Array.isArray(e.chips)?e.chips:[],O=ke(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),x=ke(e.icon_size,28,160),v=ke(e.graph_height,82,260),S=Number(e.icon_offset_x),L=Number(e.icon_offset_y),k=ke(e.conditions_icon_size,8,48),C=ke(e.daily_icon_size,8,48),Y=function(i,e){const t=Number(e.stale_minutes);if(!Number.isFinite(t)||t<=0)return!1;const a=[e.entity,e.temp_sensor,e.humidity_sensor,e.feels_like_sensor].filter(Boolean);let n=0;return a.forEach((e=>{const t=Te(i,e),a=(null==t?void 0:t.last_updated)?Date.parse(t.last_updated):NaN;Number.isFinite(a)&&(n=Math.max(n,a))})),!!n&&Date.now()-n>6e4*t}(i,e),f=[O?`--weather-temp-size:${O}px;`:"",x?`--weather-icon-size:${x}px;--weather-icon-bg-size:${x+16}px;`:"",Number.isFinite(S)?`--weather-icon-x:${S}px;`:"",Number.isFinite(L)?`--weather-icon-y:${L}px;`:"",k?`--weather-conditions-icon-size:${k}px;`:"",C?`--weather-daily-icon-size:${C}px;`:"",v?`--weather-graph-height:${v}px;`:""].filter(Boolean).join("");return U`
    <div class="tile-wrap weather-tile-wrap" style=${f}>
      <div class=${"weather-tile"+(Y?" weather-tile-stale":"")}>
        <div class="weather-content">
          <div class="weather-top">
            <div class="weather-heading">
              <div class="weather-headline-row">
                <div class="weather-name">${z}</div>
                ${M.length?p:G}
              </div>
              <div class="weather-primary">
                <span
                  ...
                  @pointerdown=${qe}
                  @pointerup=${qe}
                  @click=${t=>it(i,t,e.temp_sensor)}
                  @keyup=${t=>et(i,t,e.temp_sensor)}
                >${c}</span>
                <span
                  ...
                  @pointerdown=${qe}
                  @pointerup=${qe}
                  @click=${t=>it(i,t,e.humidity_sensor)}
                  @keyup=${t=>et(i,t,e.humidity_sensor)}
                >${r}</span>
              </div>
              <div
                ...
                @pointerdown=${qe}
                @pointerup=${qe}
                @click=${t=>it(i,t,e.feels_like_sensor)}
                @keyup=${t=>et(i,t,e.feels_like_sensor)}
              >Feels like ${s}</div>
            </div>
            <div class="weather-icon-wrap weather-icon-hit"
              ...
              @pointerdown=${qe}
              @pointerup=${qe}
              @click=${t=>it(i,t,e.entity)}
              @keyup=${t=>et(i,t,e.entity)}
            >
              ${e.icon?U`<ha-icon class=${y} .icon=${e.icon}></ha-icon>`:_e(fe(j),y,Ce(j),"object")}
            </div>
          </div>
        ...
        ${T.length?U`<div class="weather-chips-bottom-right">
              ${T.map((e=>U`
                <div
                  ...
                  @pointerdown=${qe}
                  @pointerup=${qe}
                  @click=${t=>it(i,t,(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity))}
                  @keyup=${t=>et(i,t,(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity))}
                >
                  ${Ne(i,e)}
                </div>
              `))}
  ...
  `}const rt=(...i)=>i.filter(Boolean).join(" ");function st(i,e){return e&&e.length?U`${e.map(((e,t)=>function(i,e,t){const a=e,n=Array.isArray(e)?e:Array.isArray(null==a?void 0:a.row)?a.row:[];let o=Array.isArray(null==a?void 0:a.cards)?a.cards:Array.isArray(null==a?void 0:a.extra_cards)?a.extra_cards:[];if(!Array.isArray(o)||!o.length){const i=(null==a?void 0:a.card)||(null==a?void 0:a.extra_card);i&&"object"==typeof i&&(o=[i])}const c=Math.max(1,n.length||1),r=Array.isArray(o)&&o.length&&"function"==typeof(null==i?void 0:i._renderEmbeddedRowCard)?U`<div class="switch-row-cards">
        ${o.map(((e,a)=>i._renderEmbeddedRowCard(e,`switch-row-${t}-card-${a}`)))}
      </div>`:G;return U`
    <div class="switch-row-wrap">
      <div class="switch-row" style=${`--cols:${c}`}>${n.map((e=>function(i,e){var t,a,n,o,c,r,s;const l="string"==typeof(null==e?void 0:e.entity)?e.entity:"",M=(null==e?void 0:e.icon)||"",g=(null==e?void 0:e.name)||"",I=(null===(o=null===(n=null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.states)||void 0===a?void 0:a[l])||void 0===n?void 0:n.attributes)||void 0===o?void 0:o.friendly_name)||"",N=g||I||l,d=String((null==e?void 0:e.type)||"switch").toLowerCase(),u="smart_plug"===d,D="lock"===d||l.startsWith("lock."),h="function"==typeof(null==i?void 0:i._isSwitchActive)?i._isSwitchActive(l,d):D?"unlocked"===((null===(s=null===(r=null===(c=null==i?void 0:i.hass)||void 0===c?void 0:c.states)||void 0===r?void 0:r[l])||void 0===s?void 0:s.state)||"").toLowerCase():"function"==typeof(null==i?void 0:i._isOn)&&i._isOn(l),j=(null==e?void 0:e.icon_size)||(null==e?void 0:e["icon-size"]),y=(null==e?void 0:e.font_weight)||(null==e?void 0:e["font-weight"]),z=(null==e?void 0:e.font_size)||(null==e?void 0:e["font-size"]),p=(null==e?void 0:e.icon_active)||(null==e?void 0:e.icon_on)||(null==e?void 0:e["icon-active"])||(null==e?void 0:e["icon-on"]),A=(null==e?void 0:e.icon_inactive)||(null==e?void 0:e.icon_off)||(null==e?void 0:e["icon-inactive"])||(null==e?void 0:e["icon-off"]),m=h?p||M||A:A||M,w=i=>{if(null==i||""===i)return"";const e=String(i).trim();return e?/^-?\d+(\.\d+)?$/.test(e)?`${e}px`:e:""},b=w(j),T=w(z),O=b?`--switch-icon-size:${b};width:${b};height:${b};--mdc-icon-size:${b};`:"",x=`${y?`font-weight:${y};`:""}${T?`font-size:${T};`:""}`,v=`${b?`--switch-icon-size:${b};`:""}${y?`font-weight:${y};`:""}${T?`--chip-text-font-size:${T};font-size:${T};`:""}`,S="undefined"!=typeof customElements&&!!customElements.get("ha-chip"),L="undefined"!=typeof customElements&&!!customElements.get("ha-control-button"),k=u?"smart":D?"lock":"",C=h?"on":"off",Y=rt("switch-chip",k,C),f=rt("switch-icon",k,C),_=rt("name","switch-name",k,C),Q="function"==typeof(null==i?void 0:i._resolveSwitchTemplates)?i._resolveSwitchTemplates(e):[],E=Array.isArray(Q)?Q.map((i=>i&&"object"==typeof i?i.value:i)).slice(0,2):[],Z=((i,e)=>{if(!Array.isArray(i)||!i.length)return G;const t=i.map((i=>{const e=null==i?"":String(i);return{text:e,trimmed:e.trim()}})).filter((i=>i.trimmed.length>0)).slice(0,2);return t.length?U`
    <div class=${e}>
      ${t.map((i=>U`<span>${i.text}</span>`))}
    </div>
  `:G})(E,rt("switch-info",k,C)),W="function"==typeof(null==i?void 0:i._isSwitchPending)&&i._isSwitchPending(l),P=W?U`<span class=${rt("switch-pending-spinner",k,C)} aria-hidden="true"></span>`:G,$=rt("switch-tile",k,C,W&&"pending"),R=t=>{"function"==typeof(null==i?void 0:i._onSwitchAction)&&i._onSwitchAction(t,e)},V=(null==e?void 0:e.glow_mode)||"static",F=D?De:u?ue:de,{style:B,overlay:H}=je(F,V,h&&"none"!==V);if(L){const i=rt("switch-tile-btn",k,h?"on":"off",W&&"pending");return U`
      <div class="tile-wrap">
        ...
        >
          <div class="tile-inner">
            ${S?U`<ha-chip class=${Y} style=${v||G}>
                  ${m?U`<ha-icon class=${f} .icon=${m} style=${O||G}></ha-icon>`:G}
                  ${N}
                </ha-chip>`:U`
                  ${m?U`<ha-icon class=${f} .icon=${m} style=${O||G}></ha-icon>`:G}
                  ${N?U`<div class=${_} style=${x}>${N}</div>`:G}
                `}
          </div>
        </ha-control-button>
      </div>
...
`;var ht;let jt=ht=class extends ni{constructor(){super(...arguments),this._visiblePendingSwitches=new Set,this._weatherForecastGraphSelections=new Map,this._rowCardElements=new Map,this._rowCardConfigs=new Map,this._rowCardPromises=new Map,this._switchTemplateValues=new Map,this._weatherForecastValues=new Map,this._pendingSwitches=new Map,this._switchPendingDelayMs=300,this._switchPendingTimeoutMs=1e4}static getConfigElement(){return document.createElement("space-hub-card-editor")}static getStubConfig(){return{tile_height:80,chip_icon_size:14,main_icon_size:48,chip_font_size:12,card_shadow_color:"#000000",card_shadow_intensity:.5,unavailable_pulse_color:"#ff3b30",switch_rows:[],cards:[]}}setConfig(i){if(!i)throw new Error("Configuration is required");this._validateConfig(i,{allowIncomplete:!0});const e=Ri(i||{});Array.isArray(e.headers)||(e.headers=[]),Array.isArray(e.switch_rows)||(e.switch_rows=[]),Array.isArray(e.cards)||(e.cards=[]),this._clearRowCardCache(),this._config=e,this._syncTemplateEntries(e.switch_rows),this._syncWeatherForecastEntries(e.headers)}_isValidEntityId(i){return"string"==typeof i&&i.includes(".")&&!i.includes(" ")}_validateConfig(i,e={}){const t=!!e.allowIncomplete,a=[];i.headers&&Array.isArray(i.headers)&&i.headers.forEach(((i,e)=>{if(i){if(i.ac&&(i.ac.entity?this._isValidEntityId(i.ac.entity)||a.push(`Header ${e+1}: AC entity '${i.ac.entity}' must be a valid entity ID (e.g., 'climate.living_room')`):t||a.push(`Header ${e+1}: AC tile requires an 'entity' field`)),i.thermostat&&(i.thermostat.entity?this._isValidEntityId(i.thermostat.entity)||a.push(`Header ${e+1}: Thermostat entity '${i.thermostat.entity}' must be a valid entity ID (e.g., 'climate.bedroom')`):t||a.push(`Header ${e+1}: Thermostat tile requires an 'entity' field`)),i.main){const n=i.main;!!(n.main_name||n.main_icon||n.tap_entity||n.light_group_entity||n.temp_sensor||n.humidity_sensor||Array.isArray(n.chips)&&n.chips.length>0)||t||a.push(`Header ${e+1}: Main tile must have at least one of: main_name, main_icon, tap_entity, light_group_entity, temp_sensor, humidity_sensor, or chips`);["tap_entity","hold_entity","light_group_entity","temp_sensor","humidity_sensor"].forEach((i=>{const t=n[i];t&&!this._isValidEntityId(t)&&a.push(`Header ${e+1}: Main tile ${i} '${t}' must be a valid entity ID`)}))}if(i.weather){const n=i.weather;!!(n.name||n.icon||n.entity||void 0!==n.animated_icons||void 0!==n.show_forecast||n.forecast_slots||n.forecast_fields||n.height||n.temp_size||n.temperature_size||n.icon_size||n.graph_height||n.temp_sensor||n.temp_min_24h_sensor||n.temp_max_24h_sensor||n.humidity_sensor||n.feels_like_sensor||n.dewpoint_sensor||n.wind_speed_sensor||n.wind_gust_sensor||n.wind_direction_sensor||n.rain_state_sensor||n.rain_today_sensor||n.rain_rate_sensor||n.uv_sensor||n.solar_lux_sensor||n.pressure_sensor||Array.isArray(n.chips)&&n.chips.length>0)||t||a.push(`Header ${e+1}: Weather tile must have at least one weather entity, sensor, name, icon, or chip`);["entity","temp_sensor","temp_min_24h_sensor","temp_max_24h_sensor","humidity_sensor","feels_like_sensor","dewpoint_sensor","wind_speed_sensor","wind_gust_sensor","wind_direction_sensor","rain_state_sensor","rain_today_sensor","rain_rate_sensor","uv_sensor","solar_lux_sensor","pressure_sensor"].forEach((i=>{const t=n[i];t&&!this._isValidEntityId(t)&&a.push(`Header ${e+1}: Weather tile ${i} '${t}' must be a valid entity ID`)}));if(["height","temp_size","temperature_size","icon_size","graph_height"].forEach((i=>{const t=n[i];if(null!=t){const n=Number(t);(!Number.isFinite(n)||n<=0)&&a.push(`Header ${e+1}: Weather tile ${i} must be a positive number, got: ${t}`)}})),void 0!==n.forecast_slots&&null!==n.forecast_slots){const i=Number(n.forecast_slots);(!Number.isFinite(i)||i<=0)&&a.push(`Header ${e+1}: Weather tile forecast graph hours must be a positive number, got: ${n.forecast_slots}`)}if(void 0!==n.forecast_fields&&null!==n.forecast_fields){const i=Array.isArray(n.forecast_fields)?n.forecast_fields:String(n.forecast_fields).split(","),t=new Set(["temp","temperature","rain_chance","precipitation_probability","precip_probability","probability","pop","rain","precipitation","hum","humidity","wind","wind_speed","gust","wind_gust","wind_gust_speed","uv","uv_index","cloud","clouds","cloud_coverage"]);i.forEach((i=>{const n=String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_");n&&!t.has(n)&&a.push(`Header ${e+1}: Weather tile forecast field '${i}' is not supported`)}))}}!i.ac&&!i.thermostat||i.main||t||a.push(`Header ${e+1}: AC and Thermostat tiles require a 'main' configuration block`)}else a.push(`Header ${e+1}: Header configuration cannot be empty`)})),i.switch_rows&&Array.isArray(i.switch_rows)&&i.switch_rows.forEach(((i,e)=>{if(!i)return void a.push(`Switch row ${e+1}: Switch row configuration cannot be empty`);const n=Array.isArray(i)?i:Array.isArray(i.row)?i.row:[];Array.isArray(n)&&0!==n.length||t?n.forEach(((i,n)=>{i&&i.entity?this._isValidEntityId(i.entity)||a.push(`Switch row ${e+1}, item ${n+1}: Switch entity '${i.entity}' must be a valid entity ID`):t||a.push(`Switch row ${e+1}, item ${n+1}: Switch item requires an 'entity' field`),(null==i?void 0:i.hold_entity)&&!this._isValidEntityId(i.hold_entity)&&a.push(`Switch row ${e+1}, item ${n+1}: hold_entity '${i.hold_entity}' must be a valid entity ID`)})):a.push(`Switch row ${e+1}: Switch row must contain at least one switch item`)}));if(Object.entries({tile_height:"Tile height",chip_icon_size:"Chip icon size",main_icon_size:"Main icon size",chip_font_size:"Chip font size",card_shadow_intensity:"Card shadow intensity"}).forEach((([e,t])=>{const n=i[e];if(null!=n){const i=Number(n);(!Number.isFinite(i)||i<0)&&a.push(`${t} must be a positive number, got: ${n}`)}})),void 0!==i.card_shadow_intensity&&null!==i.card_shadow_intensity){const e=Number(i.card_shadow_intensity);Number.isFinite(e)&&(e<0||e>1)&&a.push(`Card shadow intensity must be between 0 and 1, got: ${e}`)}if(["card_shadow_color","unavailable_pulse_color"].forEach((e=>{const t=i[e];if(t&&"string"==typeof t){/^(#[0-9a-fA-F]{3,8}|rgb\(|rgba\(|hsl\(|hsla\(|[a-zA-Z]+).*$/.test(t)||a.push(`${e.replace(/_/g," ")} '${t}' is not a valid color format`)}})),a.length>0)throw new Error(`Invalid space-hub-card configuration:\n${a.map((i=>`• ${i}`)).join("\n")}`)}getCardSize(){return 6}render(){var i,e,t,a,n,o,c,r,s;if(!this._config)return G;const l=ht.getStubConfig(),M=this._config||{},g={tile_height:null!==(i=M.tile_height)&&void 0!==i?i:l.tile_height,chip_icon_size:null!==(e=M.chip_icon_size)&&void 0!==e?e:l.chip_icon_size,main_icon_size:null!==(t=M.main_icon_size)&&void 0!==t?t:l.main_icon_size,chip_font_size:null!==(a=M.chip_font_size)&&void 0!==a?a:l.chip_font_size,card_shadow_color:null!==(n=M.card_shadow_color)&&void 0!==n?n:l.card_shadow_color,card_shadow_intensity:null!==(o=M.card_shadow_intensity)&&void 0!==o?o:l.card_shadow_intensity,unavailable_pulse_color:null!==(c=M.unavailable_pulse_color)&&void 0!==c?c:l.unavailable_pulse_color,headers:Array.isArray(M.headers)&&M.headers.length?M.headers:[],switch_rows:Array.isArray(M.switch_rows)?M.switch_rows:[],cards:Array.isArray(M.cards)?M.cards:[],tap_action:M.tap_action,hold_action:M.hold_action,double_tap_action:M.double_tap_action},I=Array.isArray(g.headers)&&g.headers.length?g.headers:[],N=Number(g.tile_height)||Number(l.tile_height)||80,d=Number(g.chip_icon_size)||Number(l.chip_icon_size)||14,u=Number(g.chip_font_size)||Number(l.chip_font_size)||12,D=Math.max(u+10,20),h=Math.round(.625*N),j=I[0]||{},y=Number(null!==(r=null==j?void 0:j.main_icon_size)&&void 0!==r?r:null==j?void 0:j.maicon_size),z=Number.isFinite(y)&&y>0?y:Number(g.main_icon_size)||Number(l.main_icon_size)||48,p=this._rgbaFromColor(g.card_shadow_color||l.card_shadow_color,null!==(s=g.card_shadow_intensity)&&void 0!==s?s:l.card_shadow_intensity),A=g.unavailable_pulse_color||l.unavailable_pulse_color||"#ff3b30",m=this._hasAnyUnavailable(g,I),w=this._rgbaFromColor(A,.18),b=this._rgbaFromColor(A,.36);return U`
    ...
    `}updated(i){super.updated(i),i.has("hass")&&(this._rowCardElements.forEach((i=>{i&&(i.hass=this.hass)})),this._resumeTemplateSubscriptions(),this._resumeWeatherForecastSubscriptions(),this._syncPendingSwitches())}connectedCallback(){super.connectedCallback(),this._resumeTemplateSubscriptions(),this._resumeWeatherForecastSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._switchTemplateValues.forEach((i=>this._disposeTemplateEntry(i))),this._weatherForecastValues.forEach((i=>this._disposeWeatherForecastEntry(i))),this._clearAllPendingSwitches()}_renderHeaderRow(i,e){const t=i.main||{},a=i.weather||{},n={tap_entity:t.tap_entity,hold_entity:t.hold_entity||t.tap_entity,glow_mode:t.glow_mode,light_group_entity:t.light_group_entity,name:t.main_name||t.name,icon:t.main_icon||t.icon,temp_sensor:t.temp_sensor,humidity_sensor:t.humidity_sensor,chips:Array.isArray(t.chips)?t.chips:[],tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},o={entity:a.entity,name:a.name||a.main_name,icon:a.icon||a.main_icon,height:a.height,temp_size:a.temp_size,temperature_size:a.temperature_size,icon_size:a.icon_size,icon_offset_x:a.icon_offset_x,icon_offset_y:a.icon_offset_y,conditions_icon_size:a.conditions_icon_size,daily_icon_size:a.daily_icon_size,graph_height:a.graph_height,animated_icons:a.animated_icons,show_forecast:a.show_forecast,sync_graphs:a.sync_graphs,stale_minutes:a.stale_minutes,rain_rate_threshold:a.rain_rate_threshold,forecast_slots:a.forecast_slots,forecast_fields:a.forecast_fields,forecast_graph_key:`weather-${e}`,temp_sensor:a.temp_sensor,temp_min_24h_sensor:a.temp_min_24h_sensor,temp_max_24h_sensor:a.temp_max_24h_sensor,humidity_sensor:a.humidity_sensor,feels_like_sensor:a.feels_like_sensor,dewpoint_sensor:a.dewpoint_sensor,wind_speed_sensor:a.wind_speed_sensor,wind_gust_sensor:a.wind_gust_sensor,wind_direction_sensor:a.wind_direction_sensor,rain_state_sensor:a.rain_state_sensor,rain_today_sensor:a.rain_today_sensor,rain_rate_sensor:a.rain_rate_sensor,uv_sensor:a.uv_sensor,solar_lux_sensor:a.solar_lux_sensor,pressure_sensor:a.pressure_sensor,metrics:Array.isArray(a.metrics)?a.metrics:void 0,chips:Array.isArray(a.chips)?a.chips:[],tap_action:a.tap_action,hold_action:a.hold_action,double_tap_action:a.double_tap_action,forecast:!1===a.show_forecast?[]:this._getWeatherForecast(a.entity,"hourly"),daily_forecast:!1===a.show_forecast?[]:this._getWeatherForecast(a.entity,"daily")},c=i.ac||{},r=i.thermostat||{},s=!!(null==c?void 0:c.entity),l=!!(null==r?void 0:r.entity),M=!(!t||!(t.main_name||t.name||t.light_group_entity||t.entity||t.main_icon||t.icon||t.temp_sensor||t.humidity_sensor||Array.isArray(t.chips)&&t.chips.length)),g=!(!a||!(a.name||a.main_name||a.icon||a.main_icon||void 0!==a.animated_icons||void 0!==a.show_forecast||a.forecast_slots||a.forecast_fields||a.height||a.temp_size||a.temperature_size||a.icon_size||a.graph_height||a.entity||a.temp_sensor||a.temp_min_24h_sensor||a.temp_max_24h_sensor||a.humidity_sensor||a.feels_like_sensor||a.dewpoint_sensor||a.wind_speed_sensor||a.wind_gust_sensor||a.wind_direction_sensor||a.rain_state_sensor||a.rain_today_sensor||a.rain_rate_sensor||a.uv_sensor||a.solar_lux_sensor||a.pressure_sensor||Array.isArray(a.chips)&&a.chips.length)),I=M&&s,N=M&&l;M||!s&&!l||console.warn("space-hub-card: header contains `ac`/`thermostat` outside of `main` — ignoring per configured rules.");const d=I||N?I&&N?"header-row":"header-row main-plus-one":"header-row only-main";return U`
      ...
      ${M?U`<div class=${d}>
        ${M?ye(this,n):G}
        ${I?function(i,e){var t,a,n;const o=(null==e?void 0:e.entity)||"",c=null==e?void 0:e.glow_mode,r=((null===(n=null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.states)||void 0===a?void 0:a[o])||void 0===n?void 0:n.state)||"").toLowerCase(),s=!!r&&"off"!==r,l="function"==typeof(null==i?void 0:i._acChip)?i._acChip(r):{icon:"mdi:air-conditioner"},M=(null==l?void 0:l.icon)||"mdi:air-conditioner",g="ac-mode-"+((I=r)&&"off"!==I?I.includes("cool")?"cool":I.includes("heat")?"heat":I.includes("dry")?"dry":I.includes("fan")?"fan":I.includes("auto")?"auto":"default":"off");var I;const N=`chip chip-temperature-humidity ac-chip ${g}`,d=`ac-fan ${g}${s?" spinning":""}`,u=function(i){const e=(i||"").toLowerCase();return e&&"off"!==e?e.includes("cool")?{weak:"rgba(0,170,255,0.12)",strong:"rgba(0,170,255,0.26)"}:e.includes("heat")?{weak:"rgba(255,112,67,0.12)",strong:"rgba(255,112,67,0.26)"}:e.includes("dry")?{weak:"rgba(255,202,40,0.12)",strong:"rgba(255,202,40,0.26)"}:e.includes("fan")?{weak:"rgba(102,187,106,0.12)",strong:"rgba(102,187,106,0.26)"}:e.includes("auto")?{weak:"rgba(38,198,218,0.12)",strong:"rgba(38,198,218,0.26)"}:{weak:"rgba(0,0,0,0.06)",strong:"rgba(0,0,0,0.12)"}:{weak:"rgba(0,0,0,0.00)",strong:"rgba(0,0,0,0.00)"}}(r),D=null!=c?c:"static",{style:h,overlay:j}=je(u,D,s);return U`
    <div class="tile-wrap">
    ...
    <div class="tile-wrap">
      ...
      >
        ...
        <div class="temperature-chip-container">
          ${z?U`<ha-chip class=${h}>${d}</ha-chip>`:U`<div class=${j}><span class="thermostat-target">${d}</span></div>`}
        </div>
        <div class="center-xy">
