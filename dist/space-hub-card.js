 ...
 */var Ti;null===(Ti=window.HTMLSlotElement)||void 0===Ti||Ti.prototype.assignedElements;var bi="[^\\s]+";function Oi(i,e){for(var t=[],a=0,n=i.length;a<n;a++)t.push(i[a].substr(0,e));return t}var xi=function(i){return function(e,t){var a=t[i].map((function(i){return i.toLowerCase()})),n=a.indexOf(e.toLowerCase());return n>-1?n:null}};function vi(i){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var a=0,n=e;a<n.length;a++){var o=n[a];for(var c in o)i[c]=o[c]}return i}var Si=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Li=["January","February","March","April","May","June","July","August","September","October","November","December"],Ci=Oi(Li,3),ki={dayNamesShort:Oi(Si,3),dayNames:Si,monthNamesShort:Ci,monthNames:Li,amPm:["am","pm"],DoFn:function(i){return i+["th","st","nd","rd"][i%10>3?0:(i-i%10!=10?1:0)*i%10]}},Yi=(vi({},ki),function(i){return+i-1}),fi=[null,"[1-9]\\d?"],_i=[null,bi],Qi=["isPm",bi,function(i,e){var t=i.toLowerCase();return t===e.amPm[0]?0:t===e.amPm[1]?1:null}],Ei=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(i){var e=(i+"").match(/([+-]|\d\d)/gi);if(e){var t=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?t:-t}return 0}];xi("monthNamesShort"),xi("monthNames");var Ui,Zi;!function(){try{(new Date).toLocaleDateString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(i){return"RangeError"===i.name}}(),function(i){i.language="language",i.system="system",i.comma_decimal="comma_decimal",i.decimal_comma="decimal_comma",i.space_comma="space_comma",i.none="none"}(Ui||(Ui={})),function(i){i.language="language",i.system="system",i.am_pm="12",i.twenty_four="24"}(Zi||(Zi={}));var Gi=function(i,e,t,a){a=a||{},t=null==t?{}:t;var n=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return n.detail=t,i.dispatchEvent(n),n},Wi=new Set(["call-service","divider","section","weblink","cast","select"]),Pi={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},$i=function(i,e){void 0===e&&(e=!1);var t=function(i,e){return a("hui-error-card",{type:"error",error:i,config:e})},a=function(i,e){var a=window.document.createElement(i);try{a.setConfig(e)}catch(a){return console.error(i,a),t(a.message,e)}return a};if(!i||"object"!=typeof i||!e&&!i.type)return t("No type defined",i);var n=i.type;if(n&&n.startsWith("custom:"))n=n.substr("custom:".length);else if(e)if(Wi.has(n))n="hui-"+n+"-row";else{if(!i.entity)return t("Invalid config given.",i);var o=i.entity.split(".",1)[0];n="hui-"+(Pi[o]||"text")+"-entity-row"}else n="hui-"+n+"-card";if(customElements.get(n))return a(n,i);var c=t("Custom element doesn't exist: "+i.type+".",i);c.style.display="None";var r=setTimeout((function(){c.style.display=""}),2e3);return customElements.whenDefined(i.type).then((function(){clearTimeout(r),Gi(c,"ll-rebuild",{},c)})),c};function Ri(i){return JSON.parse(JSON.stringify(i))}const Vi=new Set(["more-info","toggle","perform-action","navigate","url","assist","none","fire-dom-event","call-service"]),Fi=i=>!!i&&"object"==typeof i&&!Array.isArray(i),Bi=i=>!!((null==i?void 0:i.tap_action)||(null==i?void 0:i.hold_action)||(null==i?void 0:i.double_tap_action)),Hi=i=>{if(null==i||!1===i)return;if(!0===i)return!0;if("string"==typeof i){const e=i.trim();return!e||{text:e}}if(!Fi(i))return;const e={};if("string"==typeof i.text&&i.text.trim()&&(e.text=i.text),"string"==typeof i.title&&i.title.trim()&&(e.title=i.title),"string"==typeof i.confirm_text&&i.confirm_text.trim()&&(e.confirm_text=i.confirm_text),"string"==typeof i.dismiss_text&&i.dismiss_text.trim()&&(e.dismiss_text=i.dismiss_text),Array.isArray(i.exemptions)){const t=i.exemptions.filter((i=>!!i&&"object"==typeof i&&"string"==typeof i.user)).map((i=>({user:i.user})));t.length&&(e.exemptions=t)}return!Object.keys(e).length||e},Ji=i=>{if(Fi(i)&&"string"==typeof i.action&&Vi.has(i.action)){if("call-service"===i.action||"perform-action"===i.action){return Object.assign(Object.assign({},i),{action:"perform-action",perform_action:"string"==typeof i.perform_action?i.perform_action:"string"==typeof i.service?i.service:void 0,data:Fi(i.data)?i.data:Fi(i.service_data)?i.service_data:void 0,target:Fi(i.target)?i.target:void 0,confirmation:Hi(i.confirmation)})}return Object.assign(Object.assign({},i),{confirmation:Hi(i.confirmation)})}},Xi=["lock","door","presence","illuminance","gate","sliding_gate","smart_plug","custom"],Ki=["switch","smart_plug","lock"],qi=["static","pulse","none"],ie=["hourly","daily","twice_daily"],ee=["24h","12h"],te=["more-info","toggle","perform-action","navigate","url","assist","none"],ae="M4,12L5.41,13.41L11,7.83V20H13V7.83L18.59,13.42L20,12L12,4L4,12Z",ne="M4,12L5.41,10.59L11,16.17V4H13V16.17L18.59,10.58L20,12L12,20L4,12Z",oe="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";let ce=class extends ni{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.type="text",this.disabled=!1}_onInput(i){i.stopPropagation(),this.disabled||(this.value=i.currentTarget.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}render(){return E`
    ...
    `}_renderWeatherConfig(i,e){var t,a,n,o,c,r,s;const l=i||{};return E`
      <ha-expansion-panel outlined .header=${"Weather Tile"}>
        <div class="section-content">
          ${!!i?E`
            ...
            <div class="side-by-side">
              ${this._renderEntityField("Weather Entity",`${e}.entity`,l.entity,{domain:"weather"})}
              <space-hub-textfield
                label="Tile Height (px)"
                type="number"
                .value=${String(null!==(t=l.height)&&void 0!==t?t:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="18"
                max="56"
                .value=${String(null!==(a=l.temp_size)&&void 0!==a?a:"")}
              ...
              <space-hub-textfield
                ...
                min="28"
                max="160"
                .value=${String(null!==(n=l.icon_size)&&void 0!==n?n:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                min="0"
                .value=${String(null!==(o=l.stale_minutes)&&void 0!==o?o:"")}
              ...
              <space-hub-textfield
                ...
                min="0"
                step="0.1"
                .value=${String(null!==(c=l.rain_rate_threshold)&&void 0!==c?c:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.rain_rate_threshold`,Number.isFinite(t)&&t>=0?t:void 0)}}
              ></space-hub-textfield>
            </div>
            <div class="side-by-side">
              ${this._renderSelectField("Forecast Type",`${e}.forecast_type`,l.forecast_type,ie)}
              ${this._renderSelectField("Time Format",`${e}.time_format`,l.time_format,ee)}
            </div>
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="1"
                max="72"
                .value=${String(null!==(r=l.forecast_slots)&&void 0!==r?r:"")}
              ...
              <space-hub-textfield
                ...
                min="82"
                max="260"
                .value=${String(null!==(s=l.graph_height)&&void 0!==s?s:"")}
            ...
            <space-hub-textfield
              ...
              .value=${Array.isArray(l.forecast_fields)?l.forecast_fields.join(", "):l.forecast_fields||""}
              @input=${i=>{const t=i.target.value.split(",").map((i=>i.trim())).filter((i=>i));this._valueChanged(`${e}.forecast_fields`,t.length?t:void 0)}}
            ></space-hub-textfield>
            <div class="side-by-side">
              ${this._renderEntityField("Temperature Sensor",`${e}.temp_sensor`,l.temp_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Humidity Sensor",`${e}.humidity_sensor`,l.humidity_sensor,{domain:"sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("24h Min Temperature Sensor",`${e}.temp_min_24h_sensor`,l.temp_min_24h_sensor,{domain:"sensor"})}
              ${this._renderEntityField("24h Max Temperature Sensor",`${e}.temp_max_24h_sensor`,l.temp_max_24h_sensor,{domain:"sensor"})}
            </div>
            ${this._renderEntityField("Feels Like Sensor",`${e}.feels_like_sensor`,l.feels_like_sensor,{domain:"sensor"})}
            <div class="side-by-side">
              ${this._renderEntityField("Wind Speed Sensor",`${e}.wind_speed_sensor`,l.wind_speed_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Wind Gust Sensor",`${e}.wind_gust_sensor`,l.wind_gust_sensor,{domain:"sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("Wind Direction Sensor",`${e}.wind_direction_sensor`,l.wind_direction_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Rain State Sensor",`${e}.rain_state_sensor`,l.rain_state_sensor,{domain:"binary_sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("Rain Today Sensor",`${e}.rain_today_sensor`,l.rain_today_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Rain Rate Sensor",`${e}.rain_rate_sensor`,l.rain_rate_sensor,{domain:"sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("UV Sensor",`${e}.uv_sensor`,l.uv_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Solar Lux Sensor",`${e}.solar_lux_sensor`,l.solar_lux_sensor,{domain:"sensor"})}
            </div>
            ${this._renderEntityField("Pressure Sensor",`${e}.pressure_sensor`,l.pressure_sensor,{domain:"sensor"})}
            ${this._renderChipsConfig(l.chips||[],e)}
            ${this._renderActionConfig("Tap Action",`${e}.tap_action`,l.tap_action)}
            ${this._renderActionConfig("Hold Action",`${e}.hold_action`,l.hold_action)}
            ${this._renderActionConfig("Double Tap Action",`${e}.double_tap_action`,l.double_tap_action)}
  ...
  `}const Ae={barometer:"data:image/svg+xml;base64,","clear-day":"data:image/svg+xml;base64,","clear-night":"data:image/svg+xml;base64,",cloudy:"data:image/svg+xml;base64,",drizzle:"data:image/svg+xml;base64,",fog:"data:image/svg+xml;base64,",hail:"data:image/svg+xml;base64,","not-available":"data:image/svg+xml;base64,","partly-cloudy-day":"data:image/svg+xml;base64,","partly-cloudy-night":"data:image/svg+xml;base64,","pressure-high":"data:image/svg+xml;base64,",rain:"data:image/svg+xml;base64,",raindrop:"data:image/svg+xml;base64,",raindrops:"data:image/svg+xml;base64,",sleet:"data:image/svg+xml;base64,",snow:"data:image/svg+xml;base64,","sun-hot":"data:image/svg+xml;base64,","thermometer-colder":"data:image/svg+xml;base64,","thermometer-warmer":"data:image/svg+xml;base64,",thunderstorms:"data:image/svg+xml;base64,","thunderstorms-rain":"data:image/svg+xml;base64,","uv-index":"data:image/svg+xml;base64,","weather-alarm":"data:image/svg+xml;base64,",wind:"data:image/svg+xml;base64,","wind-alert":"data:image/svg+xml;base64,"},me=new Set(["","unknown","unavailable"]),we=["temperature","precipitation_probability"],Te={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability",rain:"precipitation",precipitation:"precipitation",humidity:"humidity",hum:"humidity",wind:"wind_speed",wind_speed:"wind_speed",gust:"wind_gust_speed",wind_gust:"wind_gust_speed",wind_gust_speed:"wind_gust_speed",uv:"uv_index",uv_index:"uv_index",cloud:"cloud_coverage",clouds:"cloud_coverage",cloud_coverage:"cloud_coverage"},be={"clear-night":"clear-night",cloudy:"cloudy",exceptional:"weather-alarm",fog:"fog",hail:"hail",lightning:"thunderstorms","lightning-rainy":"thunderstorms-rain",partlycloudy:"partly-cloudy-day",pouring:"rain",rainy:"rain",snowy:"snow","snowy-rainy":"sleet",sunny:"clear-day",windy:"wind","windy-variant":"wind-alert"};function Oe(i){return i<=0?"#3aa7ff":i<=8?"#50c5d8":i<=15?"#9bd57b":i<=22?"#ffd34a":i<=28?"#ff9d24":"#ff5d38"}function xe(i,e){var t;if(e&&(null==i?void 0:i.hass))return null===(t=i.hass.states)||void 0===t?void 0:t[e]}function ve(i){const e=void 0===(null==i?void 0:i.state)||null===(null==i?void 0:i.state)?"":String(i.state);return me.has(e.toLowerCase())?"":e}function Se(i,e){const t=ve(xe(i,e));if(!t)return;const a=Number(t);return Number.isFinite(a)?a:void 0}function Le(i,e,t=!1){if(null==i||""===i)return"—";const a=Number(i);return Number.isFinite(a)?t&&Math.abs(a)>=1e3?`${(a/1e3).toFixed(1)}k`:a.toFixed(e):String(i)}function Ce(i,e,t,a=!1){var n;const o=xe(i,e),c=ve(o);if(!c)return"—";const r=(null===(n=null==o?void 0:o.attributes)||void 0===n?void 0:n.unit_of_measurement)||"",s=Le(c,t,a);return r?`${s} ${r}`:s}function ke(i,e){const t=Se(i,e);return void 0===t?"—°":`${t.toFixed(1)}°`}function Ye(i,e,t){const a=Number(i);if(Number.isFinite(a)&&!(a<=0))return Math.max(e,Math.min(t,a))}function fe(i,e,t){const a=Ce(i,e,1),n=function(i,e){const t=Se(i,e);if(void 0===t)return"";const a=["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"];return a[Math.round((t%360+360)%360/22.5)%a.length]}(i,t);return"—"===a?n||"—":n?`${a} ${n}`:a}function _e(i){if(!i)return"Weather";const e={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Storm rain","snowy-rainy":"Sleet","windy-variant":"Windy"};return e[i]?e[i]:i.replace(/[-_]/g," ").replace(/\b\w/g,(i=>i.toUpperCase()))}function Qe(i){return(i||"unknown").replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Ee(i,e){const t=Number.isFinite(Number(e.rain_rate_threshold))?Number(e.rain_rate_threshold):0,a=Se(i,e.rain_rate_sensor);if(void 0!==a)return a>t;return"on"===ve(xe(i,e.rain_state_sensor)).toLowerCase()}function Ue(i,e){const t=ve(xe(i,e.entity)).toLowerCase();return t.includes("snow")||t.includes("hail")?"snow":"rain"}function Ze(i,e,t,a,n=!1){if(a||"—"!==t)return{icon:i,label:e,value:t,entity:a,active:n}}function Ge(i){return be[i]||"partly-cloudy-day"}function We(i,e,t){return E`
    <img
      ...
      draggable="false"
    />
  `}function Pe(i,e){const t=Ee(i,e),a=Ue(i,e),n=e.rain_state_sensor||e.rain_rate_sensor||e.rain_today_sensor,o=function(i,e){const t=Ee(i,e);if(!e.rain_state_sensor&&!e.rain_rate_sensor)return"";const a=Ue(i,e);if(!t)return"snow"===a?"No snow":"No rain";const n=Ce(i,e.rain_rate_sensor,1),o="snow"===a?"Snowing":"Raining";return"—"===n||"0.0 mm/h"===n?o:`${o} ${n}`}(i,e)||Ce(i,e.rain_today_sensor,1),c="snow"===a?"Snow":"Rain",r=t?"snow"===a?"snow":"rain":"raindrop";return[Ze("wind","Wind",fe(i,e.wind_speed_sensor,e.wind_direction_sensor),e.wind_speed_sensor),Ze("wind-alert","Gust",Ce(i,e.wind_gust_sensor,1),e.wind_gust_sensor),Ze("thermometer-colder","24h Min",ke(i,e.temp_min_24h_sensor),e.temp_min_24h_sensor),Ze("thermometer-warmer","24h Max",ke(i,e.temp_max_24h_sensor),e.temp_max_24h_sensor),Ze(r,c,o,n,t),Ze("uv-index","UV",Ce(i,e.uv_sensor,0),e.uv_sensor),Ze("sun-hot","Solar",Ce(i,e.solar_lux_sensor,0),e.solar_lux_sensor),Ze("barometer","Pressure",Ce(i,e.pressure_sensor,0),e.pressure_sensor)].filter((i=>!!i))}function $e(i){return Array.isArray(i)?i.filter((i=>!!i&&"object"==typeof i)).map((i=>({condition:"string"==typeof i.condition?i.condition:void 0,datetime:"string"==typeof i.datetime?i.datetime:void 0,temperature:i.temperature,precipitation_probability:i.precipitation_probability,precipitation:i.precipitation,humidity:i.humidity,wind_speed:i.wind_speed,wind_gust_speed:i.wind_gust_speed,uv_index:i.uv_index,cloud_coverage:i.cloud_coverage,templow:i.templow}))):[]}function Re(i,e){if(!i.datetime)return"";const t=new Date(i.datetime);if(Number.isNaN(t.getTime()))return"";const a=function(i){const e=String(i||"").trim().toLowerCase().replace(/[-_\s]/g,"");return["12","12h","12hour","12hours","ampm"].includes(e)?"12h":["24","24h","24hour","24hours"].includes(e)?"24h":void 0}(e),n={hour:"2-digit",minute:"2-digit"};return a&&(n.hour12="12h"===a),new Intl.DateTimeFormat(void 0,n).format(t)}function Ve(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function Fe(i,e,t){const a=i.map(((i,t)=>({item:i,index:t,value:Ve(i,e)}))).filter((i=>void 0!==i.value));if(!a.length)return{points:[],min:0,max:1};const n=a.map((i=>i.value)),{min:o,max:c}=function(i,e){if("precipitation_probability"===i)return{min:0,max:100};let t=Math.min(...e),a=Math.max(...e);if("temperature"===i)t=5*Math.floor((t-2)/5),a=5*Math.ceil((a+2)/5);else{const i=Math.max(.18*(a-t),1);t=Math.max(0,t-i),a+=i}return a<=t&&(a=t+1),{min:t,max:a}}(e,n),r=t.width-t.left-t.right,s=t.height-t.top-t.bottom,l=a.map(((i,e)=>{const n=1===a.length?t.left+r/2:t.left+e/(a.length-1)*r,l=t.top+(c-i.value)/(c-o)*s;return Object.assign(Object.assign({},i),{x:n,y:l})}));return{points:l,min:o,max:c}}function Be(i){return i<=0?[]:Array.from(new Set([0,Math.floor((i-1)/3),Math.floor(2*(i-1)/3),i-1])).filter((e=>e>=0&&e<i))}function He(i){return i.replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Je(i){if(!i.length)return"";if(1===i.length)return`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;let e=`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;for(let t=0;t<i.length-1;t+=1){const a=i[t],n=i[t+1],o=i[t-1]||a,c=i[t+2]||n,r=a.x+(n.x-o.x)/6,s=a.y+(n.y-o.y)/6,l=n.x-(c.x-a.x)/6,M=n.y-(c.y-a.y)/6;e+=` C ${r.toFixed(2)} ${s.toFixed(2)}, ${l.toFixed(2)} ${M.toFixed(2)}, ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return e}function Xe(i,e){if(!i.length)return"";const t=i[0],a=i[i.length-1];return`${Je(i)} L ${a.x.toFixed(2)} ${e.toFixed(2)} L ${t.x.toFixed(2)} ${e.toFixed(2)} Z`}function Ke(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";return`${e.getFullYear()}-${`${e.getMonth()+1}`.padStart(2,"0")}-${`${e.getDate()}`.padStart(2,"0")}`}function qe(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function it(i,e,t){return Math.max(0,Math.min(100,(i-e)/(t-e)*100))}function et(i){return Ye(i.graph_height,82,260)||118}function tt(i,e,t,a){const n=t.slice(0,7);if(!n.length)return G;const o=function(i){const e=new Map;return i.forEach(((i,t)=>{const a=Ke(i.datetime),n=Ve(i,"temperature");if(!a||void 0===n)return;const o={item:i,value:n,x:0,y:0,index:t},c=e.get(a)||{};(!c.low||n<c.low.value)&&(c.low=o),(!c.high||n>c.high.value)&&(c.high=o),e.set(a,c)})),e}(a),{min:c,max:r}=function(i,e){const t=[];if(i.forEach((i=>{const e=qe(i,"templow"),a=qe(i,"temperature");void 0!==e&&t.push(e),void 0!==a&&t.push(a)})),e.forEach((i=>{const e=Ve(i,"temperature");void 0!==e&&t.push(e)})),!t.length)return{min:0,max:1};let a=5*Math.floor((Math.min(...t)-2)/5),n=5*Math.ceil((Math.max(...t)+2)/5);return n<=a&&(n=a+1),{min:a,max:n}}(n,a),s=Ke((new Date).toISOString()),l=function(i,e){return Se(i,e.temp_sensor)}(i,e);return E`
    <section class="weather-daily-forecast">
      ...
      ${n.map((i=>{var t,a,n,M;const g=Ke(i.datetime),I=o.get(g),N=null!==(t=qe(i,"templow"))&&void 0!==t?t:null===(a=null==I?void 0:I.low)||void 0===a?void 0:a.value,d=null!==(n=qe(i,"temperature"))&&void 0!==n?n:null===(M=null==I?void 0:I.high)||void 0===M?void 0:M.value;if(void 0===N||void 0===d)return G;const u=it(N,c,r),D=it(d,c,r),h=Math.max(4,D-u),j=String(i.condition||""),z=Number(i.precipitation_probability),y=Number.isFinite(z)?`Rain ${Math.round(z)}%`:"",p=g===s&&void 0!==l?it(l,c,r):void 0;return E`
          <div class="weather-daily-row">
            <div class="weather-daily-day">${function(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";const t=Ke((new Date).toISOString()),a=new Date;a.setDate(a.getDate()+1);const n=Ke(i);return n===t?"Today":n===Ke(a.toISOString())?"Tomorrow":new Intl.DateTimeFormat(void 0,{weekday:"short"}).format(e)}(i.datetime)}</div>
            <div class="weather-daily-condition">
              ${We(Ge(j),`weather-daily-icon weather-condition-${Qe(j)}`,_e(j))}
              ${y?E`<span title="Chance of precipitation">${y}</span>`:G}
            </div>
            <div class="weather-daily-low">
              <span>${N.toFixed(0)}°</span>
              ${(null==I?void 0:I.low)?E`<small>${Re(I.low.item,e.time_format)}</small>`:G}
            </div>
            ...
            <div class="weather-daily-high">
              ...
              ${(null==I?void 0:I.high)?E`<small>${Re(I.high.item,e.time_format)}</small>`:G}
            </div>
          </div>
        `}))}
    </section>
  `}function at(i,e){if(!i.length)return"";const t=i[0],a=i.slice(0,12).reduce(((i,e)=>{const t=Number(i.precipitation_probability)||0,a=Number(e.precipitation_probability)||0,n=Number(i.precipitation)||0,o=Number(e.precipitation)||0;return o>n||o===n&&a>t?e:i}),t),n=Number(a.precipitation_probability)||0,o=Number(a.precipitation)||0;if(n>=25||o>0){const i=a===t,c=Re(a,e);let r;r=n>=80||o>=2?"Rain likely":n>=50||o>=.5?"Showers possible":"Slight chance of rain";const s=i?"shortly":c?`around ${c}`:"";return`${s?`${r} ${s}`:r} (${n>0?`${Math.round(n)}% chance`:`${o.toFixed(1)} mm`})`}return`${_e(String(t.condition||""))}, ${c=t,`${Le(c.temperature,0)}°`}`;var c}function nt(i){i.stopPropagation()}function ot(i,e,t){e.preventDefault(),e.stopPropagation(),t&&"function"==typeof(null==i?void 0:i._openMoreInfo)&&i._openMoreInfo(t)}function ct(i,e,t){"Enter"!==e.key&&" "!==e.key||ot(i,e,t)}function rt(i,e,t,a){if(e.stopPropagation(),!a||"function"!=typeof(null==i?void 0:i._setWeatherForecastGraphSelection))return;const n=e.currentTarget.getBoundingClientRect(),o=n.width?Math.max(0,Math.min(1,(e.clientX-n.left)/n.width)):0,c=Math.round(o*(a-1));t.forEach((e=>i._setWeatherForecastGraphSelection(e,c)))}function st(i,e,t){const a="function"==typeof(null==i?void 0:i._getWeatherForecastGraphSelection)?i._getWeatherForecastGraphSelection(e):void 0,n=function(i){const e=Date.now();let t=0,a=Number.POSITIVE_INFINITY;return i.forEach(((i,n)=>{const o=i.item.datetime?new Date(i.item.datetime).getTime():Number.NaN;if(!Number.isFinite(o))return;const c=Math.abs(o-e);c<a&&(a=c,t=n)})),t}(t);return t[Math.max(0,Math.min(t.length-1,Number.isFinite(Number(a))?Number(a):n))]||t[0]}function lt(i,e,t,a){const n=i.height-i.bottom;return[...[0,1,2].map((e=>{const t=i.top+e*((n-i.top)/2);return U`<line class="weather-conditions-grid-line" x1=${i.left} x2=${i.width-i.right} y1=${t} y2=${t}></line>`})),...e.map((e=>{const o=t[e];return U`
        <line class="weather-conditions-time-line" x1=${o.x} x2=${o.x} y1=${i.top} y2=${n}></line>
        <text class="weather-conditions-time-label" x=${o.x} y=${i.height-6}>${Re(o.item,a)}</text>
      `}))]}function Mt(i,e,t,a,n){const o={width:360,height:et(e),left:14,right:42,top:15,bottom:24},{points:c,min:r,max:s}=Fe(t,"temperature",o);if(c.length<2)return G;const l=o.height-o.bottom,M=st(i,a,c),g=c.reduce(((i,e)=>e.value<i.value?e:i),c[0]),I=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),N=Be(c.length),d=function(i){if(i.length<=7)return i;const e=Math.max(1,Math.ceil(i.length/7));return i.filter(((i,t)=>t%e==0)).slice(0,7)}(c),u=Je(c),D=Xe(c,l),h=He(a),j=`weather-conditions-temp-line-${h}`,z=`weather-conditions-temp-fill-${h}`,y=(r+s)/2;return E`
    <section class="weather-conditions-card weather-conditions-temp">
      <div class="weather-conditions-head">
        ...
        <div class="weather-conditions-selected">
          <span>${Re(M.item,e.time_format)}</span>
      ...
      ${d.length?E`
        <div class="weather-conditions-icons">
          ${d.map((i=>{const e=String(i.item.condition||"");return E`
              ${We(Ge(e),`weather-conditions-icon weather-condition-${Qe(e)}`,_e(e))}
            `}))}
        </div>
      `:G}
      ...
      <div class="weather-conditions-chart-frame">
        <svg
          ...
          @pointerdown=${nt}
          @pointermove=${e=>rt(i,e,n,c.length)}
          @click=${e=>rt(i,e,n,c.length)}
        >
          <defs>
          ...
          <text class="weather-conditions-axis" x=${o.width-5} y=${o.top+(l-o.top)/2}>${y.toFixed(0)}°</text>
  ...
  `}function gt(i,e,t,a,n,o){if(t.length<2)return G;const c=`${n}-temperature`,r=`${n}-precipitation`,s=o?[c,r]:null,l=a.includes("temperature")?Mt(i,e,t,c,s||[c]):G,M=a.includes("precipitation_probability")?function(i,e,t,a,n){const o={width:360,height:et(e),left:14,right:42,top:10,bottom:22},{points:c}=Fe(t,"precipitation_probability",o);if(c.length<2)return G;const r=o.height-o.bottom,s=st(i,a,c),l=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),M=Be(c.length),g=Je(c),I=Xe(c,r),N=`weather-conditions-rain-fill-${He(a)}`;return E`
    <section class="weather-conditions-card weather-conditions-rain">
      <div class="weather-conditions-head">
        ...
        <div class="weather-conditions-selected">
          <span>${Re(s.item,e.time_format)}</span>
  ...
  `}function It(i,e){var t,a;const n=ve(xe(i,e.entity)).toLowerCase(),o=e.name||"Weather",c=ke(i,e.temp_sensor),r=function(i,e){const t=Se(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),s=ke(i,e.feels_like_sensor),l=Pe(i,e),M=!1===e.show_forecast?[]:$e(e.forecast),g=!1===e.show_forecast?[]:$e(e.daily_forecast),I=Number(e.forecast_slots),N=Number.isFinite(I)&&I>0?Math.min(Math.floor(I),72):8,d=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):we,t=[];return e.forEach((i=>{const e=Te[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:we}(e.forecast_fields),u=M.slice(0,N),D=at(M,e.time_format),h=String((null===(t=M[0])||void 0===t?void 0:t.condition)||n||"").toLowerCase(),j=h||n,z=`weather-icon weather-condition-${Qe(j)}`,y=D||_e(h||n),p=E`<span class="weather-source-badge" title="Forecast data" aria-label="Forecast data"></span>`,A=e.forecast_graph_key||`weather-${e.entity||o}`,m=!1!==e.sync_graphs,w=gt(i,e,u,d,A,m),T=tt(i,e,g,M),b=Array.isArray(e.chips)?e.chips:[],O=!!e.double_tap_action,x=Number(e.height),v=Ye(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),S=Ye(e.icon_size,28,160),L=Ye(e.graph_height,82,260),C=function(i,e){const t=Number(e.stale_minutes);if(!Number.isFinite(t)||t<=0)return!1;const a=[e.entity,e.temp_sensor,e.humidity_sensor,e.feels_like_sensor].filter(Boolean);let n=0;return a.forEach((e=>{const t=xe(i,e),a=(null==t?void 0:t.last_updated)?Date.parse(t.last_updated):NaN;Number.isFinite(a)&&(n=Math.max(n,a))})),!!n&&Date.now()-n>6e4*t}(i,e),k=[Number.isFinite(x)&&x>0?`--weather-tile-h:${x}px;`:"",v?`--weather-temp-size:${v}px;`:"",S?`--weather-icon-size:${S}px;--weather-icon-bg-size:${S+16}px;`:"",L?`--weather-graph-height:${L}px;`:""].filter(Boolean).join("");return E`
    <div class="tile-wrap weather-tile-wrap" style=${k}>
      <ha-control-button
        class=${"weather-tile"+(C?" weather-tile-stale":"")}
          ...
          <div class="weather-top">
            <div class="weather-heading">
              ...
              <div class="weather-primary">
                ...
                <span class="weather-humidity">${r}</span>
              </div>
            ...
            <div class="weather-icon-wrap weather-clickable"
              ...
              @pointerdown=${nt}
              @pointerup=${nt}
              @click=${t=>ot(i,t,e.entity)}
              @keyup=${t=>ct(i,t,e.entity)}
            >
              ${e.icon?E`<ha-icon class=${z} .icon=${e.icon}></ha-icon>`:We(Ge(j),z,_e(j))}
            </div>
          </div>
          ...
          <div class="weather-grid">
            ${l.map((e=>E`
              <div
                ...
                @keyup=${t=>ct(i,t,e.entity)}
              >
                ${We(e.icon,"weather-metric-icon",e.label)}
        ...
        ${b.length?E`<div class="weather-chips-bottom-right">
              ${b.map((e=>E`
                <div
                  ...
                  @pointerdown=${nt}
                  @pointerup=${nt}
                  @click=${t=>ot(i,t,(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity))}
