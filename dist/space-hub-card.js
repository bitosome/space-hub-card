  ...
  `}(t,b):R;return O`
    <div class="tile-wrap">
      ...
      ${l?O`<div class="chip" style=${`background:${h}`}>
          ...
          ${Array.isArray(null==e?void 0:e.chips)&&e.chips.length?O`${e.chips.filter((t=>"illuminance"!==String((null==t?void 0:t.type)||"").toLowerCase())).map((e=>Pt(t,e)))}`:R}
        </div>
