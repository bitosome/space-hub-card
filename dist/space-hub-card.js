 ...
 */var bi;null===(bi=window.HTMLSlotElement)||void 0===bi||bi.prototype.assignedElements;var Ti="[^\\s]+";function Oi(i,e){for(var t=[],a=0,n=i.length;a<n;a++)t.push(i[a].substr(0,e));return t}var xi=function(i){return function(e,t){var a=t[i].map((function(i){return i.toLowerCase()})),n=a.indexOf(e.toLowerCase());return n>-1?n:null}};function vi(i){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var a=0,n=e;a<n.length;a++){var o=n[a];for(var c in o)i[c]=o[c]}return i}var Si=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Li=["January","February","March","April","May","June","July","August","September","October","November","December"],ki=Oi(Li,3),Ci={dayNamesShort:Oi(Si,3),dayNames:Si,monthNamesShort:ki,monthNames:Li,amPm:["am","pm"],DoFn:function(i){return i+["th","st","nd","rd"][i%10>3?0:(i-i%10!=10?1:0)*i%10]}},Yi=(vi({},Ci),function(i){return+i-1}),fi=[null,"[1-9]\\d?"],_i=[null,Ti],Qi=["isPm",Ti,function(i,e){var t=i.toLowerCase();return t===e.amPm[0]?0:t===e.amPm[1]?1:null}],Ui=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(i){var e=(i+"").match(/([+-]|\d\d)/gi);if(e){var t=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?t:-t}return 0}];xi("monthNamesShort"),xi("monthNames");var Ei,Zi;!function(){try{(new Date).toLocaleDateString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(i){return"RangeError"===i.name}}(),function(i){i.language="language",i.system="system",i.comma_decimal="comma_decimal",i.decimal_comma="decimal_comma",i.space_comma="space_comma",i.none="none"}(Ei||(Ei={})),function(i){i.language="language",i.system="system",i.am_pm="12",i.twenty_four="24"}(Zi||(Zi={}));var Gi=function(i,e,t,a){a=a||{},t=null==t?{}:t;var n=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return n.detail=t,i.dispatchEvent(n),n},Wi=new Set(["call-service","divider","section","weblink","cast","select"]),Pi={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},$i=function(i,e){void 0===e&&(e=!1);var t=function(i,e){return a("hui-error-card",{type:"error",error:i,config:e})},a=function(i,e){var a=window.document.createElement(i);try{a.setConfig(e)}catch(a){return console.error(i,a),t(a.message,e)}return a};if(!i||"object"!=typeof i||!e&&!i.type)return t("No type defined",i);var n=i.type;if(n&&n.startsWith("custom:"))n=n.substr("custom:".length);else if(e)if(Wi.has(n))n="hui-"+n+"-row";else{if(!i.entity)return t("Invalid config given.",i);var o=i.entity.split(".",1)[0];n="hui-"+(Pi[o]||"text")+"-entity-row"}else n="hui-"+n+"-card";if(customElements.get(n))return a(n,i);var c=t("Custom element doesn't exist: "+i.type+".",i);c.style.display="None";var r=setTimeout((function(){c.style.display=""}),2e3);return customElements.whenDefined(i.type).then((function(){clearTimeout(r),Gi(c,"ll-rebuild",{},c)})),c};function Ri(i){return JSON.parse(JSON.stringify(i))}const Vi=new Set(["more-info","toggle","perform-action","navigate","url","assist","none","fire-dom-event","call-service"]),Fi=i=>!!i&&"object"==typeof i&&!Array.isArray(i),Bi=i=>!!((null==i?void 0:i.tap_action)||(null==i?void 0:i.hold_action)||(null==i?void 0:i.double_tap_action)),Hi=i=>{if(null==i||!1===i)return;if(!0===i)return!0;if("string"==typeof i){const e=i.trim();return!e||{text:e}}if(!Fi(i))return;const e={};if("string"==typeof i.text&&i.text.trim()&&(e.text=i.text),"string"==typeof i.title&&i.title.trim()&&(e.title=i.title),"string"==typeof i.confirm_text&&i.confirm_text.trim()&&(e.confirm_text=i.confirm_text),"string"==typeof i.dismiss_text&&i.dismiss_text.trim()&&(e.dismiss_text=i.dismiss_text),Array.isArray(i.exemptions)){const t=i.exemptions.filter((i=>!!i&&"object"==typeof i&&"string"==typeof i.user)).map((i=>({user:i.user})));t.length&&(e.exemptions=t)}return!Object.keys(e).length||e},Ji=i=>{if(Fi(i)&&"string"==typeof i.action&&Vi.has(i.action)){if("call-service"===i.action||"perform-action"===i.action){return Object.assign(Object.assign({},i),{action:"perform-action",perform_action:"string"==typeof i.perform_action?i.perform_action:"string"==typeof i.service?i.service:void 0,data:Fi(i.data)?i.data:Fi(i.service_data)?i.service_data:void 0,target:Fi(i.target)?i.target:void 0,confirmation:Hi(i.confirmation)})}return Object.assign(Object.assign({},i),{confirmation:Hi(i.confirmation)})}},Xi=["lock","door","presence","illuminance","gate","sliding_gate","smart_plug","custom"],Ki=["switch","smart_plug","lock"],qi=["static","pulse","none"],ie=["more-info","toggle","perform-action","navigate","url","assist","none"],ee="M4,12L5.41,13.41L11,7.83V20H13V7.83L18.59,13.42L20,12L12,4L4,12Z",te="M4,12L5.41,10.59L11,16.17V4H13V16.17L18.59,10.58L20,12L12,20L4,12Z",ae="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";let ne=class extends ni{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.type="text",this.disabled=!1}_onInput(i){i.stopPropagation(),this.disabled||(this.value=i.currentTarget.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}render(){return U`
    ...
    `}_renderWeatherConfig(i,e){var t,a,n,o,c,r,s,l,M,g,I;const N=i||{};return U`
      <ha-expansion-panel outlined .header=${"Weather Tile"}>
        <div class="section-content">
          ${!!i?U`
            <div class="side-by-side">
              ${this._renderEntityField("Weather Entity",`${e}.entity`,N.entity,{domain:"weather"})}
            </div>
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="18"
                max="56"
                .value=${String(null!==(t=N.temp_size)&&void 0!==t?t:"")}
              ...
              <space-hub-textfield
                ...
                min="28"
                max="160"
                .value=${String(null!==(a=N.icon_size)&&void 0!==a?a:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                .value=${String(null!==(n=N.icon_offset_x)&&void 0!==n?n:"")}
              ...
              <space-hub-textfield
                ...
                type="number"
                .value=${String(null!==(o=N.icon_offset_y)&&void 0!==o?o:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                min="0"
                .value=${String(null!==(c=N.stale_minutes)&&void 0!==c?c:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(r=N.conditions_icon_size)&&void 0!==r?r:"")}
              ...
              <space-hub-textfield
                ...
                min="0"
                max="72"
                .value=${String(null!==(s=N.temperature_icon_count)&&void 0!==s?s:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(l=N.daily_icon_size)&&void 0!==l?l:"")}
              ...
              <space-hub-textfield
                ...
                min="1"
                max="4"
                .value=${String(null!==(M=N.metric_columns)&&void 0!==M?M:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="1"
                max="72"
                .value=${String(null!==(g=N.forecast_slots)&&void 0!==g?g:"")}
              ...
              <space-hub-textfield
                ...
                min="82"
                max="260"
                .value=${String(null!==(I=N.graph_height)&&void 0!==I?I:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.graph_height`,Number.isFinite(t)&&t>0?t:void 0)}}
              ></space-hub-textfield>
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("Temperature Sensor",`${e}.temp_sensor`,N.temp_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Humidity Sensor",`${e}.humidity_sensor`,N.humidity_sensor,{domain:"sensor"})}
            </div>
            ${this._renderEntityField("Feels Like Sensor",`${e}.feels_like_sensor`,N.feels_like_sensor,{domain:"sensor"})}
            ${this._renderMetricsConfig(N.metrics&&N.metrics.length?N.metrics:this._defaultWeatherMetrics(N),e)}
            ${this._renderChipsConfig(N.chips||[],e)}
...
class pe extends ze{}pe.directiveName="unsafeSVG",pe.resultType=2;const Ae=ri(pe),me={barometer:"data:image/svg+xml;base64,","clear-day":"data:image/svg+xml;base64,","clear-night":"data:image/svg+xml;base64,",cloudy:"data:image/svg+xml;base64,",drizzle:"data:image/svg+xml;base64,",fog:"data:image/svg+xml;base64,",hail:"data:image/svg+xml;base64,","not-available":"data:image/svg+xml;base64,","partly-cloudy-day":"data:image/svg+xml;base64,","partly-cloudy-night":"data:image/svg+xml;base64,","pressure-high":"data:image/svg+xml;base64,",rain:"data:image/svg+xml;base64,",raindrop:"data:image/svg+xml;base64,",raindrops:"data:image/svg+xml;base64,",sleet:"data:image/svg+xml;base64,",snow:"data:image/svg+xml;base64,","sun-hot":"data:image/svg+xml;base64,","thermometer-colder":"data:image/svg+xml;base64,","thermometer-warmer":"data:image/svg+xml;base64,",thunderstorms:"data:image/svg+xml;base64,","thunderstorms-rain":"data:image/svg+xml;base64,","uv-index":"data:image/svg+xml;base64,","weather-alarm":"data:image/svg+xml;base64,",wind:"data:image/svg+xml;base64,","wind-alert":"data:image/svg+xml;base64,"},we=new Set(["","unknown","unavailable"]),be=["temperature","precipitation_probability"],Te={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability",rain:"precipitation",precipitation:"precipitation",humidity:"humidity",hum:"humidity",wind:"wind_speed",wind_speed:"wind_speed",gust:"wind_gust_speed",wind_gust:"wind_gust_speed",wind_gust_speed:"wind_gust_speed",uv:"uv_index",uv_index:"uv_index",cloud:"cloud_coverage",clouds:"cloud_coverage",cloud_coverage:"cloud_coverage"},Oe={"clear-night":"clear-night",cloudy:"cloudy",exceptional:"weather-alarm",fog:"fog",hail:"hail",lightning:"thunderstorms","lightning-rainy":"thunderstorms-rain",partlycloudy:"partly-cloudy-day",pouring:"rain",rainy:"rain",snowy:"snow","snowy-rainy":"sleet",sunny:"clear-day",windy:"wind","windy-variant":"wind-alert"},xe=new Map;function ve(i){return i<=0?"#3aa7ff":i<=8?"#50c5d8":i<=15?"#9bd57b":i<=22?"#ffd34a":i<=28?"#ff9d24":"#ff5d38"}function Se(i,e){var t;if(e&&(null==i?void 0:i.hass))return null===(t=i.hass.states)||void 0===t?void 0:t[e]}function Le(i){const e=void 0===(null==i?void 0:i.state)||null===(null==i?void 0:i.state)?"":String(i.state);return we.has(e.toLowerCase())?"":e}function ke(i,e){const t=Le(Se(i,e));if(!t)return;const a=Number(t);return Number.isFinite(a)?a:void 0}function Ce(i,e,t=!1){if(null==i||""===i)return"—";const a=Number(i);return Number.isFinite(a)?t&&Math.abs(a)>=1e3?`${(a/1e3).toFixed(1)}k`:a.toFixed(e):String(i)}function Ye(i,e){var t;const a=Se(i,e),n=Le(a);if(!n)return"—";const o=(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.unit_of_measurement)||"",c=Number(n);if(!Number.isFinite(c))return o?`${n} ${o}`:n;const r=Ce(c,Number.isInteger(c)?0:1);return o?`${r} ${o}`:r}function fe(i,e){const t=ke(i,e);return void 0===t?"—°":`${t.toFixed(1)}°`}function _e(i,e,t){const a=Number(i);if(Number.isFinite(a)&&!(a<=0))return Math.max(e,Math.min(t,a))}function Qe(i){if(!i)return"Weather";const e={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Storm rain","snowy-rainy":"Sleet","windy-variant":"Windy"};return e[i]?e[i]:i.replace(/[-_]/g," ").replace(/\b\w/g,(i=>i.toUpperCase()))}function Ue(i){return(i||"unknown").replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Ee(i){return Oe[i]||"partly-cloudy-day"}function Ze(i,e,t,a="img"){if("inline"===a){const a=function(i){const e=xe.get(i);if(void 0!==e)return e;const[,t]=String(me[i]||"").split("base64,");let a="";if(t&&"function"==typeof atob)try{a=atob(t)}catch(i){a=""}return xe.set(i,a),a}(i);return a?U`
    ...
    <img
      ...
      draggable="false"
    />
  `}function Ge(i,e){return i&&i.includes(":")?i:e}function We(i,e){const t=function(i,e){const t=Number.isFinite(Number(e.rain_rate_threshold))?Number(e.rain_rate_threshold):0,a=ke(i,e.rain_rate_sensor);return void 0!==a?a>t:"on"===Le(Se(i,e.rain_state_sensor)).toLowerCase()}(i,e),a=e.name||"Rain",n=e.rain_state_sensor||e.rain_rate_sensor,o=t?Ge(e.icon_active||e.icon,"mdi:weather-rainy"):Ge(e.icon_inactive||e.icon,"mdi:water-off-outline");let c;if(t){const t=function(i,e,t,a=!1){var n;const o=Se(i,e),c=Le(o);if(!c)return"—";const r=(null===(n=null==o?void 0:o.attributes)||void 0===n?void 0:n.unit_of_measurement)||"",s=Ce(c,t,a);return r?`${s} ${r}`:s}(i,e.rain_rate_sensor,1);c="—"===t?"Raining":t}else c="No rain";return{label:a,value:c,entity:n,stateEntity:n,active:t,mdi:o}}function Pe(i){return Array.isArray(i)?i.filter((i=>!!i&&"object"==typeof i)).map((i=>({condition:"string"==typeof i.condition?i.condition:void 0,datetime:"string"==typeof i.datetime?i.datetime:void 0,temperature:i.temperature,precipitation_probability:i.precipitation_probability,precipitation:i.precipitation,humidity:i.humidity,wind_speed:i.wind_speed,wind_gust_speed:i.wind_gust_speed,uv_index:i.uv_index,cloud_coverage:i.cloud_coverage,templow:i.templow}))):[]}function $e(i,e){if(!e.datetime)return"";const t=new Date(e.datetime);if(Number.isNaN(t.getTime()))return"";const{locale:a,options:n}=function(i){var e;const t=null===(e=null==i?void 0:i.hass)||void 0===e?void 0:e.locale,a=String((null==t?void 0:t.time_format)||"").toLowerCase(),n={hour:"2-digit",minute:"2-digit"};return"12"===a&&(n.hour12=!0),"24"===a&&(n.hour12=!1),{locale:null==t?void 0:t.language,options:n}}(i);return new Intl.DateTimeFormat(a,n).format(t)}function Re(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function Ve(i,e,t){const a=i.map(((i,t)=>({item:i,index:t,value:Re(i,e)}))).filter((i=>void 0!==i.value));if(!a.length)return{points:[],min:0,max:1};const n=a.map((i=>i.value)),{min:o,max:c}=function(i,e){if("precipitation_probability"===i)return{min:0,max:100};let t=Math.min(...e),a=Math.max(...e);if("temperature"===i)t=5*Math.floor((t-2)/5),a=5*Math.ceil((a+2)/5);else{const i=Math.max(.18*(a-t),1);t=Math.max(0,t-i),a+=i}return a<=t&&(a=t+1),{min:t,max:a}}(e,n),r=t.width-t.left-t.right,s=t.height-t.top-t.bottom,l=a.map(((i,e)=>{const n=1===a.length?t.left+r/2:t.left+e/(a.length-1)*r,l=t.top+(c-i.value)/(c-o)*s;return Object.assign(Object.assign({},i),{x:n,y:l})}));return{points:l,min:o,max:c}}function Fe(i){return i<=0?[]:Array.from(new Set([0,Math.floor((i-1)/3),Math.floor(2*(i-1)/3),i-1])).filter((e=>e>=0&&e<i))}function Be(i){return i.replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function He(i){if(!i.length)return"";if(1===i.length)return`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;let e=`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;for(let t=0;t<i.length-1;t+=1){const a=i[t],n=i[t+1],o=i[t-1]||a,c=i[t+2]||n,r=a.x+(n.x-o.x)/6,s=a.y+(n.y-o.y)/6,l=n.x-(c.x-a.x)/6,M=n.y-(c.y-a.y)/6;e+=` C ${r.toFixed(2)} ${s.toFixed(2)}, ${l.toFixed(2)} ${M.toFixed(2)}, ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return e}function Je(i,e){if(!i.length)return"";const t=i[0],a=i[i.length-1];return`${He(i)} L ${a.x.toFixed(2)} ${e.toFixed(2)} L ${t.x.toFixed(2)} ${e.toFixed(2)} Z`}function Xe(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";return`${e.getFullYear()}-${`${e.getMonth()+1}`.padStart(2,"0")}-${`${e.getDate()}`.padStart(2,"0")}`}function Ke(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function qe(i,e,t){return Math.max(0,Math.min(100,(i-e)/(t-e)*100))}function it(i){return _e(i.graph_height,82,260)||118}function et(i,e,t,a){const n=t.slice(0,7);if(!n.length)return G;const o=function(i){const e=new Map;return i.forEach(((i,t)=>{const a=Xe(i.datetime),n=Re(i,"temperature");if(!a||void 0===n)return;const o={item:i,value:n,x:0,y:0,index:t},c=e.get(a)||{};(!c.low||n<c.low.value)&&(c.low=o),(!c.high||n>c.high.value)&&(c.high=o),e.set(a,c)})),e}(a),{min:c,max:r}=function(i,e){const t=[];if(i.forEach((i=>{const e=Ke(i,"templow"),a=Ke(i,"temperature");void 0!==e&&t.push(e),void 0!==a&&t.push(a)})),e.forEach((i=>{const e=Re(i,"temperature");void 0!==e&&t.push(e)})),!t.length)return{min:0,max:1};let a=5*Math.floor((Math.min(...t)-2)/5),n=5*Math.ceil((Math.max(...t)+2)/5);return n<=a&&(n=a+1),{min:a,max:n}}(n,a),s=Xe((new Date).toISOString()),l=function(i,e){return ke(i,e.temp_sensor)}(i,e);return U`
    <section class="weather-daily-forecast">
      ...
      ${n.map((e=>{var t,a,n,M;const g=Xe(e.datetime),I=o.get(g),N=null!==(t=Ke(e,"templow"))&&void 0!==t?t:null===(a=null==I?void 0:I.low)||void 0===a?void 0:a.value,d=null!==(n=Ke(e,"temperature"))&&void 0!==n?n:null===(M=null==I?void 0:I.high)||void 0===M?void 0:M.value;if(void 0===N||void 0===d)return G;const u=qe(N,c,r),D=qe(d,c,r),h=Math.max(4,D-u),j=String(e.condition||""),y=Number(e.precipitation_probability),z=Number.isFinite(y)?`Rain ${Math.round(y)}%`:"",p=g===s&&void 0!==l?qe(l,c,r):void 0;return U`
          <div class="weather-daily-row">
            <div class="weather-daily-day">
              <span class="weather-daily-day-name">${function(i,e){var t,a;if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";const o=Xe((new Date).toISOString()),c=new Date;c.setDate(c.getDate()+1);const r=Xe(e);return r===o?"Today":r===Xe(c.toISOString())?"Tomorrow":new Intl.DateTimeFormat(null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.locale)||void 0===a?void 0:a.language,{weekday:"long"}).format(n)}(i,e.datetime)}</span>
            ...
            <div class="weather-daily-condition">
              ${Ze(Ee(j),`weather-daily-icon weather-condition-${Ue(j)}`,Qe(j))}
              ${z?U`<span title="Chance of precipitation">${z}</span>`:G}
            </div>
            <div class="weather-daily-low">
              <span>${N.toFixed(0)}°</span>
              ${(null==I?void 0:I.low)?U`<small>${$e(i,I.low.item)}</small>`:G}
            </div>
            <div class="weather-daily-range">
              <div class="weather-daily-track"></div>
              <div
                class="weather-daily-segment"
                style=${`left:${u.toFixed(1)}%;width:${h.toFixed(1)}%;background:linear-gradient(90deg, ${ve(N)}, ${ve(d)});`}
              ></div>
              ${void 0!==p?U`
            ...
            <div class="weather-daily-high">
              ...
              ${(null==I?void 0:I.high)?U`<small>${$e(i,I.high.item)}</small>`:G}
            </div>
          </div>
        `}))}
    </section>
  `}function tt(i,e){if(!e.length)return"";const t=e[0],a=e.slice(0,12).reduce(((i,e)=>{const t=Number(i.precipitation_probability)||0,a=Number(e.precipitation_probability)||0,n=Number(i.precipitation)||0,o=Number(e.precipitation)||0;return o>n||o===n&&a>t?e:i}),t),n=Number(a.precipitation_probability)||0,o=Number(a.precipitation)||0;if(n>=25||o>0){const e=a===t,c=$e(i,a);let r;r=n>=80||o>=2?"Rain likely":n>=50||o>=.5?"Showers possible":"Slight chance of rain";const s=e?"shortly":c?`around ${c}`:"";return`${s?`${r} ${s}`:r} (${n>0?`${Math.round(n)}% chance`:`${o.toFixed(1)} mm`})`}return`${Qe(String(t.condition||""))}, ${c=t,`${Ce(c.temperature,0)}°`}`;var c}function at(i){i.stopPropagation()}function nt(i,e,t){e.preventDefault(),e.stopPropagation(),t&&"function"==typeof(null==i?void 0:i._openMoreInfo)&&i._openMoreInfo(t)}function ot(i,e,t){"Enter"!==e.key&&" "!==e.key||nt(i,e,t)}function ct(i,e,t,a,n){if(e.stopPropagation(),!a||"function"!=typeof(null==i?void 0:i._setWeatherForecastGraphSelection))return;const o=e.currentTarget.getBoundingClientRect();if(!o.width)return;const c=(e.clientX-o.left)/o.width,r=n.left/n.width,s=(n.width-n.right)/n.width,l=Math.max(0,Math.min(1,(c-r)/(s-r))),M=Math.round(l*(a-1));t.forEach((e=>i._setWeatherForecastGraphSelection(e,M)))}function rt(i,e,t){const a="function"==typeof(null==i?void 0:i._getWeatherForecastGraphSelection)?i._getWeatherForecastGraphSelection(e):void 0,n=function(i){const e=Date.now();let t=0,a=Number.POSITIVE_INFINITY;return i.forEach(((i,n)=>{const o=i.item.datetime?new Date(i.item.datetime).getTime():Number.NaN;if(!Number.isFinite(o))return;const c=Math.abs(o-e);c<a&&(a=c,t=n)})),t}(t);return t[Math.max(0,Math.min(t.length-1,Number.isFinite(Number(a))?Number(a):n))]||t[0]}function st(i,e,t,a){const n=e.height-e.bottom;return[...[0,1,2].map((i=>{const t=e.top+i*((n-e.top)/2);return E`<line class="weather-conditions-grid-line" x1=${e.left} x2=${e.width-e.right} y1=${t} y2=${t}></line>`})),...t.map((t=>{const o=a[t];return E`
        <line class="weather-conditions-time-line" x1=${o.x} x2=${o.x} y1=${e.top} y2=${n}></line>
        <text class="weather-conditions-time-label" x=${o.x} y=${e.height-6}>${$e(i,o.item)}</text>
      `}))]}function lt(i,e,t,a,n){const o={width:360,height:it(e),left:14,right:30,top:15,bottom:24},{points:c,min:r,max:s}=Ve(t,"temperature",o);if(c.length<2)return G;const l=o.height-o.bottom,M=rt(i,a,c),g=c.reduce(((i,e)=>e.value<i.value?e:i),c[0]),I=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),N=Fe(c.length),d=function(i,e){if(e<=0)return[];if(i.length<=e)return i;if(1===e)return[i[0]];const t=[];let a=-1;for(let n=0;n<e;n+=1){const o=Math.round(n/(e-1)*(i.length-1));o!==a&&(t.push(i[o]),a=o)}return t}(c,function(i){const e=Number(i.temperature_icon_count);return Number.isFinite(e)?Math.max(0,Math.min(72,Math.floor(e))):8}(e)),u=He(c),D=Je(c,l),h=Be(a),j=`weather-conditions-temp-line-${h}`,y=`weather-conditions-temp-fill-${h}`,z=(r+s)/2;return U`
    <section class="weather-conditions-card weather-conditions-temp">
        ...
        <div class="weather-conditions-icons">
          ${d.map((i=>{const e=String(i.item.condition||""),t=i.x/o.width*100;return U`
              <span class="weather-conditions-icon-slot" style=${`left:${t.toFixed(2)}%;`}>
                ${Ze(Ee(e),`weather-conditions-icon weather-condition-${Ue(e)}`,Qe(e))}
              </span>
            `}))}
        </div>
      `:G}
      ...
      <div class="weather-conditions-chart-frame">
        <svg
          ...
          @pointerdown=${at}
          @pointermove=${e=>ct(i,e,n,c.length,o)}
          @click=${e=>ct(i,e,n,c.length,o)}
        >
          <defs>
            ...
            <linearGradient id=${j} x1=${o.left} x2=${o.width-o.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
              ${c.map(((i,e)=>E`
                <stop offset=${e/(c.length-1)*100+"%"} stop-color=${ve(i.value)}></stop>
              `))}
            </linearGradient>
          </defs>
          ${st(i,o,N,c)}
  ...
  `}function Mt(i,e,t,a,n,o){if(t.length<2)return G;const c=`${n}-temperature`,r=`${n}-precipitation`,s=o?[c,r]:null,l=a.includes("temperature")?lt(i,e,t,c,s||[c]):G,M=a.includes("precipitation_probability")?function(i,e,t,a,n){const o={width:360,height:it(e),left:14,right:30,top:10,bottom:22},{points:c}=Ve(t,"precipitation_probability",o);if(c.length<2)return G;const r=o.height-o.bottom,s=rt(i,a,c),l=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),M=Fe(c.length),g=He(c),I=Je(c,r),N=`weather-conditions-rain-fill-${Be(a)}`;return U`
  ...
  `}function gt(i,e){var t,a;const n=Le(Se(i,e.entity)).toLowerCase(),o=e.name||"Weather",c=fe(i,e.temp_sensor),r=function(i,e){const t=ke(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),s=fe(i,e.feels_like_sensor),l=function(i,e){const t=Array.isArray(e.metrics)&&e.metrics.length?e.metrics:function(i){const e=[{entity:i.wind_speed_sensor,name:"Wind"},{entity:i.wind_gust_sensor,name:"Gust"},{entity:i.temp_min_24h_sensor,name:"24h Min"},{entity:i.temp_max_24h_sensor,name:"24h Max"},{entity:i.uv_sensor,name:"UV"},{entity:i.solar_lux_sensor,name:"Solar"},{entity:i.pressure_sensor,name:"Pressure"}].filter((i=>i.entity));return(i.rain_state_sensor||i.rain_rate_sensor)&&e.splice(4,0,{type:"rain",name:"Rain",rain_state_sensor:i.rain_state_sensor,rain_rate_sensor:i.rain_rate_sensor,rain_rate_threshold:i.rain_rate_threshold}),e}(e);return t.filter((i=>i&&("rain"===i.type?i.rain_state_sensor||i.rain_rate_sensor:i.entity))).map((e=>{var t;if("rain"===e.type)return We(i,e);const a=Se(i,e.entity);return{label:e.name||(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.friendly_name)||e.entity||"",value:Ye(i,e.entity),entity:e.entity,mdi:e.icon||void 0,stateEntity:e.entity}}))}(i,e),M=!1===e.show_forecast?[]:Pe(e.forecast),g=!1===e.show_forecast?[]:Pe(e.daily_forecast),I=Number(e.forecast_slots),N=Number.isFinite(I)&&I>0?Math.min(Math.floor(I),72):8,d=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):be,t=[];return e.forEach((i=>{const e=Te[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:be}(e.forecast_fields),u=M.slice(0,N),D=tt(i,M),h=String((null===(t=M[0])||void 0===t?void 0:t.condition)||n||"").toLowerCase(),j=h||n,y=`weather-icon weather-condition-${Ue(j)}`,z=D||Qe(h||n),p=U`<span class="weather-source-badge" title="Forecast data" aria-label="Forecast data"></span>`,A=e.forecast_graph_key||`weather-${e.entity||o}`,m=!1!==e.sync_graphs,w=Mt(i,e,u,d,A,m),b=et(i,e,g,M),T=Array.isArray(e.chips)?e.chips:[],O=_e(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),x=_e(e.icon_size,28,160),v=_e(e.graph_height,82,260),S=Number(e.icon_offset_x),L=Number(e.icon_offset_y),k=_e(e.conditions_icon_size,8,48),C=_e(e.daily_icon_size,8,48),Y=Number(e.metric_columns),f=Number.isFinite(Y)&&Y>0?Math.max(1,Math.min(4,Math.round(Y))):3,_=function(i,e){const t=Number(e.stale_minutes);if(!Number.isFinite(t)||t<=0)return!1;const a=[e.entity,e.temp_sensor,e.humidity_sensor,e.feels_like_sensor].filter(Boolean);let n=0;return a.forEach((e=>{const t=Se(i,e),a=(null==t?void 0:t.last_updated)?Date.parse(t.last_updated):NaN;Number.isFinite(a)&&(n=Math.max(n,a))})),!!n&&Date.now()-n>6e4*t}(i,e),Q=[O?`--weather-temp-size:${O}px;`:"",x?`--weather-icon-size:${x}px;--weather-icon-bg-size:${x+16}px;`:"",Number.isFinite(S)?`--weather-icon-x:${S}px;`:"",Number.isFinite(L)?`--weather-icon-y:${L}px;`:"",k?`--weather-conditions-icon-size:${k}px;`:"",C?`--weather-daily-icon-size:${C}px;`:"",v?`--weather-graph-height:${v}px;`:"",`--weather-metric-columns:${f};`].filter(Boolean).join("");return U`
    <div class="tile-wrap weather-tile-wrap" style=${Q}>
      <div class=${"weather-tile"+(_?" weather-tile-stale":"")}>
        <div class="weather-content">
          <div class="weather-top">
            ...
            >
              ${e.icon?U`<ha-icon class=${y} .icon=${e.icon}></ha-icon>`:Ze(Ee(j),y,Qe(j),"inline")}
            </div>
          </div>
