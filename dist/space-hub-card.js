          ...
          ${!!i?E`
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(u=A.conditions_icon_size)&&void 0!==u?u:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                max="2.5"
                step="0.05"
                .value=${String(null!==(I=A.conditions_icon_scale)&&void 0!==I?I:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.conditions_icon_scale`,Number.isFinite(t)&&t>0?t:void 0)}}
              ></space-hub-textfield>
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(h=A.temperature_readout_icon_size)&&void 0!==h?h:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.temperature_readout_icon_size`,Number.isFinite(t)&&t>0?t:void 0)}}
              ></space-hub-textfield>
            </div>
            <div class="side-by-side">
              <space-hub-textfield
                ...
                max="2.5"
                step="0.05"
                .value=${String(null!==(D=A.temperature_readout_icon_scale)&&void 0!==D?D:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.temperature_readout_icon_scale`,Number.isFinite(t)&&t>0?t:void 0)}}
              ></space-hub-textfield>
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(j=A.daily_icon_size)&&void 0!==j?j:"")}
