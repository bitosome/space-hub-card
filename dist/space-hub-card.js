      ...
      <div class="tile-wrap">
        ...
        >
          <div class="tile-inner">
            ${g?O`<ha-chip style=${`--ha-chip-background-color:${b};--chip-background-color:${b};--ha-chip-text-color:${_};color:${_};font-weight:600;`}>
                  ${o?O`<ha-icon .icon=${o} style=${`margin-right:6px;${u}color:${_};`}></ha-icon>`:R}
                  ${n||i}
                </ha-chip>`:O`
    ...
    <div class="tile-wrap">
      ...
      >
        ...
        <div class="temperature-chip-container">
          ${y?O`<ha-chip style=${`--ha-chip-background-color:${b};--chip-background-color:${b};--ha-chip-text-color:${_};color:${_};font-weight:700;`}>${p}</ha-chip>`:O`<div class="temperature-chip" style=${`background:${b};color:${_};`}><span class="thermostat-target">${p}</span></div>`}
        </div>
        <div class="center-xy">
