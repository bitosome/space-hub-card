 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ji=i=>!(i=>null===i||"object"!=typeof i&&"function"!=typeof i)(i)&&"function"==typeof i.then,yi=1073741823;const zi=ci(class extends ui{constructor(){super(...arguments),this._$C_t=yi,this._$Cwt=[],this._$Cq=new Di(this),this._$CK=new hi}render(...i){var e;return null!==(e=i.find((i=>!ji(i))))&&void 0!==e?e:Z}update(i,e){const t=this._$Cwt;let a=t.length;this._$Cwt=e;const n=this._$Cq,o=this._$CK;this.isConnected||this.disconnected();for(let i=0;i<e.length&&!(i>this._$C_t);i++){const r=e[i];if(!ji(r))return this._$C_t=i,r;i<a&&r===t[i]||(this._$C_t=yi,a=0,Promise.resolve(r).then((async i=>{for(;o.get();)await o.get();const e=n.deref();if(void 0!==e){const t=e._$Cwt.indexOf(r);t>-1&&t<e._$C_t&&(e._$C_t=t,e.setValue(i))}})))}return Z}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),pi=i=>e=>"function"==typeof e?((i,e)=>(customElements.define(i,e),e))(i,e):((i,e)=>{const{kind:t,elements:a}=e;return{kind:t,elements:a,finisher(e){customElements.define(i,e)}}})(i,e)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */var wi;null===(wi=window.HTMLSlotElement)||void 0===wi||wi.prototype.assignedElements;var Ti="[^\\s]+";function Oi(i,e){for(var t=[],a=0,n=i.length;a<n;a++)t.push(i[a].substr(0,e));return t}var xi=function(i){return function(e,t){var a=t[i].map((function(i){return i.toLowerCase()})),n=a.indexOf(e.toLowerCase());return n>-1?n:null}};function vi(i){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var a=0,n=e;a<n.length;a++){var o=n[a];for(var r in o)i[r]=o[r]}return i}var Si=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Li=["January","February","March","April","May","June","July","August","September","October","November","December"],ki=Oi(Li,3),Ci={dayNamesShort:Oi(Si,3),dayNames:Si,monthNamesShort:ki,monthNames:Li,amPm:["am","pm"],DoFn:function(i){return i+["th","st","nd","rd"][i%10>3?0:(i-i%10!=10?1:0)*i%10]}},_i=(vi({},Ci),function(i){return+i-1}),Yi=[null,"[1-9]\\d?"],fi=[null,Ti],Qi=["isPm",Ti,function(i,e){var t=i.toLowerCase();return t===e.amPm[0]?0:t===e.amPm[1]?1:null}],Ei=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(i){var e=(i+"").match(/([+-]|\d\d)/gi);if(e){var t=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?t:-t}return 0}];xi("monthNamesShort"),xi("monthNames");var Ui,Zi;!function(){try{(new Date).toLocaleDateString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(i){return"RangeError"===i.name}}(),function(i){i.language="language",i.system="system",i.comma_decimal="comma_decimal",i.decimal_comma="decimal_comma",i.space_comma="space_comma",i.none="none"}(Ui||(Ui={})),function(i){i.language="language",i.system="system",i.am_pm="12",i.twenty_four="24"}(Zi||(Zi={}));var Gi=function(i,e,t,a){a=a||{},t=null==t?{}:t;var n=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return n.detail=t,i.dispatchEvent(n),n},Wi=new Set(["call-service","divider","section","weblink","cast","select"]),Pi={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},$i=function(i,e){void 0===e&&(e=!1);var t=function(i,e){return a("hui-error-card",{type:"error",error:i,config:e})},a=function(i,e){var a=window.document.createElement(i);try{a.setConfig(e)}catch(a){return console.error(i,a),t(a.message,e)}return a};if(!i||"object"!=typeof i||!e&&!i.type)return t("No type defined",i);var n=i.type;if(n&&n.startsWith("custom:"))n=n.substr("custom:".length);else if(e)if(Wi.has(n))n="hui-"+n+"-row";else{if(!i.entity)return t("Invalid config given.",i);var o=i.entity.split(".",1)[0];n="hui-"+(Pi[o]||"text")+"-entity-row"}else n="hui-"+n+"-card";if(customElements.get(n))return a(n,i);var r=t("Custom element doesn't exist: "+i.type+".",i);r.style.display="None";var c=setTimeout((function(){r.style.display=""}),2e3);return customElements.whenDefined(i.type).then((function(){clearTimeout(c),Gi(r,"ll-rebuild",{},r)})),r};function Ri(i){return JSON.parse(JSON.stringify(i))}const Vi=new Set(["more-info","toggle","perform-action","navigate","url","assist","none","fire-dom-event","call-service"]),Fi=i=>!!i&&"object"==typeof i&&!Array.isArray(i),Bi=i=>!!((null==i?void 0:i.tap_action)||(null==i?void 0:i.hold_action)||(null==i?void 0:i.double_tap_action)),Hi=i=>{if(null==i||!1===i)return;if(!0===i)return!0;if("string"==typeof i){const e=i.trim();return!e||{text:e}}if(!Fi(i))return;const e={};if("string"==typeof i.text&&i.text.trim()&&(e.text=i.text),"string"==typeof i.title&&i.title.trim()&&(e.title=i.title),"string"==typeof i.confirm_text&&i.confirm_text.trim()&&(e.confirm_text=i.confirm_text),"string"==typeof i.dismiss_text&&i.dismiss_text.trim()&&(e.dismiss_text=i.dismiss_text),Array.isArray(i.exemptions)){const t=i.exemptions.filter((i=>!!i&&"object"==typeof i&&"string"==typeof i.user)).map((i=>({user:i.user})));t.length&&(e.exemptions=t)}return!Object.keys(e).length||e},Ji=i=>{if(Fi(i)&&"string"==typeof i.action&&Vi.has(i.action)){if("call-service"===i.action||"perform-action"===i.action){return Object.assign(Object.assign({},i),{action:"perform-action",perform_action:"string"==typeof i.perform_action?i.perform_action:"string"==typeof i.service?i.service:void 0,data:Fi(i.data)?i.data:Fi(i.service_data)?i.service_data:void 0,target:Fi(i.target)?i.target:void 0,confirmation:Hi(i.confirmation)})}return Object.assign(Object.assign({},i),{confirmation:Hi(i.confirmation)})}},Xi=["lock","door","presence","illuminance","gate","sliding_gate","smart_plug","custom"],Ki=["switch","smart_plug","lock"],qi=["static","pulse","none"],ie=["more-info","toggle","perform-action","navigate","url","assist","none"],ee="M4,12L5.41,13.41L11,7.83V20H13V7.83L18.59,13.42L20,12L12,4L4,12Z",te="M4,12L5.41,10.59L11,16.17V4H13V16.17L18.59,10.58L20,12L12,20L4,12Z",ae="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";let ne=class extends ni{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.type="text",this.disabled=!1}_onInput(i){i.stopPropagation(),this.disabled||(this.value=i.currentTarget.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}render(){return E`
    ...
    `}_renderWeatherConfig(i,e){var t,a,n,o,r,c,s,l,M,g,d;const N=i||{};return E`
          ...
          ${!!i?E`
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                min="0"
                .value=${String(null!==(r=N.stale_minutes)&&void 0!==r?r:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(c=N.conditions_icon_size)&&void 0!==c?c:"")}
            ...
            <div class="side-by-side">
              ...
              <space-hub-textfield
                ...
                min="82"
                max="260"
                .value=${String(null!==(d=N.graph_height)&&void 0!==d?d:"")}
...
class pe extends ze{}pe.directiveName="unsafeSVG",pe.resultType=2;const me=ci(pe),Ae={barometer:"data:image/svg+xml;base64,","clear-day":"data:image/svg+xml;base64,","clear-night":"data:image/svg+xml;base64,",cloudy:"data:image/svg+xml;base64,",drizzle:"data:image/svg+xml;base64,",fog:"data:image/svg+xml;base64,",hail:"data:image/svg+xml;base64,","not-available":"data:image/svg+xml;base64,","partly-cloudy-day":"data:image/svg+xml;base64,","partly-cloudy-night":"data:image/svg+xml;base64,","pressure-high":"data:image/svg+xml;base64,",rain:"data:image/svg+xml;base64,",raindrop:"data:image/svg+xml;base64,",raindrops:"data:image/svg+xml;base64,",sleet:"data:image/svg+xml;base64,",snow:"data:image/svg+xml;base64,","sun-hot":"data:image/svg+xml;base64,","thermometer-colder":"data:image/svg+xml;base64,","thermometer-warmer":"data:image/svg+xml;base64,",thunderstorms:"data:image/svg+xml;base64,","thunderstorms-rain":"data:image/svg+xml;base64,","uv-index":"data:image/svg+xml;base64,","weather-alarm":"data:image/svg+xml;base64,",wind:"data:image/svg+xml;base64,","wind-alert":"data:image/svg+xml;base64,"},be=new Set(["","unknown","unavailable"]),we=["temperature","precipitation_probability"],Te={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability",rain:"precipitation",precipitation:"precipitation",humidity:"humidity",hum:"humidity",wind:"wind_speed",wind_speed:"wind_speed",gust:"wind_gust_speed",wind_gust:"wind_gust_speed",wind_gust_speed:"wind_gust_speed",uv:"uv_index",uv_index:"uv_index",cloud:"cloud_coverage",clouds:"cloud_coverage",cloud_coverage:"cloud_coverage"},Oe={"clear-night":"clear-night",cloudy:"cloudy",exceptional:"weather-alarm",fog:"fog",hail:"hail",lightning:"thunderstorms","lightning-rainy":"thunderstorms-rain",partlycloudy:"partly-cloudy-day",pouring:"rain",rainy:"rain",snowy:"snow","snowy-rainy":"sleet",sunny:"clear-day",windy:"wind","windy-variant":"wind-alert"},xe=new Map;function ve(i){return i<=0?"#3aa7ff":i<=8?"#50c5d8":i<=15?"#9bd57b":i<=22?"#ffd34a":i<=28?"#ff9d24":"#ff5d38"}function Se(i,e){var t;if(e&&(null==i?void 0:i.hass))return null===(t=i.hass.states)||void 0===t?void 0:t[e]}function Le(i){const e=void 0===(null==i?void 0:i.state)||null===(null==i?void 0:i.state)?"":String(i.state);return be.has(e.toLowerCase())?"":e}function ke(i,e){const t=Le(Se(i,e));if(!t)return;const a=Number(t);return Number.isFinite(a)?a:void 0}function Ce(i,e,t=!1){if(null==i||""===i)return"—";const a=Number(i);return Number.isFinite(a)?t&&Math.abs(a)>=1e3?`${(a/1e3).toFixed(1)}k`:a.toFixed(e):String(i)}function _e(i,e){var t;const a=Se(i,e),n=Le(a);if(!n)return"—";const o=(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.unit_of_measurement)||"",r=Number(n);if(!Number.isFinite(r))return o?`${n} ${o}`:n;const c=Ce(r,Number.isInteger(r)?0:1);return o?`${c} ${o}`:c}function Ye(i,e){const t=ke(i,e);return void 0===t?"—°":`${t.toFixed(1)}°`}function fe(i,e,t){const a=Number(i);if(Number.isFinite(a)&&!(a<=0))return Math.max(e,Math.min(t,a))}function Qe(i){if(!i)return"Weather";const e={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Storm rain","snowy-rainy":"Sleet","windy-variant":"Windy"};return e[i]?e[i]:i.replace(/[-_]/g," ").replace(/\b\w/g,(i=>i.toUpperCase()))}function Ee(i){return(i||"unknown").replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Ue(i){return Oe[i]||"partly-cloudy-day"}function Ze(i,e,t,a="img"){if("inline"===a){const a=function(i){const e=xe.get(i);if(void 0!==e)return e;const[,t]=String(Ae[i]||"").split("base64,");let a="";if(t&&"function"==typeof atob)try{a=atob(t)}catch(i){a=""}return xe.set(i,a),a}(i);return a?E`
    ...
    <img
      ...
      draggable="false"
    />
  `}function Ge(i,e){return i&&i.includes(":")?i:e}function We(i,e){const t=function(i,e){const t=Number.isFinite(Number(e.rain_rate_threshold))?Number(e.rain_rate_threshold):0,a=ke(i,e.rain_rate_sensor);return void 0!==a?a>t:"on"===Le(Se(i,e.rain_state_sensor)).toLowerCase()}(i,e),a=e.name||"Rain",n=e.rain_state_sensor||e.rain_rate_sensor,o=t?Ge(e.icon_active||e.icon,"mdi:weather-rainy"):Ge(e.icon_inactive||e.icon,"mdi:water-off-outline");let r;if(t){const t=function(i,e,t,a=!1){var n;const o=Se(i,e),r=Le(o);if(!r)return"—";const c=(null===(n=null==o?void 0:o.attributes)||void 0===n?void 0:n.unit_of_measurement)||"",s=Ce(r,t,a);return c?`${s} ${c}`:s}(i,e.rain_rate_sensor,1);r="—"===t?"Raining":t}else r="No rain";return{label:a,value:r,entity:n,stateEntity:n,active:t,mdi:o}}function Pe(i){return Array.isArray(i)?i.filter((i=>!!i&&"object"==typeof i)).map((i=>({condition:"string"==typeof i.condition?i.condition:void 0,datetime:"string"==typeof i.datetime?i.datetime:void 0,temperature:i.temperature,precipitation_probability:i.precipitation_probability,precipitation:i.precipitation,humidity:i.humidity,wind_speed:i.wind_speed,wind_gust_speed:i.wind_gust_speed,uv_index:i.uv_index,cloud_coverage:i.cloud_coverage,templow:i.templow}))):[]}function $e(i,e){if(!e.datetime)return"";const t=new Date(e.datetime);if(Number.isNaN(t.getTime()))return"";const{locale:a,options:n}=function(i){var e;const t=null===(e=null==i?void 0:i.hass)||void 0===e?void 0:e.locale,a=String((null==t?void 0:t.time_format)||"").toLowerCase(),n={hour:"2-digit",minute:"2-digit"};return"12"===a&&(n.hour12=!0),"24"===a&&(n.hour12=!1),{locale:null==t?void 0:t.language,options:n}}(i);return new Intl.DateTimeFormat(a,n).format(t)}function Re(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function Ve(i,e,t){const a=i.reduce(((i,t,a)=>{const n=Re(t,e);if(void 0===n)return i;const o=function(i){if(!i.datetime)return;const e=new Date(i.datetime).getTime();return Number.isFinite(e)?e:void 0}(t),r={item:t,index:a,value:n};return void 0!==o&&(r.timestamp=o),i.push(r),i}),[]);if(!a.length)return{points:[],min:0,max:1};const n=a.every((i=>Number.isFinite(i.timestamp))),o=n?[...a].sort(((i,e)=>Number(i.timestamp)-Number(e.timestamp))):a,r=n?Number(o[0].timestamp):0,c=(n?Number(o[o.length-1].timestamp):0)-r,s=a.map((i=>i.value)),{min:l,max:M}=function(i,e){if("precipitation_probability"===i)return{min:0,max:100};let t=Math.min(...e),a=Math.max(...e);if("temperature"===i)t=5*Math.floor((t-2)/5),a=5*Math.ceil((a+2)/5);else{const i=Math.max(.18*(a-t),1);t=Math.max(0,t-i),a+=i}return a<=t&&(a=t+1),{min:t,max:a}}(e,s),g=t.width-t.left-t.right,d=t.height-t.top-t.bottom,N=o.map(((i,e)=>{const a=n&&c>0?t.left+(Number(i.timestamp)-r)/c*g:1===o.length?t.left+g/2:t.left+e/(o.length-1)*g,s=t.top+(M-i.value)/(M-l)*d;return Object.assign(Object.assign({},i),{x:a,y:s})}));return{points:N,min:l,max:M}}function Fe(i){return i<=0?[]:Array.from(new Set([0,Math.floor((i-1)/3),Math.floor(2*(i-1)/3),i-1])).filter((e=>e>=0&&e<i))}function Be(i){return i.replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function He(i){if(!i.length)return"";if(1===i.length)return`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;let e=`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;for(let t=0;t<i.length-1;t+=1){const a=i[t],n=i[t+1],o=i[t-1]||a,r=i[t+2]||n,c=a.x+(n.x-o.x)/6,s=a.y+(n.y-o.y)/6,l=n.x-(r.x-a.x)/6,M=n.y-(r.y-a.y)/6;e+=` C ${c.toFixed(2)} ${s.toFixed(2)}, ${l.toFixed(2)} ${M.toFixed(2)}, ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return e}function Je(i,e){if(!i.length)return"";const t=i[0],a=i[i.length-1];return`${He(i)} L ${a.x.toFixed(2)} ${e.toFixed(2)} L ${t.x.toFixed(2)} ${e.toFixed(2)} Z`}function Xe(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";return`${e.getFullYear()}-${`${e.getMonth()+1}`.padStart(2,"0")}-${`${e.getDate()}`.padStart(2,"0")}`}function Ke(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function qe(i,e,t){return Math.max(0,Math.min(100,(i-e)/(t-e)*100))}function it(i){return fe(i.graph_height,82,260)||118}function et(i,e,t,a){const n=t.slice(0,7);if(!n.length)return G;const o=function(i){const e=new Map;return i.forEach(((i,t)=>{const a=Xe(i.datetime),n=Re(i,"temperature");if(!a||void 0===n)return;const o={item:i,value:n,x:0,y:0,index:t},r=e.get(a)||{};(!r.low||n<r.low.value)&&(r.low=o),(!r.high||n>r.high.value)&&(r.high=o),e.set(a,r)})),e}(a),{min:r,max:c}=function(i,e){const t=[];if(i.forEach((i=>{const e=Ke(i,"templow"),a=Ke(i,"temperature");void 0!==e&&t.push(e),void 0!==a&&t.push(a)})),e.forEach((i=>{const e=Re(i,"temperature");void 0!==e&&t.push(e)})),!t.length)return{min:0,max:1};let a=5*Math.floor((Math.min(...t)-2)/5),n=5*Math.ceil((Math.max(...t)+2)/5);return n<=a&&(n=a+1),{min:a,max:n}}(n,a),s=Xe((new Date).toISOString()),l=function(i,e){return ke(i,e.temp_sensor)}(i,e);return E`
    <section class="weather-daily-forecast">
      ...
      ${n.map((e=>{var t,a,n,M;const g=Xe(e.datetime),d=o.get(g),N=null!==(t=Ke(e,"templow"))&&void 0!==t?t:null===(a=null==d?void 0:d.low)||void 0===a?void 0:a.value,I=null!==(n=Ke(e,"temperature"))&&void 0!==n?n:null===(M=null==d?void 0:d.high)||void 0===M?void 0:M.value;if(void 0===N||void 0===I)return G;const u=qe(N,r,c),D=qe(I,r,c),h=Math.max(4,D-u),j=String(e.condition||""),y=Number(e.precipitation_probability),z=Number.isFinite(y)?`Rain ${Math.round(y)}%`:"",p=g===s&&void 0!==l?qe(l,r,c):void 0;return E`
          <div class="weather-daily-row">
            <div class="weather-daily-day">
              <span class="weather-daily-day-name">${function(i,e){var t,a;if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";const o=Xe((new Date).toISOString()),r=new Date;r.setDate(r.getDate()+1);const c=Xe(e);return c===o?"Today":c===Xe(r.toISOString())?"Tomorrow":new Intl.DateTimeFormat(null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.locale)||void 0===a?void 0:a.language,{weekday:"long"}).format(n)}(i,e.datetime)}</span>
            ...
            <div class="weather-daily-condition">
              ${Ze(Ue(j),`weather-daily-icon weather-condition-${Ee(j)}`,Qe(j))}
              ${z?E`<span title="Chance of precipitation">${z}</span>`:G}
            </div>
            <div class="weather-daily-low">
              <span>${N.toFixed(0)}°</span>
              ${(null==d?void 0:d.low)?E`<small>${$e(i,d.low.item)}</small>`:G}
            </div>
            <div class="weather-daily-range">
              <div class="weather-daily-track"></div>
              <div
                class="weather-daily-segment"
                style=${`left:${u.toFixed(1)}%;width:${h.toFixed(1)}%;background:linear-gradient(90deg, ${ve(N)}, ${ve(I)});`}
              ></div>
              ${void 0!==p?E`
            ...
            <div class="weather-daily-high">
              ...
              ${(null==d?void 0:d.high)?E`<small>${$e(i,d.high.item)}</small>`:G}
            </div>
          </div>
        `}))}
    </section>
  `}function tt(i,e){if(!e.length)return"";const t=e[0],a=e.slice(0,12).reduce(((i,e)=>{const t=Number(i.precipitation_probability)||0,a=Number(e.precipitation_probability)||0,n=Number(i.precipitation)||0,o=Number(e.precipitation)||0;return o>n||o===n&&a>t?e:i}),t),n=Number(a.precipitation_probability)||0,o=Number(a.precipitation)||0;if(n>=25||o>0){const e=a===t,r=$e(i,a);let c;c=n>=80||o>=2?"Rain likely":n>=50||o>=.5?"Showers possible":"Slight chance of rain";const s=e?"shortly":r?`around ${r}`:"";return`${s?`${c} ${s}`:c} (${n>0?`${Math.round(n)}% chance`:`${o.toFixed(1)} mm`})`}return`${Qe(String(t.condition||""))}, ${r=t,`${Ce(r.temperature,0)}°`}`;var r}function at(i){i.stopPropagation()}function nt(i,e,t){e.preventDefault(),e.stopPropagation(),t&&"function"==typeof(null==i?void 0:i._openMoreInfo)&&i._openMoreInfo(t)}function ot(i,e,t){"Enter"!==e.key&&" "!==e.key||nt(i,e,t)}function rt(i,e,t,a,n){if(e.stopPropagation(),!a.length||"function"!=typeof(null==i?void 0:i._setWeatherForecastGraphSelection))return;const o=e.currentTarget.getBoundingClientRect();if(!o.width)return;const r=(e.clientX-o.left)/o.width,c=Math.max(0,Math.min(n.width,r*n.width)),s=a.reduce(((i,e,t)=>{const n=a[i];return Math.abs(e.x-c)<Math.abs(n.x-c)?t:i}),0);t.forEach((e=>i._setWeatherForecastGraphSelection(e,s)))}function ct(i,e,t){const a="function"==typeof(null==i?void 0:i._getWeatherForecastGraphSelection)?i._getWeatherForecastGraphSelection(e):void 0,n=function(i){const e=Date.now();let t=0,a=Number.POSITIVE_INFINITY;return i.forEach(((i,n)=>{const o=i.item.datetime?new Date(i.item.datetime).getTime():Number.NaN;if(!Number.isFinite(o))return;const r=Math.abs(o-e);r<a&&(a=r,t=n)})),t}(t);return t[Math.max(0,Math.min(t.length-1,Number.isFinite(Number(a))?Number(a):n))]||t[0]}function st(i,e,t,a){const n=e.height-e.bottom;return[...[0,1,2].map((i=>{const t=e.top+i*((n-e.top)/2);return U`<line class="weather-conditions-grid-line" x1=${e.left} x2=${e.width-e.right} y1=${t} y2=${t}></line>`})),...t.map((t=>{const o=a[t];return U`
      ...
      `}))]}function lt(i,e,t,a,n){const o={width:360,height:it(e),left:14,right:30,top:15,bottom:24},{points:r,min:c,max:s}=Ve(t,"temperature",o);if(r.length<2)return G;const l=o.height-o.bottom,M=ct(i,a,r),g=r.reduce(((i,e)=>e.value<i.value?e:i),r[0]),d=r.reduce(((i,e)=>e.value>i.value?e:i),r[0]),N=Fe(r.length),I=function(i,e){if(e<=0)return[];if(i.length<=e)return i;if(1===e)return[i[0]];const t=i.every((i=>Number.isFinite(i.timestamp))),a=t?Number(i[0].timestamp):0,n=(t?Number(i[i.length-1].timestamp):0)-a,o=[];let r=-1;for(let c=0;c<e;c+=1){const s=c/(e-1),l=a+n*s,M=t&&n>0?i.reduce(((e,t,a)=>{const n=i[e];return Math.abs(Number(t.timestamp)-l)<Math.abs(Number(n.timestamp)-l)?a:e}),0):Math.round(s*(i.length-1));M!==r&&(o.push(i[M]),r=M)}return o}(r,function(i){const e=Number(i.temperature_icon_count);return Number.isFinite(e)?Math.max(0,Math.min(72,Math.floor(e))):8}(e)),u=He(r),D=Je(r,l),h=Be(a),j=`weather-conditions-temp-line-${h}`,y=`weather-conditions-temp-fill-${h}`,z=(c+s)/2;return E`
    <section class="weather-conditions-card weather-conditions-temp">
      ...
      ${I.length?E`
        <div class="weather-conditions-icons">
          ${I.map((i=>{const e=String(i.item.condition||""),t=i.x/o.width*100;return E`
              <span class="weather-conditions-icon-slot" style=${`left:${t.toFixed(2)}%;`}>
                ${Ze(Ue(e),`weather-conditions-icon weather-condition-${Ee(e)}`,Qe(e))}
              </span>
            `}))}
        </div>
      `:G}
      ...
      <div class="weather-conditions-chart-frame">
        <svg
          ...
          @pointerdown=${at}
          @pointermove=${e=>rt(i,e,n,r,o)}
          @click=${e=>rt(i,e,n,r,o)}
        >
          <defs>
            ...
            <linearGradient id=${j} x1=${o.left} x2=${o.width-o.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
              ${r.map(((i,e)=>U`
                <stop offset=${e/(r.length-1)*100+"%"} stop-color=${ve(i.value)}></stop>
              `))}
            </linearGradient>
          </defs>
          ${st(i,o,N,r)}
  ...
  `}function Mt(i,e,t,a,n,o){if(t.length<2)return G;const r=`${n}-temperature`,c=`${n}-precipitation`,s=o?[r,c]:null,l=a.includes("temperature")?lt(i,e,t,r,s||[r]):G,M=a.includes("precipitation_probability")?function(i,e,t,a,n){const o={width:360,height:it(e),left:14,right:30,top:10,bottom:22},{points:r}=Ve(t,"precipitation_probability",o);if(r.length<2)return G;const c=o.height-o.bottom,s=ct(i,a,r),l=r.reduce(((i,e)=>e.value>i.value?e:i),r[0]),M=Fe(r.length),g=He(r),d=Je(r,c),N=`weather-conditions-rain-fill-${Be(a)}`;return E`
  ...
  `}function gt(i,e){var t,a;const n=Le(Se(i,e.entity)).toLowerCase(),o=e.name||"Weather",r=Ye(i,e.temp_sensor),c=function(i,e){const t=ke(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),s=Ye(i,e.feels_like_sensor),l=function(i,e){const t=Array.isArray(e.metrics)&&e.metrics.length?e.metrics:function(i){const e=[{entity:i.wind_speed_sensor,name:"Wind"},{entity:i.wind_gust_sensor,name:"Gust"},{entity:i.temp_min_24h_sensor,name:"24h Min"},{entity:i.temp_max_24h_sensor,name:"24h Max"},{entity:i.uv_sensor,name:"UV"},{entity:i.solar_lux_sensor,name:"Solar"},{entity:i.pressure_sensor,name:"Pressure"}].filter((i=>i.entity));return(i.rain_state_sensor||i.rain_rate_sensor)&&e.splice(4,0,{type:"rain",name:"Rain",rain_state_sensor:i.rain_state_sensor,rain_rate_sensor:i.rain_rate_sensor,rain_rate_threshold:i.rain_rate_threshold}),e}(e);return t.filter((i=>i&&("rain"===i.type?i.rain_state_sensor||i.rain_rate_sensor:i.entity))).map((e=>{var t;if("rain"===e.type)return We(i,e);const a=Se(i,e.entity);return{label:e.name||(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.friendly_name)||e.entity||"",value:_e(i,e.entity),entity:e.entity,mdi:e.icon||void 0,stateEntity:e.entity}}))}(i,e),M=!1===e.show_forecast?[]:Pe(e.forecast),g=!1===e.show_forecast?[]:Pe(e.daily_forecast),d=Number(e.forecast_slots),N=Number.isFinite(d)&&d>0?Math.min(Math.floor(d),72):8,I=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):we,t=[];return e.forEach((i=>{const e=Te[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:we}(e.forecast_fields),u=M.slice(0,N),D=tt(i,M),h=String((null===(t=M[0])||void 0===t?void 0:t.condition)||n||"").toLowerCase(),j=h||n,y=`weather-icon weather-condition-${Ee(j)}`,z=D||Qe(h||n),p=E`<span class="weather-source-badge" title="Forecast data" aria-label="Forecast data"></span>`,m=e.forecast_graph_key||`weather-${e.entity||o}`,A=!1!==e.sync_graphs,b=Mt(i,e,u,I,m,A),w=et(i,e,g,M),T=Array.isArray(e.chips)?e.chips:[],O=fe(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),x=fe(e.icon_size,28,160),v=fe(e.graph_height,82,260),S=Number(e.icon_offset_x),L=Number(e.icon_offset_y),k=fe(e.conditions_icon_size,8,48),C=fe(e.daily_icon_size,8,48),_=Number(e.metric_columns),Y=Number.isFinite(_)&&_>0?Math.max(1,Math.min(4,Math.round(_))):3,f=function(i,e){const t=Number(e.stale_minutes);if(!Number.isFinite(t)||t<=0)return!1;const a=[e.entity,e.temp_sensor,e.humidity_sensor,e.feels_like_sensor].filter(Boolean);let n=0;return a.forEach((e=>{const t=Se(i,e),a=(null==t?void 0:t.last_updated)?Date.parse(t.last_updated):NaN;Number.isFinite(a)&&(n=Math.max(n,a))})),!!n&&Date.now()-n>6e4*t}(i,e),Q=[O?`--weather-temp-size:${O}px;`:"",x?`--weather-icon-size:${x}px;--weather-icon-bg-size:${x+16}px;`:"",Number.isFinite(S)?`--weather-icon-x:${S}px;`:"",Number.isFinite(L)?`--weather-icon-y:${L}px;`:"",k?`--weather-conditions-icon-size:${k}px;`:"",C?`--weather-daily-icon-size:${C}px;`:"",v?`--weather-graph-height:${v}px;`:"",`--weather-metric-columns:${Y};`].filter(Boolean).join("");return E`
    <div class="tile-wrap weather-tile-wrap" style=${Q}>
      <div class=${"weather-tile"+(f?" weather-tile-stale":"")}>
        <div class="weather-content">
          <div class="weather-top">
            ...
            <div class="weather-icon-wrap" aria-hidden="true">
              ${e.icon?E`<ha-icon class=${y} .icon=${e.icon}></ha-icon>`:Ze(Ue(j),y,Qe(j),"inline")}
            </div>
          </div>
  ...
  `}const dt=(...i)=>i.filter(Boolean).join(" ");function Nt(i,e){return e&&e.length?E`${e.map(((e,t)=>function(i,e,t){const a=e,n=Array.isArray(e)?e:Array.isArray(null==a?void 0:a.row)?a.row:[];let o=Array.isArray(null==a?void 0:a.cards)?a.cards:Array.isArray(null==a?void 0:a.extra_cards)?a.extra_cards:[];if(!Array.isArray(o)||!o.length){const i=(null==a?void 0:a.card)||(null==a?void 0:a.extra_card);i&&"object"==typeof i&&(o=[i])}const r=Math.max(1,n.length||1),c=Array.isArray(o)&&o.length&&"function"==typeof(null==i?void 0:i._renderEmbeddedRowCard)?E`<div class="switch-row-cards">
        ${o.map(((e,a)=>i._renderEmbeddedRowCard(e,`switch-row-${t}-card-${a}`)))}
      </div>`:G;return E`
    <div class="switch-row-wrap">
      <div class="switch-row" style=${`--cols:${r}`}>${n.map((e=>function(i,e){var t,a,n,o,r,c,s;const l="string"==typeof(null==e?void 0:e.entity)?e.entity:"",M=(null==e?void 0:e.icon)||"",g=(null==e?void 0:e.name)||"",d=(null===(o=null===(n=null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.states)||void 0===a?void 0:a[l])||void 0===n?void 0:n.attributes)||void 0===o?void 0:o.friendly_name)||"",N=g||d||l,I=String((null==e?void 0:e.type)||"switch").toLowerCase(),u="smart_plug"===I,D="lock"===I||l.startsWith("lock."),h="function"==typeof(null==i?void 0:i._isSwitchActive)?i._isSwitchActive(l,I):D?"unlocked"===((null===(s=null===(c=null===(r=null==i?void 0:i.hass)||void 0===r?void 0:r.states)||void 0===c?void 0:c[l])||void 0===s?void 0:s.state)||"").toLowerCase():"function"==typeof(null==i?void 0:i._isOn)&&i._isOn(l),j=(null==e?void 0:e.icon_size)||(null==e?void 0:e["icon-size"]),y=(null==e?void 0:e.font_weight)||(null==e?void 0:e["font-weight"]),z=(null==e?void 0:e.font_size)||(null==e?void 0:e["font-size"]),p=(null==e?void 0:e.icon_active)||(null==e?void 0:e.icon_on)||(null==e?void 0:e["icon-active"])||(null==e?void 0:e["icon-on"]),m=(null==e?void 0:e.icon_inactive)||(null==e?void 0:e.icon_off)||(null==e?void 0:e["icon-inactive"])||(null==e?void 0:e["icon-off"]),A=h?p||M||m:m||M,b=i=>{if(null==i||""===i)return"";const e=String(i).trim();return e?/^-?\d+(\.\d+)?$/.test(e)?`${e}px`:e:""},w=b(j),T=b(z),O=w?`--switch-icon-size:${w};width:${w};height:${w};--mdc-icon-size:${w};`:"",x=`${y?`font-weight:${y};`:""}${T?`font-size:${T};`:""}`,v=`${w?`--switch-icon-size:${w};`:""}${y?`font-weight:${y};`:""}${T?`--chip-text-font-size:${T};font-size:${T};`:""}`,S="undefined"!=typeof customElements&&!!customElements.get("ha-chip"),L="undefined"!=typeof customElements&&!!customElements.get("ha-control-button"),k=u?"smart":D?"lock":"",C=h?"on":"off",_=dt("switch-chip",k,C),Y=dt("switch-icon",k,C),f=dt("name","switch-name",k,C),Q="function"==typeof(null==i?void 0:i._resolveSwitchTemplates)?i._resolveSwitchTemplates(e):[],U=Array.isArray(Q)?Q.map((i=>i&&"object"==typeof i?i.value:i)).slice(0,2):[],Z=((i,e)=>{if(!Array.isArray(i)||!i.length)return G;const t=i.map((i=>{const e=null==i?"":String(i);return{text:e,trimmed:e.trim()}})).filter((i=>i.trimmed.length>0)).slice(0,2);return t.length?E`
    <div class=${e}>
      ${t.map((i=>E`<span>${i.text}</span>`))}
    </div>
  `:G})(U,dt("switch-info",k,C)),W="function"==typeof(null==i?void 0:i._isSwitchPending)&&i._isSwitchPending(l),P=W?E`<span class=${dt("switch-pending-spinner",k,C)} aria-hidden="true"></span>`:G,$=dt("switch-tile",k,C,W&&"pending"),R=t=>{"function"==typeof(null==i?void 0:i._onSwitchAction)&&i._onSwitchAction(t,e)},V=(null==e?void 0:e.glow_mode)||"static",F=D?De:u?ue:Ie,{style:B,overlay:H}=je(F,V,h&&"none"!==V);if(L){const i=dt("switch-tile-btn",k,h?"on":"off",W&&"pending");return E`
      <div class="tile-wrap">
        ...
        >
          <div class="tile-inner">
            ${S?E`<ha-chip class=${_} style=${v||G}>
                  ...
                  ${A?E`<ha-icon class=${Y} .icon=${A} style=${O||G}></ha-icon>`:G}
                  ${N?E`<div class=${f} style=${x}>${N}</div>`:G}
                `}
          </div>
        </ha-control-button>
      </div>
...
`;var mt;let At=mt=class extends ni{constructor(){super(...arguments),this._visiblePendingSwitches=new Set,this._weatherForecastGraphSelections=new Map,this._rowCardElements=new Map,this._rowCardConfigs=new Map,this._rowCardPromises=new Map,this._switchTemplateValues=new Map,this._weatherForecastValues=new Map,this._pendingSwitches=new Map,this._switchPendingDelayMs=300,this._switchPendingTimeoutMs=1e4}static getConfigElement(){return document.createElement("space-hub-card-editor")}static getStubConfig(){return{tile_height:80,chip_icon_size:14,main_icon_size:48,chip_font_size:12,card_shadow_color:"#000000",card_shadow_intensity:.5,unavailable_pulse_color:"#ff3b30",switch_rows:[],cards:[]}}setConfig(i){if(!i)throw new Error("Configuration is required");this._validateConfig(i,{allowIncomplete:!0});const e=Ri(i||{});Array.isArray(e.headers)||(e.headers=[]),Array.isArray(e.switch_rows)||(e.switch_rows=[]),Array.isArray(e.cards)||(e.cards=[]),this._clearRowCardCache(),this._config=e,this._syncTemplateEntries(e.switch_rows),this._syncWeatherForecastEntries(e.headers)}_isValidEntityId(i){return"string"==typeof i&&i.includes(".")&&!i.includes(" ")}_validateConfig(i,e={}){const t=!!e.allowIncomplete,a=[];i.headers&&Array.isArray(i.headers)&&i.headers.forEach(((i,e)=>{if(i){if(i.ac&&(i.ac.entity?this._isValidEntityId(i.ac.entity)||a.push(`Header ${e+1}: AC entity '${i.ac.entity}' must be a valid entity ID (e.g., 'climate.living_room')`):t||a.push(`Header ${e+1}: AC tile requires an 'entity' field`)),i.thermostat&&(i.thermostat.entity?this._isValidEntityId(i.thermostat.entity)||a.push(`Header ${e+1}: Thermostat entity '${i.thermostat.entity}' must be a valid entity ID (e.g., 'climate.bedroom')`):t||a.push(`Header ${e+1}: Thermostat tile requires an 'entity' field`)),i.main){const n=i.main;!!(n.main_name||n.main_icon||n.tap_entity||n.light_group_entity||n.temp_sensor||n.humidity_sensor||Array.isArray(n.chips)&&n.chips.length>0)||t||a.push(`Header ${e+1}: Main tile must have at least one of: main_name, main_icon, tap_entity, light_group_entity, temp_sensor, humidity_sensor, or chips`);["tap_entity","hold_entity","light_group_entity","temp_sensor","humidity_sensor"].forEach((i=>{const t=n[i];t&&!this._isValidEntityId(t)&&a.push(`Header ${e+1}: Main tile ${i} '${t}' must be a valid entity ID`)}))}if(i.weather){const n=i.weather;!!(n.name||n.icon||n.entity||void 0!==n.animated_icons||void 0!==n.show_forecast||n.forecast_slots||n.forecast_fields||n.height||n.temp_size||n.temperature_size||n.icon_size||n.graph_height||n.temperature_icon_count||n.metric_columns||n.temp_sensor||n.temp_min_24h_sensor||n.temp_max_24h_sensor||n.humidity_sensor||n.feels_like_sensor||n.dewpoint_sensor||n.wind_speed_sensor||n.wind_gust_sensor||n.wind_direction_sensor||n.rain_state_sensor||n.rain_today_sensor||n.rain_rate_sensor||n.uv_sensor||n.solar_lux_sensor||n.pressure_sensor||Array.isArray(n.chips)&&n.chips.length>0)||t||a.push(`Header ${e+1}: Weather tile must have at least one weather entity, sensor, name, icon, or chip`);["entity","temp_sensor","temp_min_24h_sensor","temp_max_24h_sensor","humidity_sensor","feels_like_sensor","dewpoint_sensor","wind_speed_sensor","wind_gust_sensor","wind_direction_sensor","rain_state_sensor","rain_today_sensor","rain_rate_sensor","uv_sensor","solar_lux_sensor","pressure_sensor"].forEach((i=>{const t=n[i];t&&!this._isValidEntityId(t)&&a.push(`Header ${e+1}: Weather tile ${i} '${t}' must be a valid entity ID`)}));if(["height","temp_size","temperature_size","icon_size","graph_height"].forEach((i=>{const t=n[i];if(null!=t){const n=Number(t);(!Number.isFinite(n)||n<=0)&&a.push(`Header ${e+1}: Weather tile ${i} must be a positive number, got: ${t}`)}})),void 0!==n.temperature_icon_count&&null!==n.temperature_icon_count){const i=Number(n.temperature_icon_count);(!Number.isFinite(i)||i<0)&&a.push(`Header ${e+1}: Weather tile temperature_icon_count must be zero or a positive number, got: ${n.temperature_icon_count}`)}if(void 0!==n.metric_columns&&null!==n.metric_columns){const i=Number(n.metric_columns);(!Number.isFinite(i)||i<1)&&a.push(`Header ${e+1}: Weather tile metric_columns must be a positive number, got: ${n.metric_columns}`)}if(void 0!==n.forecast_slots&&null!==n.forecast_slots){const i=Number(n.forecast_slots);(!Number.isFinite(i)||i<=0)&&a.push(`Header ${e+1}: Weather tile forecast graph hours must be a positive number, got: ${n.forecast_slots}`)}if(void 0!==n.forecast_fields&&null!==n.forecast_fields){const i=Array.isArray(n.forecast_fields)?n.forecast_fields:String(n.forecast_fields).split(","),t=new Set(["temp","temperature","rain_chance","precipitation_probability","precip_probability","probability","pop","rain","precipitation","hum","humidity","wind","wind_speed","gust","wind_gust","wind_gust_speed","uv","uv_index","cloud","clouds","cloud_coverage"]);i.forEach((i=>{const n=String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_");n&&!t.has(n)&&a.push(`Header ${e+1}: Weather tile forecast field '${i}' is not supported`)}))}}!i.ac&&!i.thermostat||i.main||t||a.push(`Header ${e+1}: AC and Thermostat tiles require a 'main' configuration block`)}else a.push(`Header ${e+1}: Header configuration cannot be empty`)})),i.switch_rows&&Array.isArray(i.switch_rows)&&i.switch_rows.forEach(((i,e)=>{if(!i)return void a.push(`Switch row ${e+1}: Switch row configuration cannot be empty`);const n=Array.isArray(i)?i:Array.isArray(i.row)?i.row:[];Array.isArray(n)&&0!==n.length||t?n.forEach(((i,n)=>{i&&i.entity?this._isValidEntityId(i.entity)||a.push(`Switch row ${e+1}, item ${n+1}: Switch entity '${i.entity}' must be a valid entity ID`):t||a.push(`Switch row ${e+1}, item ${n+1}: Switch item requires an 'entity' field`),(null==i?void 0:i.hold_entity)&&!this._isValidEntityId(i.hold_entity)&&a.push(`Switch row ${e+1}, item ${n+1}: hold_entity '${i.hold_entity}' must be a valid entity ID`)})):a.push(`Switch row ${e+1}: Switch row must contain at least one switch item`)}));if(Object.entries({tile_height:"Tile height",chip_icon_size:"Chip icon size",main_icon_size:"Main icon size",chip_font_size:"Chip font size",card_shadow_intensity:"Card shadow intensity"}).forEach((([e,t])=>{const n=i[e];if(null!=n){const i=Number(n);(!Number.isFinite(i)||i<0)&&a.push(`${t} must be a positive number, got: ${n}`)}})),void 0!==i.card_shadow_intensity&&null!==i.card_shadow_intensity){const e=Number(i.card_shadow_intensity);Number.isFinite(e)&&(e<0||e>1)&&a.push(`Card shadow intensity must be between 0 and 1, got: ${e}`)}if(["card_shadow_color","unavailable_pulse_color"].forEach((e=>{const t=i[e];if(t&&"string"==typeof t){/^(#[0-9a-fA-F]{3,8}|rgb\(|rgba\(|hsl\(|hsla\(|[a-zA-Z]+).*$/.test(t)||a.push(`${e.replace(/_/g," ")} '${t}' is not a valid color format`)}})),a.length>0)throw new Error(`Invalid space-hub-card configuration:\n${a.map((i=>`• ${i}`)).join("\n")}`)}getCardSize(){const i=this._config||{},e=mt.getStubConfig(),t=this._positiveNumber(i.tile_height)||this._positiveNumber(e.tile_height)||80;let a=24;(Array.isArray(i.headers)?i.headers:[]).forEach((i=>{i&&"object"==typeof i&&(this._hasWeatherForCardSize(i.weather)&&(a+=this._weatherHeightForCardSize(i.weather||{},t)+12),this._hasMainForCardSize(i)&&(a+=t+12))}));const n=Array.isArray(i.switch_rows)?i.switch_rows.length:0;a+=n*(t+12);const o=Array.isArray(i.cards)?i.cards.length:0;return a+=120*o,Math.max(6,Math.ceil(a/50))}_positiveNumber(i){const e=Number(i);return Number.isFinite(e)&&e>0?e:void 0}_hasMainForCardSize(i){const e=i.main||{};return!(!e||!(e.main_name||e.name||e.light_group_entity||e.entity||e.main_icon||e.icon||e.temp_sensor||e.humidity_sensor||Array.isArray(e.chips)&&e.chips.length))}_hasWeatherForCardSize(i){return!(!i||!(i.name||i.main_name||i.icon||i.main_icon||void 0!==i.animated_icons||void 0!==i.show_forecast||i.forecast_slots||i.forecast_fields||i.height||i.temp_size||i.temperature_size||i.icon_size||i.graph_height||i.temperature_icon_count||i.metric_columns||i.entity||i.temp_sensor||i.temp_min_24h_sensor||i.temp_max_24h_sensor||i.humidity_sensor||i.feels_like_sensor||i.dewpoint_sensor||i.wind_speed_sensor||i.wind_gust_sensor||i.wind_direction_sensor||i.rain_state_sensor||i.rain_today_sensor||i.rain_rate_sensor||i.uv_sensor||i.solar_lux_sensor||i.pressure_sensor||Array.isArray(i.chips)&&i.chips.length))}_weatherHeightForCardSize(i,e){const t=Math.max(82,Math.min(260,this._positiveNumber(i.graph_height)||118)),a=Math.max(1,Math.min(4,Math.round(this._positiveNumber(i.metric_columns)||3))),n=this._weatherMetricCountForCardSize(i),o=n>0?Math.ceil(n/a):0,r=!1!==i.show_forecast&&i.entity?this._weatherForecastFieldCountForCardSize(i):0,c=78+40*o+(o>1?5*(o-1):0)+(r>0?r*(t+64)+8*(r-1):0)+(r>0?250:0)+32;return Math.max(c,e)}_weatherMetricCountForCardSize(i){if(Array.isArray(i.metrics)&&i.metrics.length)return i.metrics.filter((i=>!!i&&("rain"===i.type?!(!i.rain_state_sensor&&!i.rain_rate_sensor):!!i.entity))).length;let e=[i.wind_speed_sensor,i.wind_gust_sensor,i.temp_min_24h_sensor,i.temp_max_24h_sensor,i.uv_sensor,i.solar_lux_sensor,i.pressure_sensor].filter(Boolean).length;return(i.rain_state_sensor||i.rain_rate_sensor)&&(e+=1),e}_weatherForecastFieldCountForCardSize(i){const e={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability"},t=Array.isArray(i.forecast_fields)?i.forecast_fields:"string"==typeof i.forecast_fields?i.forecast_fields.split(","):["temperature","precipitation_probability"],a=new Set;return t.forEach((i=>{const t=e[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];t&&a.add(t)})),a.size||2}render(){var i,e,t,a,n,o,r,c,s;if(!this._config)return G;const l=mt.getStubConfig(),M=this._config||{},g={tile_height:null!==(i=M.tile_height)&&void 0!==i?i:l.tile_height,chip_icon_size:null!==(e=M.chip_icon_size)&&void 0!==e?e:l.chip_icon_size,main_icon_size:null!==(t=M.main_icon_size)&&void 0!==t?t:l.main_icon_size,chip_font_size:null!==(a=M.chip_font_size)&&void 0!==a?a:l.chip_font_size,card_shadow_color:null!==(n=M.card_shadow_color)&&void 0!==n?n:l.card_shadow_color,card_shadow_intensity:null!==(o=M.card_shadow_intensity)&&void 0!==o?o:l.card_shadow_intensity,unavailable_pulse_color:null!==(r=M.unavailable_pulse_color)&&void 0!==r?r:l.unavailable_pulse_color,headers:Array.isArray(M.headers)&&M.headers.length?M.headers:[],switch_rows:Array.isArray(M.switch_rows)?M.switch_rows:[],cards:Array.isArray(M.cards)?M.cards:[],tap_action:M.tap_action,hold_action:M.hold_action,double_tap_action:M.double_tap_action},d=Array.isArray(g.headers)&&g.headers.length?g.headers:[],N=Number(g.tile_height)||Number(l.tile_height)||80,I=Number(g.chip_icon_size)||Number(l.chip_icon_size)||14,u=Number(g.chip_font_size)||Number(l.chip_font_size)||12,D=Math.max(u+10,20),h=Math.round(.625*N),j=d[0]||{},y=Number(null!==(c=null==j?void 0:j.main_icon_size)&&void 0!==c?c:null==j?void 0:j.maicon_size),z=Number.isFinite(y)&&y>0?y:Number(g.main_icon_size)||Number(l.main_icon_size)||48,p=this._rgbaFromColor(g.card_shadow_color||l.card_shadow_color,null!==(s=g.card_shadow_intensity)&&void 0!==s?s:l.card_shadow_intensity),m=g.unavailable_pulse_color||l.unavailable_pulse_color||"#ff3b30",A=this._hasAnyUnavailable(g,d),b=this._rgbaFromColor(m,.18),w=this._rgbaFromColor(m,.36);return E`
    ...
    `}updated(i){super.updated(i),i.has("hass")&&(this._rowCardElements.forEach((i=>{i&&(i.hass=this.hass)})),this._resumeTemplateSubscriptions(),this._resumeWeatherForecastSubscriptions(),this._syncPendingSwitches())}connectedCallback(){super.connectedCallback(),this._resumeTemplateSubscriptions(),this._resumeWeatherForecastSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._switchTemplateValues.forEach((i=>this._disposeTemplateEntry(i))),this._weatherForecastValues.forEach((i=>this._disposeWeatherForecastEntry(i))),this._clearAllPendingSwitches()}_renderHeaderRow(i,e){const t=i.main||{},a=i.weather||{},n={tap_entity:t.tap_entity,hold_entity:t.hold_entity||t.tap_entity,glow_mode:t.glow_mode,light_group_entity:t.light_group_entity,name:t.main_name||t.name,icon:t.main_icon||t.icon,temp_sensor:t.temp_sensor,humidity_sensor:t.humidity_sensor,chips:Array.isArray(t.chips)?t.chips:[],tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},o={entity:a.entity,name:a.name||a.main_name,icon:a.icon||a.main_icon,height:a.height,temp_size:a.temp_size,temperature_size:a.temperature_size,icon_size:a.icon_size,icon_offset_x:a.icon_offset_x,icon_offset_y:a.icon_offset_y,conditions_icon_size:a.conditions_icon_size,temperature_icon_count:a.temperature_icon_count,daily_icon_size:a.daily_icon_size,graph_height:a.graph_height,metric_columns:a.metric_columns,animated_icons:a.animated_icons,show_forecast:a.show_forecast,sync_graphs:a.sync_graphs,stale_minutes:a.stale_minutes,rain_rate_threshold:a.rain_rate_threshold,forecast_slots:a.forecast_slots,forecast_fields:a.forecast_fields,forecast_graph_key:`weather-${e}`,temp_sensor:a.temp_sensor,temp_min_24h_sensor:a.temp_min_24h_sensor,temp_max_24h_sensor:a.temp_max_24h_sensor,humidity_sensor:a.humidity_sensor,feels_like_sensor:a.feels_like_sensor,dewpoint_sensor:a.dewpoint_sensor,wind_speed_sensor:a.wind_speed_sensor,wind_gust_sensor:a.wind_gust_sensor,wind_direction_sensor:a.wind_direction_sensor,rain_state_sensor:a.rain_state_sensor,rain_today_sensor:a.rain_today_sensor,rain_rate_sensor:a.rain_rate_sensor,uv_sensor:a.uv_sensor,solar_lux_sensor:a.solar_lux_sensor,pressure_sensor:a.pressure_sensor,metrics:Array.isArray(a.metrics)?a.metrics:void 0,chips:Array.isArray(a.chips)?a.chips:[],tap_action:a.tap_action,hold_action:a.hold_action,double_tap_action:a.double_tap_action,forecast:!1===a.show_forecast?[]:this._getWeatherForecast(a.entity,"hourly"),daily_forecast:!1===a.show_forecast?[]:this._getWeatherForecast(a.entity,"daily")},r=i.ac||{},c=i.thermostat||{},s=!!(null==r?void 0:r.entity),l=!!(null==c?void 0:c.entity),M=!(!t||!(t.main_name||t.name||t.light_group_entity||t.entity||t.main_icon||t.icon||t.temp_sensor||t.humidity_sensor||Array.isArray(t.chips)&&t.chips.length)),g=!(!a||!(a.name||a.main_name||a.icon||a.main_icon||void 0!==a.animated_icons||void 0!==a.show_forecast||a.forecast_slots||a.forecast_fields||a.height||a.temp_size||a.temperature_size||a.icon_size||a.graph_height||a.temperature_icon_count||a.metric_columns||a.entity||a.temp_sensor||a.temp_min_24h_sensor||a.temp_max_24h_sensor||a.humidity_sensor||a.feels_like_sensor||a.dewpoint_sensor||a.wind_speed_sensor||a.wind_gust_sensor||a.wind_direction_sensor||a.rain_state_sensor||a.rain_today_sensor||a.rain_rate_sensor||a.uv_sensor||a.solar_lux_sensor||a.pressure_sensor||Array.isArray(a.chips)&&a.chips.length)),d=M&&s,N=M&&l;M||!s&&!l||console.warn("space-hub-card: header contains `ac`/`thermostat` outside of `main` — ignoring per configured rules.");const I=d||N?d&&N?"header-row":"header-row main-plus-one":"header-row only-main";return E`
      ...
      ${M?E`<div class=${I}>
        ${M?ye(this,n):G}
        ${d?function(i,e){var t,a,n;const o=(null==e?void 0:e.entity)||"",r=null==e?void 0:e.glow_mode,c=((null===(n=null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.states)||void 0===a?void 0:a[o])||void 0===n?void 0:n.state)||"").toLowerCase(),s=!!c&&"off"!==c,l="function"==typeof(null==i?void 0:i._acChip)?i._acChip(c):{icon:"mdi:air-conditioner"},M=(null==l?void 0:l.icon)||"mdi:air-conditioner",g="ac-mode-"+((d=c)&&"off"!==d?d.includes("cool")?"cool":d.includes("heat")?"heat":d.includes("dry")?"dry":d.includes("fan")?"fan":d.includes("auto")?"auto":"default":"off");var d;const N=`chip chip-temperature-humidity ac-chip ${g}`,I=`ac-fan ${g}${s?" spinning":""}`,u=function(i){const e=(i||"").toLowerCase();return e&&"off"!==e?e.includes("cool")?{weak:"rgba(0,170,255,0.12)",strong:"rgba(0,170,255,0.26)"}:e.includes("heat")?{weak:"rgba(255,112,67,0.12)",strong:"rgba(255,112,67,0.26)"}:e.includes("dry")?{weak:"rgba(255,202,40,0.12)",strong:"rgba(255,202,40,0.26)"}:e.includes("fan")?{weak:"rgba(102,187,106,0.12)",strong:"rgba(102,187,106,0.26)"}:e.includes("auto")?{weak:"rgba(38,198,218,0.12)",strong:"rgba(38,198,218,0.26)"}:{weak:"rgba(0,0,0,0.06)",strong:"rgba(0,0,0,0.12)"}:{weak:"rgba(0,0,0,0.00)",strong:"rgba(0,0,0,0.00)"}}(c),D=null!=r?r:"static",{style:h,overlay:j}=je(u,D,s);return E`
    <div class="tile-wrap">
    ...
    <div class="tile-wrap">
      ...
      >
        ...
        <div class="temperature-chip-container">
          ${z?E`<ha-chip class=${h}>${I}</ha-chip>`:E`<div class=${j}><span class="thermostat-target">${I}</span></div>`}
        </div>
        <div class="center-xy">
