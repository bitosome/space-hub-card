        ...
        <div class="section-content">
          ...
          <div class="action-row">
            ...
            ${t.length>0?L`
              ...
              <button
                class="editor-btn"
                .disabled=${this._selectedSwitchRowIndex>=t.length-1}
                @click=${()=>this._moveSwitchRow(this._selectedSwitchRowIndex,1)}
              >
      ...
      <div class="tile-wrap">
        ...
        >
          <div class="tile-inner">
            ${z?L`<ha-chip class=${N} style=${T||O}>
                  ${x?L`<ha-icon class=${R} .icon=${x} style=${S||O}></ha-icon>`:O}
                  ${p}
                </ha-chip>`:L`
                  ${x?L`<ha-icon class=${R} .icon=${x} style=${S||O}></ha-icon>`:O}
                  ${p?L`<div class=${M} style=${E}>${p}</div>`:O}
                `}
          </div>
        </ha-control-button>
      </div>
