 ...
 */var bi;null===(bi=window.HTMLSlotElement)||void 0===bi||bi.prototype.assignedElements;var Ti="[^\\s]+";function Oi(i,e){for(var t=[],a=0,n=i.length;a<n;a++)t.push(i[a].substr(0,e));return t}var xi=function(i){return function(e,t){var a=t[i].map((function(i){return i.toLowerCase()})),n=a.indexOf(e.toLowerCase());return n>-1?n:null}};function vi(i){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var a=0,n=e;a<n.length;a++){var o=n[a];for(var c in o)i[c]=o[c]}return i}var Si=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Li=["January","February","March","April","May","June","July","August","September","October","November","December"],ki=Oi(Li,3),Ci={dayNamesShort:Oi(Si,3),dayNames:Si,monthNamesShort:ki,monthNames:Li,amPm:["am","pm"],DoFn:function(i){return i+["th","st","nd","rd"][i%10>3?0:(i-i%10!=10?1:0)*i%10]}},Yi=(vi({},Ci),function(i){return+i-1}),fi=[null,"[1-9]\\d?"],_i=[null,Ti],Qi=["isPm",Ti,function(i,e){var t=i.toLowerCase();return t===e.amPm[0]?0:t===e.amPm[1]?1:null}],Ei=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(i){var e=(i+"").match(/([+-]|\d\d)/gi);if(e){var t=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?t:-t}return 0}];xi("monthNamesShort"),xi("monthNames");var Ui,Zi;!function(){try{(new Date).toLocaleDateString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(i){return"RangeError"===i.name}}(),function(i){i.language="language",i.system="system",i.comma_decimal="comma_decimal",i.decimal_comma="decimal_comma",i.space_comma="space_comma",i.none="none"}(Ui||(Ui={})),function(i){i.language="language",i.system="system",i.am_pm="12",i.twenty_four="24"}(Zi||(Zi={}));var Gi=function(i,e,t,a){a=a||{},t=null==t?{}:t;var n=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return n.detail=t,i.dispatchEvent(n),n},Wi=new Set(["call-service","divider","section","weblink","cast","select"]),Pi={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},$i=function(i,e){void 0===e&&(e=!1);var t=function(i,e){return a("hui-error-card",{type:"error",error:i,config:e})},a=function(i,e){var a=window.document.createElement(i);try{a.setConfig(e)}catch(a){return console.error(i,a),t(a.message,e)}return a};if(!i||"object"!=typeof i||!e&&!i.type)return t("No type defined",i);var n=i.type;if(n&&n.startsWith("custom:"))n=n.substr("custom:".length);else if(e)if(Wi.has(n))n="hui-"+n+"-row";else{if(!i.entity)return t("Invalid config given.",i);var o=i.entity.split(".",1)[0];n="hui-"+(Pi[o]||"text")+"-entity-row"}else n="hui-"+n+"-card";if(customElements.get(n))return a(n,i);var c=t("Custom element doesn't exist: "+i.type+".",i);c.style.display="None";var r=setTimeout((function(){c.style.display=""}),2e3);return customElements.whenDefined(i.type).then((function(){clearTimeout(r),Gi(c,"ll-rebuild",{},c)})),c};function Ri(i){return JSON.parse(JSON.stringify(i))}const Vi=new Set(["more-info","toggle","perform-action","navigate","url","assist","none","fire-dom-event","call-service"]),Fi=i=>!!i&&"object"==typeof i&&!Array.isArray(i),Bi=i=>!!((null==i?void 0:i.tap_action)||(null==i?void 0:i.hold_action)||(null==i?void 0:i.double_tap_action)),Hi=i=>{if(null==i||!1===i)return;if(!0===i)return!0;if("string"==typeof i){const e=i.trim();return!e||{text:e}}if(!Fi(i))return;const e={};if("string"==typeof i.text&&i.text.trim()&&(e.text=i.text),"string"==typeof i.title&&i.title.trim()&&(e.title=i.title),"string"==typeof i.confirm_text&&i.confirm_text.trim()&&(e.confirm_text=i.confirm_text),"string"==typeof i.dismiss_text&&i.dismiss_text.trim()&&(e.dismiss_text=i.dismiss_text),Array.isArray(i.exemptions)){const t=i.exemptions.filter((i=>!!i&&"object"==typeof i&&"string"==typeof i.user)).map((i=>({user:i.user})));t.length&&(e.exemptions=t)}return!Object.keys(e).length||e},Ji=i=>{if(Fi(i)&&"string"==typeof i.action&&Vi.has(i.action)){if("call-service"===i.action||"perform-action"===i.action){return Object.assign(Object.assign({},i),{action:"perform-action",perform_action:"string"==typeof i.perform_action?i.perform_action:"string"==typeof i.service?i.service:void 0,data:Fi(i.data)?i.data:Fi(i.service_data)?i.service_data:void 0,target:Fi(i.target)?i.target:void 0,confirmation:Hi(i.confirmation)})}return Object.assign(Object.assign({},i),{confirmation:Hi(i.confirmation)})}},Xi=["lock","door","presence","illuminance","gate","sliding_gate","smart_plug","custom"],Ki=["switch","smart_plug","lock"],qi=["static","pulse","none"],ie=["hourly","daily","twice_daily"],ee=["24h","12h"],te=["more-info","toggle","perform-action","navigate","url","assist","none"],ae="M4,12L5.41,13.41L11,7.83V20H13V7.83L18.59,13.42L20,12L12,4L4,12Z",ne="M4,12L5.41,10.59L11,16.17V4H13V16.17L18.59,10.58L20,12L12,20L4,12Z",oe="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";let ce=class extends ni{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.type="text",this.disabled=!1}_onInput(i){i.stopPropagation(),this.disabled||(this.value=i.currentTarget.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}render(){return E`
    ...
    `}_renderWeatherConfig(i,e){var t,a,n,o,c,r;const s=i||{};return E`
      <ha-expansion-panel outlined .header=${"Weather Tile"}>
        <div class="section-content">
          ${!!i?E`
            <div class="side-by-side">
              ${this._renderEntityField("Weather Entity",`${e}.entity`,s.entity,{domain:"weather"})}
            </div>
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="18"
                max="56"
                .value=${String(null!==(t=s.temp_size)&&void 0!==t?t:"")}
              ...
              <space-hub-textfield
                ...
                min="28"
                max="160"
                .value=${String(null!==(a=s.icon_size)&&void 0!==a?a:"")}
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                type="number"
                min="0"
                .value=${String(null!==(n=s.stale_minutes)&&void 0!==n?n:"")}
              ...
              <space-hub-textfield
                ...
                min="0"
                step="0.1"
                .value=${String(null!==(o=s.rain_rate_threshold)&&void 0!==o?o:"")}
                @input=${i=>{const t=Number(i.target.value);this._valueChanged(`${e}.rain_rate_threshold`,Number.isFinite(t)&&t>=0?t:void 0)}}
              ></space-hub-textfield>
            </div>
            <div class="side-by-side">
              ${this._renderSelectField("Forecast Type",`${e}.forecast_type`,s.forecast_type,ie)}
              ${this._renderSelectField("Time Format",`${e}.time_format`,s.time_format,ee)}
            </div>
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="1"
                max="72"
                .value=${String(null!==(c=s.forecast_slots)&&void 0!==c?c:"")}
              ...
              <space-hub-textfield
                ...
                min="82"
                max="260"
                .value=${String(null!==(r=s.graph_height)&&void 0!==r?r:"")}
            ...
            <space-hub-textfield
              ...
              .value=${Array.isArray(s.forecast_fields)?s.forecast_fields.join(", "):s.forecast_fields||""}
              @input=${i=>{const t=i.target.value.split(",").map((i=>i.trim())).filter((i=>i));this._valueChanged(`${e}.forecast_fields`,t.length?t:void 0)}}
            ></space-hub-textfield>
            <div class="side-by-side">
              ${this._renderEntityField("Temperature Sensor",`${e}.temp_sensor`,s.temp_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Humidity Sensor",`${e}.humidity_sensor`,s.humidity_sensor,{domain:"sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("24h Min Temperature Sensor",`${e}.temp_min_24h_sensor`,s.temp_min_24h_sensor,{domain:"sensor"})}
              ${this._renderEntityField("24h Max Temperature Sensor",`${e}.temp_max_24h_sensor`,s.temp_max_24h_sensor,{domain:"sensor"})}
            </div>
            ${this._renderEntityField("Feels Like Sensor",`${e}.feels_like_sensor`,s.feels_like_sensor,{domain:"sensor"})}
            <div class="side-by-side">
              ${this._renderEntityField("Wind Speed Sensor",`${e}.wind_speed_sensor`,s.wind_speed_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Wind Gust Sensor",`${e}.wind_gust_sensor`,s.wind_gust_sensor,{domain:"sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("Wind Direction Sensor",`${e}.wind_direction_sensor`,s.wind_direction_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Rain State Sensor",`${e}.rain_state_sensor`,s.rain_state_sensor,{domain:"binary_sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("Rain Today Sensor",`${e}.rain_today_sensor`,s.rain_today_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Rain Rate Sensor",`${e}.rain_rate_sensor`,s.rain_rate_sensor,{domain:"sensor"})}
            </div>
            <div class="side-by-side">
              ${this._renderEntityField("UV Sensor",`${e}.uv_sensor`,s.uv_sensor,{domain:"sensor"})}
              ${this._renderEntityField("Solar Lux Sensor",`${e}.solar_lux_sensor`,s.solar_lux_sensor,{domain:"sensor"})}
            </div>
            ${this._renderEntityField("Pressure Sensor",`${e}.pressure_sensor`,s.pressure_sensor,{domain:"sensor"})}
            ${this._renderMetricsConfig(s.metrics||[],e)}
            ${this._renderChipsConfig(s.chips||[],e)}
    ...
    `}_renderMetricsConfig(i,e){const t=`${e}.metrics`,a=(i,e)=>{const a=[...this._getNestedValue(t)||[]],n=i+e;n<0||n>=a.length||([a[i],a[n]]=[a[n],a[i]],this._valueChanged(t,a))};return E`
      <ha-expansion-panel outlined .header=${`Grid Metrics (${i.length})`}>
        <div class="section-content">
          ...
          ${i.map(((e,n)=>E`
            <div class="sub-item">
              <div class="sub-item-header">
                <div class="sub-item-heading">
                  <span class="sub-item-title">Metric ${n+1}</span>
                ...
                <div class="action-row">
                  ...
                  <ha-icon-button
                    .path=${"M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z"}
                    @click=${()=>{const i=this._getNestedValue(t)||[];i.splice(n,1),this._valueChanged(t,[...i])}}
                  ></ha-icon-button>
                </div>
              </div>
              ${this._renderEntityField("Entity",`${t}.${n}.entity`,e.entity,{domain:"sensor"})}
              <div class="side-by-side">
                <space-hub-textfield
                  label="Label (optional)"
                  .value=${e.name||""}
                  @input=${i=>this._valueChanged(`${t}.${n}.name`,i.target.value||void 0)}
                ></space-hub-textfield>
                <ha-icon-picker
                  .hass=${this.hass}
                  label="Icon (optional)"
                  .value=${e.icon||""}
                  @value-changed=${i=>this._valueChanged(`${t}.${n}.icon`,i.detail.value||void 0)}
                ></ha-icon-picker>
              </div>
            </div>
          `))}
          <button class="editor-btn" @click=${()=>{const i=this._getNestedValue(t)||[];i.push({entity:""}),this._valueChanged(t,i)}}>
  ...
  `}const Ae={barometer:"data:image/svg+xml;base64,","clear-day":"data:image/svg+xml;base64,","clear-night":"data:image/svg+xml;base64,",cloudy:"data:image/svg+xml;base64,",drizzle:"data:image/svg+xml;base64,",fog:"data:image/svg+xml;base64,",hail:"data:image/svg+xml;base64,","not-available":"data:image/svg+xml;base64,","partly-cloudy-day":"data:image/svg+xml;base64,","partly-cloudy-night":"data:image/svg+xml;base64,","pressure-high":"data:image/svg+xml;base64,",rain:"data:image/svg+xml;base64,",raindrop:"data:image/svg+xml;base64,",raindrops:"data:image/svg+xml;base64,",sleet:"data:image/svg+xml;base64,",snow:"data:image/svg+xml;base64,","sun-hot":"data:image/svg+xml;base64,","thermometer-colder":"data:image/svg+xml;base64,","thermometer-warmer":"data:image/svg+xml;base64,",thunderstorms:"data:image/svg+xml;base64,","thunderstorms-rain":"data:image/svg+xml;base64,","uv-index":"data:image/svg+xml;base64,","weather-alarm":"data:image/svg+xml;base64,",wind:"data:image/svg+xml;base64,","wind-alert":"data:image/svg+xml;base64,"},me=new Set(["","unknown","unavailable"]),we=["temperature","precipitation_probability"],be={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability",rain:"precipitation",precipitation:"precipitation",humidity:"humidity",hum:"humidity",wind:"wind_speed",wind_speed:"wind_speed",gust:"wind_gust_speed",wind_gust:"wind_gust_speed",wind_gust_speed:"wind_gust_speed",uv:"uv_index",uv_index:"uv_index",cloud:"cloud_coverage",clouds:"cloud_coverage",cloud_coverage:"cloud_coverage"},Te={"clear-night":"clear-night",cloudy:"cloudy",exceptional:"weather-alarm",fog:"fog",hail:"hail",lightning:"thunderstorms","lightning-rainy":"thunderstorms-rain",partlycloudy:"partly-cloudy-day",pouring:"rain",rainy:"rain",snowy:"snow","snowy-rainy":"sleet",sunny:"clear-day",windy:"wind","windy-variant":"wind-alert"};function Oe(i){return i<=0?"#3aa7ff":i<=8?"#50c5d8":i<=15?"#9bd57b":i<=22?"#ffd34a":i<=28?"#ff9d24":"#ff5d38"}function xe(i,e){var t;if(e&&(null==i?void 0:i.hass))return null===(t=i.hass.states)||void 0===t?void 0:t[e]}function ve(i){const e=void 0===(null==i?void 0:i.state)||null===(null==i?void 0:i.state)?"":String(i.state);return me.has(e.toLowerCase())?"":e}function Se(i,e){const t=ve(xe(i,e));if(!t)return;const a=Number(t);return Number.isFinite(a)?a:void 0}function Le(i,e,t=!1){if(null==i||""===i)return"—";const a=Number(i);return Number.isFinite(a)?t&&Math.abs(a)>=1e3?`${(a/1e3).toFixed(1)}k`:a.toFixed(e):String(i)}function ke(i,e,t,a=!1){var n;const o=xe(i,e),c=ve(o);if(!c)return"—";const r=(null===(n=null==o?void 0:o.attributes)||void 0===n?void 0:n.unit_of_measurement)||"",s=Le(c,t,a);return r?`${s} ${r}`:s}function Ce(i,e){var t;const a=xe(i,e),n=ve(a);if(!n)return"—";const o=(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.unit_of_measurement)||"",c=Number(n);if(!Number.isFinite(c))return o?`${n} ${o}`:n;const r=Le(c,Number.isInteger(c)?0:1);return o?`${r} ${o}`:r}function Ye(i,e){const t=Se(i,e);return void 0===t?"—°":`${t.toFixed(1)}°`}function fe(i,e,t){const a=Number(i);if(Number.isFinite(a)&&!(a<=0))return Math.max(e,Math.min(t,a))}function _e(i,e,t){const a=ke(i,e,1),n=function(i,e){const t=Se(i,e);if(void 0===t)return"";const a=["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW"];return a[Math.round((t%360+360)%360/22.5)%a.length]}(i,t);return"—"===a?n||"—":n?`${a} ${n}`:a}function Qe(i){if(!i)return"Weather";const e={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Storm rain","snowy-rainy":"Sleet","windy-variant":"Windy"};return e[i]?e[i]:i.replace(/[-_]/g," ").replace(/\b\w/g,(i=>i.toUpperCase()))}function Ee(i){return(i||"unknown").replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Ue(i,e){const t=Number.isFinite(Number(e.rain_rate_threshold))?Number(e.rain_rate_threshold):0,a=Se(i,e.rain_rate_sensor);if(void 0!==a)return a>t;return"on"===ve(xe(i,e.rain_state_sensor)).toLowerCase()}function Ze(i,e){const t=ve(xe(i,e.entity)).toLowerCase();return t.includes("snow")||t.includes("hail")?"snow":"rain"}function Ge(i,e,t,a,n=!1){if(a||"—"!==t)return{icon:i,label:e,value:t,entity:a,active:n}}function We(i){return Te[i]||"partly-cloudy-day"}function Pe(i,e,t){return E`
    <img
      ...
      draggable="false"
    />
  `}function $e(i,e){if(Array.isArray(e.metrics)&&e.metrics.length)return e.metrics.filter((i=>i&&i.entity)).map((e=>{var t;const a=xe(i,e.entity);return{label:e.name||(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.friendly_name)||e.entity||"",value:Ce(i,e.entity),entity:e.entity,mdi:e.icon||void 0,stateEntity:e.entity}}));const t=Ue(i,e),a=Ze(i,e),n=e.rain_state_sensor||e.rain_rate_sensor||e.rain_today_sensor,o=function(i,e){const t=Ue(i,e);if(!e.rain_state_sensor&&!e.rain_rate_sensor)return"";const a=Ze(i,e);if(!t)return"snow"===a?"No snow":"No rain";const n=ke(i,e.rain_rate_sensor,1),o="snow"===a?"Snowing":"Raining";return"—"===n||"0.0 mm/h"===n?o:`${o} ${n}`}(i,e)||ke(i,e.rain_today_sensor,1),c="snow"===a?"Snow":"Rain",r=t?"snow"===a?"snow":"rain":"raindrop";return[Ge("wind","Wind",_e(i,e.wind_speed_sensor,e.wind_direction_sensor),e.wind_speed_sensor),Ge("wind-alert","Gust",ke(i,e.wind_gust_sensor,1),e.wind_gust_sensor),Ge("thermometer-colder","24h Min",Ye(i,e.temp_min_24h_sensor),e.temp_min_24h_sensor),Ge("thermometer-warmer","24h Max",Ye(i,e.temp_max_24h_sensor),e.temp_max_24h_sensor),Ge(r,c,o,n,t),Ge("uv-index","UV",ke(i,e.uv_sensor,0),e.uv_sensor),Ge("sun-hot","Solar",ke(i,e.solar_lux_sensor,0),e.solar_lux_sensor),Ge("barometer","Pressure",ke(i,e.pressure_sensor,0),e.pressure_sensor)].filter((i=>!!i))}function Re(i){return Array.isArray(i)?i.filter((i=>!!i&&"object"==typeof i)).map((i=>({condition:"string"==typeof i.condition?i.condition:void 0,datetime:"string"==typeof i.datetime?i.datetime:void 0,temperature:i.temperature,precipitation_probability:i.precipitation_probability,precipitation:i.precipitation,humidity:i.humidity,wind_speed:i.wind_speed,wind_gust_speed:i.wind_gust_speed,uv_index:i.uv_index,cloud_coverage:i.cloud_coverage,templow:i.templow}))):[]}function Ve(i,e){if(!i.datetime)return"";const t=new Date(i.datetime);if(Number.isNaN(t.getTime()))return"";const a=function(i){const e=String(i||"").trim().toLowerCase().replace(/[-_\s]/g,"");return["12","12h","12hour","12hours","ampm"].includes(e)?"12h":["24","24h","24hour","24hours"].includes(e)?"24h":void 0}(e),n={hour:"2-digit",minute:"2-digit"};return a&&(n.hour12="12h"===a),new Intl.DateTimeFormat(void 0,n).format(t)}function Fe(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function Be(i,e,t){const a=i.map(((i,t)=>({item:i,index:t,value:Fe(i,e)}))).filter((i=>void 0!==i.value));if(!a.length)return{points:[],min:0,max:1};const n=a.map((i=>i.value)),{min:o,max:c}=function(i,e){if("precipitation_probability"===i)return{min:0,max:100};let t=Math.min(...e),a=Math.max(...e);if("temperature"===i)t=5*Math.floor((t-2)/5),a=5*Math.ceil((a+2)/5);else{const i=Math.max(.18*(a-t),1);t=Math.max(0,t-i),a+=i}return a<=t&&(a=t+1),{min:t,max:a}}(e,n),r=t.width-t.left-t.right,s=t.height-t.top-t.bottom,l=a.map(((i,e)=>{const n=1===a.length?t.left+r/2:t.left+e/(a.length-1)*r,l=t.top+(c-i.value)/(c-o)*s;return Object.assign(Object.assign({},i),{x:n,y:l})}));return{points:l,min:o,max:c}}function He(i){return i<=0?[]:Array.from(new Set([0,Math.floor((i-1)/3),Math.floor(2*(i-1)/3),i-1])).filter((e=>e>=0&&e<i))}function Je(i){return i.replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Xe(i){if(!i.length)return"";if(1===i.length)return`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;let e=`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;for(let t=0;t<i.length-1;t+=1){const a=i[t],n=i[t+1],o=i[t-1]||a,c=i[t+2]||n,r=a.x+(n.x-o.x)/6,s=a.y+(n.y-o.y)/6,l=n.x-(c.x-a.x)/6,M=n.y-(c.y-a.y)/6;e+=` C ${r.toFixed(2)} ${s.toFixed(2)}, ${l.toFixed(2)} ${M.toFixed(2)}, ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return e}function Ke(i,e){if(!i.length)return"";const t=i[0],a=i[i.length-1];return`${Xe(i)} L ${a.x.toFixed(2)} ${e.toFixed(2)} L ${t.x.toFixed(2)} ${e.toFixed(2)} Z`}function qe(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";return`${e.getFullYear()}-${`${e.getMonth()+1}`.padStart(2,"0")}-${`${e.getDate()}`.padStart(2,"0")}`}function it(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function et(i,e,t){return Math.max(0,Math.min(100,(i-e)/(t-e)*100))}function tt(i){return fe(i.graph_height,82,260)||118}function at(i,e,t,a){const n=t.slice(0,7);if(!n.length)return G;const o=function(i){const e=new Map;return i.forEach(((i,t)=>{const a=qe(i.datetime),n=Fe(i,"temperature");if(!a||void 0===n)return;const o={item:i,value:n,x:0,y:0,index:t},c=e.get(a)||{};(!c.low||n<c.low.value)&&(c.low=o),(!c.high||n>c.high.value)&&(c.high=o),e.set(a,c)})),e}(a),{min:c,max:r}=function(i,e){const t=[];if(i.forEach((i=>{const e=it(i,"templow"),a=it(i,"temperature");void 0!==e&&t.push(e),void 0!==a&&t.push(a)})),e.forEach((i=>{const e=Fe(i,"temperature");void 0!==e&&t.push(e)})),!t.length)return{min:0,max:1};let a=5*Math.floor((Math.min(...t)-2)/5),n=5*Math.ceil((Math.max(...t)+2)/5);return n<=a&&(n=a+1),{min:a,max:n}}(n,a),s=qe((new Date).toISOString()),l=function(i,e){return Se(i,e.temp_sensor)}(i,e);return E`
    <section class="weather-daily-forecast">
      ...
      ${n.map((i=>{var t,a,n,M;const g=qe(i.datetime),I=o.get(g),N=null!==(t=it(i,"templow"))&&void 0!==t?t:null===(a=null==I?void 0:I.low)||void 0===a?void 0:a.value,d=null!==(n=it(i,"temperature"))&&void 0!==n?n:null===(M=null==I?void 0:I.high)||void 0===M?void 0:M.value;if(void 0===N||void 0===d)return G;const u=et(N,c,r),D=et(d,c,r),h=Math.max(4,D-u),j=String(i.condition||""),y=Number(i.precipitation_probability),z=Number.isFinite(y)?`Rain ${Math.round(y)}%`:"",p=g===s&&void 0!==l?et(l,c,r):void 0;return E`
          <div class="weather-daily-row">
            <div class="weather-daily-day">
              <span class="weather-daily-day-name">${function(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";const t=qe((new Date).toISOString()),a=new Date;a.setDate(a.getDate()+1);const n=qe(i);return n===t?"Today":n===qe(a.toISOString())?"Tomorrow":new Intl.DateTimeFormat(void 0,{weekday:"long"}).format(e)}(i.datetime)}</span>
              <span class="weather-daily-date">${function(i){if(!i)return"";const e=new Date(i);return Number.isNaN(e.getTime())?"":new Intl.DateTimeFormat(void 0,{day:"numeric",month:"short"}).format(e)}(i.datetime)}</span>
            </div>
            <div class="weather-daily-condition">
              ${Pe(We(j),`weather-daily-icon weather-condition-${Ee(j)}`,Qe(j))}
              ${z?E`<span title="Chance of precipitation">${z}</span>`:G}
            </div>
            <div class="weather-daily-low">
              <span>${N.toFixed(0)}°</span>
              ${(null==I?void 0:I.low)?E`<small>${Ve(I.low.item,e.time_format)}</small>`:G}
            </div>
            ...
            <div class="weather-daily-high">
              ...
              ${(null==I?void 0:I.high)?E`<small>${Ve(I.high.item,e.time_format)}</small>`:G}
            </div>
          </div>
        `}))}
    </section>
  `}function nt(i,e){if(!i.length)return"";const t=i[0],a=i.slice(0,12).reduce(((i,e)=>{const t=Number(i.precipitation_probability)||0,a=Number(e.precipitation_probability)||0,n=Number(i.precipitation)||0,o=Number(e.precipitation)||0;return o>n||o===n&&a>t?e:i}),t),n=Number(a.precipitation_probability)||0,o=Number(a.precipitation)||0;if(n>=25||o>0){const i=a===t,c=Ve(a,e);let r;r=n>=80||o>=2?"Rain likely":n>=50||o>=.5?"Showers possible":"Slight chance of rain";const s=i?"shortly":c?`around ${c}`:"";return`${s?`${r} ${s}`:r} (${n>0?`${Math.round(n)}% chance`:`${o.toFixed(1)} mm`})`}return`${Qe(String(t.condition||""))}, ${c=t,`${Le(c.temperature,0)}°`}`;var c}function ot(i){i.stopPropagation()}function ct(i,e,t){e.preventDefault(),e.stopPropagation(),t&&"function"==typeof(null==i?void 0:i._openMoreInfo)&&i._openMoreInfo(t)}function rt(i,e,t){"Enter"!==e.key&&" "!==e.key||ct(i,e,t)}function st(i,e,t,a,n){if(e.stopPropagation(),!a||"function"!=typeof(null==i?void 0:i._setWeatherForecastGraphSelection))return;const o=e.currentTarget.getBoundingClientRect();if(!o.width)return;const c=(e.clientX-o.left)/o.width,r=n.left/n.width,s=(n.width-n.right)/n.width,l=Math.max(0,Math.min(1,(c-r)/(s-r))),M=Math.round(l*(a-1));t.forEach((e=>i._setWeatherForecastGraphSelection(e,M)))}function lt(i,e,t){const a="function"==typeof(null==i?void 0:i._getWeatherForecastGraphSelection)?i._getWeatherForecastGraphSelection(e):void 0,n=function(i){const e=Date.now();let t=0,a=Number.POSITIVE_INFINITY;return i.forEach(((i,n)=>{const o=i.item.datetime?new Date(i.item.datetime).getTime():Number.NaN;if(!Number.isFinite(o))return;const c=Math.abs(o-e);c<a&&(a=c,t=n)})),t}(t);return t[Math.max(0,Math.min(t.length-1,Number.isFinite(Number(a))?Number(a):n))]||t[0]}function Mt(i,e,t,a){const n=i.height-i.bottom;return[...[0,1,2].map((e=>{const t=i.top+e*((n-i.top)/2);return U`<line class="weather-conditions-grid-line" x1=${i.left} x2=${i.width-i.right} y1=${t} y2=${t}></line>`})),...e.map((e=>{const o=t[e];return U`
        <line class="weather-conditions-time-line" x1=${o.x} x2=${o.x} y1=${i.top} y2=${n}></line>
        <text class="weather-conditions-time-label" x=${o.x} y=${i.height-6}>${Ve(o.item,a)}</text>
      `}))]}function gt(i,e,t,a,n){const o={width:360,height:tt(e),left:14,right:42,top:15,bottom:24},{points:c,min:r,max:s}=Be(t,"temperature",o);if(c.length<2)return G;const l=o.height-o.bottom,M=lt(i,a,c),g=c.reduce(((i,e)=>e.value<i.value?e:i),c[0]),I=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),N=He(c.length),d=function(i){if(i.length<=7)return i;const e=Math.max(1,Math.ceil(i.length/7));return i.filter(((i,t)=>t%e==0)).slice(0,7)}(c),u=Xe(c),D=Ke(c,l),h=Je(a),j=`weather-conditions-temp-line-${h}`,y=`weather-conditions-temp-fill-${h}`,z=(r+s)/2;return E`
    <section class="weather-conditions-card weather-conditions-temp">
      <div class="weather-conditions-head">
        ...
        <div class="weather-conditions-selected">
          <span>${Ve(M.item,e.time_format)}</span>
      ...
      ${d.length?E`
        <div class="weather-conditions-icons">
          ${d.map((i=>{const e=String(i.item.condition||"");return E`
              ${Pe(We(e),`weather-conditions-icon weather-condition-${Ee(e)}`,Qe(e))}
            `}))}
        </div>
      `:G}
      ...
      <div class="weather-conditions-chart-frame">
        <svg
          ...
          @pointerdown=${ot}
          @pointermove=${e=>st(i,e,n,c.length,o)}
          @click=${e=>st(i,e,n,c.length,o)}
        >
          <defs>
            ...
            <linearGradient id=${j} x1=${o.left} x2=${o.width-o.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
              ${c.map(((i,e)=>U`
                <stop offset=${e/(c.length-1)*100+"%"} stop-color=${Oe(i.value)}></stop>
              `))}
            </linearGradient>
          </defs>
          ${Mt(o,N,c,e.time_format)}
  ...
  `}function It(i,e,t,a,n,o){if(t.length<2)return G;const c=`${n}-temperature`,r=`${n}-precipitation`,s=o?[c,r]:null,l=a.includes("temperature")?gt(i,e,t,c,s||[c]):G,M=a.includes("precipitation_probability")?function(i,e,t,a,n){const o={width:360,height:tt(e),left:14,right:42,top:10,bottom:22},{points:c}=Be(t,"precipitation_probability",o);if(c.length<2)return G;const r=o.height-o.bottom,s=lt(i,a,c),l=c.reduce(((i,e)=>e.value>i.value?e:i),c[0]),M=He(c.length),g=Xe(c),I=Ke(c,r),N=`weather-conditions-rain-fill-${Je(a)}`;return E`
    <section class="weather-conditions-card weather-conditions-rain">
      <div class="weather-conditions-head">
        ...
        <div class="weather-conditions-selected">
          <span>${Ve(s.item,e.time_format)}</span>
  ...
  `}(i,e,t,r,s||[r]):G;return l===G&&M===G?G:E`
    <div class="weather-conditions-panel">
      ${l}
      ${M}
    </div>
  `}function Nt(i,e){var t,a;const n=ve(xe(i,e.entity)).toLowerCase(),o=e.name||"Weather",c=Ye(i,e.temp_sensor),r=function(i,e){const t=Se(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),s=Ye(i,e.feels_like_sensor),l=$e(i,e),M=!1===e.show_forecast?[]:Re(e.forecast),g=!1===e.show_forecast?[]:Re(e.daily_forecast),I=Number(e.forecast_slots),N=Number.isFinite(I)&&I>0?Math.min(Math.floor(I),72):8,d=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):we,t=[];return e.forEach((i=>{const e=be[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:we}(e.forecast_fields),u=M.slice(0,N),D=nt(M,e.time_format),h=String((null===(t=M[0])||void 0===t?void 0:t.condition)||n||"").toLowerCase(),j=h||n,y=`weather-icon weather-condition-${Ee(j)}`,z=D||Qe(h||n),p=E`<span class="weather-source-badge" title="Forecast data" aria-label="Forecast data"></span>`,A=e.forecast_graph_key||`weather-${e.entity||o}`,m=!1!==e.sync_graphs,w=It(i,e,u,d,A,m),b=at(i,e,g,M),T=Array.isArray(e.chips)?e.chips:[],O=fe(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),x=fe(e.icon_size,28,160),v=fe(e.graph_height,82,260),S=function(i,e){const t=Number(e.stale_minutes);if(!Number.isFinite(t)||t<=0)return!1;const a=[e.entity,e.temp_sensor,e.humidity_sensor,e.feels_like_sensor].filter(Boolean);let n=0;return a.forEach((e=>{const t=xe(i,e),a=(null==t?void 0:t.last_updated)?Date.parse(t.last_updated):NaN;Number.isFinite(a)&&(n=Math.max(n,a))})),!!n&&Date.now()-n>6e4*t}(i,e),L=[O?`--weather-temp-size:${O}px;`:"",x?`--weather-icon-size:${x}px;--weather-icon-bg-size:${x+16}px;`:"",v?`--weather-graph-height:${v}px;`:""].filter(Boolean).join("");return E`
    <div class="tile-wrap weather-tile-wrap" style=${L}>
      <div class=${"weather-tile"+(S?" weather-tile-stale":"")}>
        <div class="weather-content">
          <div class="weather-top">
            <div class="weather-heading">
              ...
              <div class="weather-primary">
                <span
                  ...
                  @pointerdown=${ot}
                  @pointerup=${ot}
                  @click=${t=>ct(i,t,e.temp_sensor)}
                  @keyup=${t=>rt(i,t,e.temp_sensor)}
                >${c}</span>
                <span
                  ...
                  @pointerdown=${ot}
                  @pointerup=${ot}
                  @click=${t=>ct(i,t,e.humidity_sensor)}
                  @keyup=${t=>rt(i,t,e.humidity_sensor)}
                >${r}</span>
              </div>
              <div
                ...
                @pointerdown=${ot}
                @pointerup=${ot}
                @click=${t=>ct(i,t,e.feels_like_sensor)}
                @keyup=${t=>rt(i,t,e.feels_like_sensor)}
              >Feels like ${s}</div>
            </div>
            <div class="weather-icon-wrap weather-clickable"
              ...
              @pointerdown=${ot}
              @pointerup=${ot}
              @click=${t=>ct(i,t,e.entity)}
              @keyup=${t=>rt(i,t,e.entity)}
            >
              ${e.icon?E`<ha-icon class=${y} .icon=${e.icon}></ha-icon>`:Pe(We(j),y,Qe(j))}
            </div>
          </div>
          ...
          <div class="weather-grid">
            ${l.map((e=>E`
              <div
                ...
                @keyup=${t=>rt(i,t,e.entity)}
              >
                ${e.mdi?E`<ha-icon class="weather-metric-icon" .icon=${e.mdi}></ha-icon>`:e.icon?Pe(e.icon,"weather-metric-icon",e.label):E`<ha-state-icon class="weather-metric-icon" .hass=${i.hass} .stateObj=${xe(i,e.stateEntity)}></ha-state-icon>`}
        ...
        ${T.length?E`<div class="weather-chips-bottom-right">
              ${T.map((e=>E`
                <div
                  ...
                  @pointerdown=${ot}
                  @pointerup=${ot}
                  @click=${t=>ct(i,t,(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity))}
                  @keyup=${t=>rt(i,t,(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity))}
                >
                  ${ue(i,e)}
                </div>
              `))}
...
`;var wt;let bt=wt=class extends ni{constructor(){super(...arguments),this._visiblePendingSwitches=new Set,this._weatherForecastGraphSelections=new Map,this._rowCardElements=new Map,this._rowCardConfigs=new Map,this._rowCardPromises=new Map,this._switchTemplateValues=new Map,this._weatherForecastValues=new Map,this._pendingSwitches=new Map,this._switchPendingDelayMs=300,this._switchPendingTimeoutMs=1e4}static getConfigElement(){return document.createElement("space-hub-card-editor")}static getStubConfig(){return{tile_height:80,chip_icon_size:14,main_icon_size:48,chip_font_size:12,card_shadow_color:"#000000",card_shadow_intensity:.5,unavailable_pulse_color:"#ff3b30",switch_rows:[],cards:[]}}setConfig(i){if(!i)throw new Error("Configuration is required");this._validateConfig(i,{allowIncomplete:!0});const e=Ri(i||{});Array.isArray(e.headers)||(e.headers=[]),Array.isArray(e.switch_rows)||(e.switch_rows=[]),Array.isArray(e.cards)||(e.cards=[]),this._clearRowCardCache(),this._config=e,this._syncTemplateEntries(e.switch_rows),this._syncWeatherForecastEntries(e.headers)}_isValidEntityId(i){return"string"==typeof i&&i.includes(".")&&!i.includes(" ")}_validateConfig(i,e={}){const t=!!e.allowIncomplete,a=[];i.headers&&Array.isArray(i.headers)&&i.headers.forEach(((i,e)=>{if(i){if(i.ac&&(i.ac.entity?this._isValidEntityId(i.ac.entity)||a.push(`Header ${e+1}: AC entity '${i.ac.entity}' must be a valid entity ID (e.g., 'climate.living_room')`):t||a.push(`Header ${e+1}: AC tile requires an 'entity' field`)),i.thermostat&&(i.thermostat.entity?this._isValidEntityId(i.thermostat.entity)||a.push(`Header ${e+1}: Thermostat entity '${i.thermostat.entity}' must be a valid entity ID (e.g., 'climate.bedroom')`):t||a.push(`Header ${e+1}: Thermostat tile requires an 'entity' field`)),i.main){const n=i.main;!!(n.main_name||n.main_icon||n.tap_entity||n.light_group_entity||n.temp_sensor||n.humidity_sensor||Array.isArray(n.chips)&&n.chips.length>0)||t||a.push(`Header ${e+1}: Main tile must have at least one of: main_name, main_icon, tap_entity, light_group_entity, temp_sensor, humidity_sensor, or chips`);["tap_entity","hold_entity","light_group_entity","temp_sensor","humidity_sensor"].forEach((i=>{const t=n[i];t&&!this._isValidEntityId(t)&&a.push(`Header ${e+1}: Main tile ${i} '${t}' must be a valid entity ID`)}))}if(i.weather){const n=i.weather;!!(n.name||n.icon||n.entity||void 0!==n.animated_icons||void 0!==n.show_forecast||n.forecast_type||n.forecast_slots||n.forecast_fields||n.time_format||n.height||n.temp_size||n.temperature_size||n.icon_size||n.graph_height||n.temp_sensor||n.temp_min_24h_sensor||n.temp_max_24h_sensor||n.humidity_sensor||n.feels_like_sensor||n.dewpoint_sensor||n.wind_speed_sensor||n.wind_gust_sensor||n.wind_direction_sensor||n.rain_state_sensor||n.rain_today_sensor||n.rain_rate_sensor||n.uv_sensor||n.solar_lux_sensor||n.pressure_sensor||Array.isArray(n.chips)&&n.chips.length>0)||t||a.push(`Header ${e+1}: Weather tile must have at least one weather entity, sensor, name, icon, or chip`);["entity","temp_sensor","temp_min_24h_sensor","temp_max_24h_sensor","humidity_sensor","feels_like_sensor","dewpoint_sensor","wind_speed_sensor","wind_gust_sensor","wind_direction_sensor","rain_state_sensor","rain_today_sensor","rain_rate_sensor","uv_sensor","solar_lux_sensor","pressure_sensor"].forEach((i=>{const t=n[i];t&&!this._isValidEntityId(t)&&a.push(`Header ${e+1}: Weather tile ${i} '${t}' must be a valid entity ID`)}));if(["height","temp_size","temperature_size","icon_size","graph_height"].forEach((i=>{const t=n[i];if(null!=t){const n=Number(t);(!Number.isFinite(n)||n<=0)&&a.push(`Header ${e+1}: Weather tile ${i} must be a positive number, got: ${t}`)}})),void 0!==n.forecast_slots&&null!==n.forecast_slots){const i=Number(n.forecast_slots);(!Number.isFinite(i)||i<0)&&a.push(`Header ${e+1}: Weather tile forecast_slots must be a positive number, got: ${n.forecast_slots}`)}if(n.forecast_type&&!["hourly","daily","twice_daily"].includes(String(n.forecast_type))&&a.push(`Header ${e+1}: Weather tile forecast_type must be one of: hourly, daily, twice_daily`),n.time_format&&!["12h","24h"].includes(String(n.time_format).toLowerCase())&&a.push(`Header ${e+1}: Weather tile time_format must be one of: 12h, 24h`),void 0!==n.forecast_fields&&null!==n.forecast_fields){const i=Array.isArray(n.forecast_fields)?n.forecast_fields:String(n.forecast_fields).split(","),t=new Set(["temp","temperature","rain_chance","precipitation_probability","precip_probability","probability","pop","rain","precipitation","hum","humidity","wind","wind_speed","gust","wind_gust","wind_gust_speed","uv","uv_index","cloud","clouds","cloud_coverage"]);i.forEach((i=>{const n=String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_");n&&!t.has(n)&&a.push(`Header ${e+1}: Weather tile forecast field '${i}' is not supported`)}))}}!i.ac&&!i.thermostat||i.main||t||a.push(`Header ${e+1}: AC and Thermostat tiles require a 'main' configuration block`)}else a.push(`Header ${e+1}: Header configuration cannot be empty`)})),i.switch_rows&&Array.isArray(i.switch_rows)&&i.switch_rows.forEach(((i,e)=>{if(!i)return void a.push(`Switch row ${e+1}: Switch row configuration cannot be empty`);const n=Array.isArray(i)?i:Array.isArray(i.row)?i.row:[];Array.isArray(n)&&0!==n.length||t?n.forEach(((i,n)=>{i&&i.entity?this._isValidEntityId(i.entity)||a.push(`Switch row ${e+1}, item ${n+1}: Switch entity '${i.entity}' must be a valid entity ID`):t||a.push(`Switch row ${e+1}, item ${n+1}: Switch item requires an 'entity' field`),(null==i?void 0:i.hold_entity)&&!this._isValidEntityId(i.hold_entity)&&a.push(`Switch row ${e+1}, item ${n+1}: hold_entity '${i.hold_entity}' must be a valid entity ID`)})):a.push(`Switch row ${e+1}: Switch row must contain at least one switch item`)}));if(Object.entries({tile_height:"Tile height",chip_icon_size:"Chip icon size",main_icon_size:"Main icon size",chip_font_size:"Chip font size",card_shadow_intensity:"Card shadow intensity"}).forEach((([e,t])=>{const n=i[e];if(null!=n){const i=Number(n);(!Number.isFinite(i)||i<0)&&a.push(`${t} must be a positive number, got: ${n}`)}})),void 0!==i.card_shadow_intensity&&null!==i.card_shadow_intensity){const e=Number(i.card_shadow_intensity);Number.isFinite(e)&&(e<0||e>1)&&a.push(`Card shadow intensity must be between 0 and 1, got: ${e}`)}if(["card_shadow_color","unavailable_pulse_color"].forEach((e=>{const t=i[e];if(t&&"string"==typeof t){/^(#[0-9a-fA-F]{3,8}|rgb\(|rgba\(|hsl\(|hsla\(|[a-zA-Z]+).*$/.test(t)||a.push(`${e.replace(/_/g," ")} '${t}' is not a valid color format`)}})),a.length>0)throw new Error(`Invalid space-hub-card configuration:\n${a.map((i=>`• ${i}`)).join("\n")}`)}getCardSize(){return 6}render(){var i,e,t,a,n,o,c,r,s;if(!this._config)return G;const l=wt.getStubConfig(),M=this._config||{},g={tile_height:null!==(i=M.tile_height)&&void 0!==i?i:l.tile_height,chip_icon_size:null!==(e=M.chip_icon_size)&&void 0!==e?e:l.chip_icon_size,main_icon_size:null!==(t=M.main_icon_size)&&void 0!==t?t:l.main_icon_size,chip_font_size:null!==(a=M.chip_font_size)&&void 0!==a?a:l.chip_font_size,card_shadow_color:null!==(n=M.card_shadow_color)&&void 0!==n?n:l.card_shadow_color,card_shadow_intensity:null!==(o=M.card_shadow_intensity)&&void 0!==o?o:l.card_shadow_intensity,unavailable_pulse_color:null!==(c=M.unavailable_pulse_color)&&void 0!==c?c:l.unavailable_pulse_color,headers:Array.isArray(M.headers)&&M.headers.length?M.headers:[],switch_rows:Array.isArray(M.switch_rows)?M.switch_rows:[],cards:Array.isArray(M.cards)?M.cards:[],tap_action:M.tap_action,hold_action:M.hold_action,double_tap_action:M.double_tap_action},I=Array.isArray(g.headers)&&g.headers.length?g.headers:[],N=Number(g.tile_height)||Number(l.tile_height)||80,d=Number(g.chip_icon_size)||Number(l.chip_icon_size)||14,u=Number(g.chip_font_size)||Number(l.chip_font_size)||12,D=Math.max(u+10,20),h=Math.round(.625*N),j=I[0]||{},y=Number(null!==(r=null==j?void 0:j.main_icon_size)&&void 0!==r?r:null==j?void 0:j.maicon_size),z=Number.isFinite(y)&&y>0?y:Number(g.main_icon_size)||Number(l.main_icon_size)||48,p=this._rgbaFromColor(g.card_shadow_color||l.card_shadow_color,null!==(s=g.card_shadow_intensity)&&void 0!==s?s:l.card_shadow_intensity),A=g.unavailable_pulse_color||l.unavailable_pulse_color||"#ff3b30",m=this._hasAnyUnavailable(g,I),w=this._rgbaFromColor(A,.18),b=this._rgbaFromColor(A,.36);return E`
    ...
    `}updated(i){super.updated(i),i.has("hass")&&(this._rowCardElements.forEach((i=>{i&&(i.hass=this.hass)})),this._resumeTemplateSubscriptions(),this._resumeWeatherForecastSubscriptions(),this._syncPendingSwitches())}connectedCallback(){super.connectedCallback(),this._resumeTemplateSubscriptions(),this._resumeWeatherForecastSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._switchTemplateValues.forEach((i=>this._disposeTemplateEntry(i))),this._weatherForecastValues.forEach((i=>this._disposeWeatherForecastEntry(i))),this._clearAllPendingSwitches()}_renderHeaderRow(i,e){const t=i.main||{},a=i.weather||{},n={tap_entity:t.tap_entity,hold_entity:t.hold_entity||t.tap_entity,glow_mode:t.glow_mode,light_group_entity:t.light_group_entity,name:t.main_name||t.name,icon:t.main_icon||t.icon,temp_sensor:t.temp_sensor,humidity_sensor:t.humidity_sensor,chips:Array.isArray(t.chips)?t.chips:[],tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action},o={entity:a.entity,name:a.name||a.main_name,icon:a.icon||a.main_icon,height:a.height,temp_size:a.temp_size,temperature_size:a.temperature_size,icon_size:a.icon_size,graph_height:a.graph_height,animated_icons:a.animated_icons,show_forecast:a.show_forecast,sync_graphs:a.sync_graphs,stale_minutes:a.stale_minutes,rain_rate_threshold:a.rain_rate_threshold,forecast_type:a.forecast_type,forecast_slots:a.forecast_slots,forecast_fields:a.forecast_fields,time_format:a.time_format,forecast_graph_key:`weather-${e}`,temp_sensor:a.temp_sensor,temp_min_24h_sensor:a.temp_min_24h_sensor,temp_max_24h_sensor:a.temp_max_24h_sensor,humidity_sensor:a.humidity_sensor,feels_like_sensor:a.feels_like_sensor,dewpoint_sensor:a.dewpoint_sensor,wind_speed_sensor:a.wind_speed_sensor,wind_gust_sensor:a.wind_gust_sensor,wind_direction_sensor:a.wind_direction_sensor,rain_state_sensor:a.rain_state_sensor,rain_today_sensor:a.rain_today_sensor,rain_rate_sensor:a.rain_rate_sensor,uv_sensor:a.uv_sensor,solar_lux_sensor:a.solar_lux_sensor,pressure_sensor:a.pressure_sensor,metrics:Array.isArray(a.metrics)?a.metrics:void 0,chips:Array.isArray(a.chips)?a.chips:[],tap_action:a.tap_action,hold_action:a.hold_action,double_tap_action:a.double_tap_action,forecast:!1===a.show_forecast?[]:this._getWeatherForecast(a.entity,a.forecast_type),daily_forecast:!1===a.show_forecast?[]:this._getWeatherForecast(a.entity,"daily")},c=i.ac||{},r=i.thermostat||{},s=!!(null==c?void 0:c.entity),l=!!(null==r?void 0:r.entity),M=!(!t||!(t.main_name||t.name||t.light_group_entity||t.entity||t.main_icon||t.icon||t.temp_sensor||t.humidity_sensor||Array.isArray(t.chips)&&t.chips.length)),g=!(!a||!(a.name||a.main_name||a.icon||a.main_icon||void 0!==a.animated_icons||void 0!==a.show_forecast||a.forecast_type||a.forecast_slots||a.forecast_fields||a.time_format||a.height||a.temp_size||a.temperature_size||a.icon_size||a.graph_height||a.entity||a.temp_sensor||a.temp_min_24h_sensor||a.temp_max_24h_sensor||a.humidity_sensor||a.feels_like_sensor||a.dewpoint_sensor||a.wind_speed_sensor||a.wind_gust_sensor||a.wind_direction_sensor||a.rain_state_sensor||a.rain_today_sensor||a.rain_rate_sensor||a.uv_sensor||a.solar_lux_sensor||a.pressure_sensor||Array.isArray(a.chips)&&a.chips.length)),I=M&&s,N=M&&l;M||!s&&!l||console.warn("space-hub-card: header contains `ac`/`thermostat` outside of `main` — ignoring per configured rules.");const d=I||N?I&&N?"header-row":"header-row main-plus-one":"header-row only-main";return E`
      ...
      ${M?E`<div class=${d}>
        ${M?pe(this,n):G}
        ${I?function(i,e){var t,a,n;const o=(null==e?void 0:e.entity)||"",c=null==e?void 0:e.glow_mode,r=((null===(n=null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.states)||void 0===a?void 0:a[o])||void 0===n?void 0:n.state)||"").toLowerCase(),s=!!r&&"off"!==r,l="function"==typeof(null==i?void 0:i._acChip)?i._acChip(r):{icon:"mdi:air-conditioner"},M=(null==l?void 0:l.icon)||"mdi:air-conditioner",g="ac-mode-"+((I=r)&&"off"!==I?I.includes("cool")?"cool":I.includes("heat")?"heat":I.includes("dry")?"dry":I.includes("fan")?"fan":I.includes("auto")?"auto":"default":"off");var I;const N=`chip chip-temperature-humidity ac-chip ${g}`,d=`ac-fan ${g}${s?" spinning":""}`,u=function(i){const e=(i||"").toLowerCase();return e&&"off"!==e?e.includes("cool")?{weak:"rgba(0,170,255,0.12)",strong:"rgba(0,170,255,0.26)"}:e.includes("heat")?{weak:"rgba(255,112,67,0.12)",strong:"rgba(255,112,67,0.26)"}:e.includes("dry")?{weak:"rgba(255,202,40,0.12)",strong:"rgba(255,202,40,0.26)"}:e.includes("fan")?{weak:"rgba(102,187,106,0.12)",strong:"rgba(102,187,106,0.26)"}:e.includes("auto")?{weak:"rgba(38,198,218,0.12)",strong:"rgba(38,198,218,0.26)"}:{weak:"rgba(0,0,0,0.06)",strong:"rgba(0,0,0,0.12)"}:{weak:"rgba(0,0,0,0.00)",strong:"rgba(0,0,0,0.00)"}}(r),D=null!=c?c:"static",{style:h,overlay:j}=ze(u,D,s);return E`
    <div class="tile-wrap">
    ...
    <div class="tile-wrap">
      ...
      >
        ...
        <div class="temperature-chip-container">
          ${z?E`<ha-chip class=${h}>${d}</ha-chip>`:E`<div class=${j}><span class="thermostat-target">${d}</span></div>`}
        </div>
        <div class="center-xy">
