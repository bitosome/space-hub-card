        ...
        >
          <div class="tile-inner">
            ${g?R`<ha-chip style=${`--ha-chip-background-color:${_};--chip-background-color:${_};--ha-chip-text-color:${b};color:${b};font-weight:600;`}>
                  ...
                  ${o?R`<ha-icon class="switch-icon" .icon=${o} style=${`${u}${a?`color:${m};`:""}`}></ha-icon>`:U}
                  ${r?R`<div class="name" style=${`${p}${a?`color:${m};`:""}`}>${r}</div>`:U}
                `}
          </div>
        </ha-control-button>
      </div>
