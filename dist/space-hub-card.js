  ...
  `}function gt(i,e){var t,a;const n=ve(xe(i,e.entity)).toLowerCase(),o=e.name||"Weather",c=Ce(i,e.temp_sensor),r=function(i,e){const t=Se(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),s=Ce(i,e.feels_like_sensor),l=We(i,e),M=!1===e.show_forecast?[]:Pe(e.forecast),g=!1===e.show_forecast?[]:Pe(e.daily_forecast),I=Number(e.forecast_slots),N=Number.isFinite(I)&&I>0?Math.min(Math.floor(I),72):8,d=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):we,t=[];return e.forEach((i=>{const e=Te[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:we}(e.forecast_fields),u=M.slice(0,N),D=tt(M,e.time_format),h=String((null===(t=M[0])||void 0===t?void 0:t.condition)||n||"").toLowerCase(),j=h||n,z=`weather-icon weather-condition-${Qe(j)}`,y=D||_e(h||n),p=E`<span class="weather-source-badge" title="Forecast data" aria-label="Forecast data"></span>`,A=e.forecast_graph_key||`weather-${e.entity||o}`,m=Mt(i,e,u,d,A),w=et(i,e,g,M),T=Array.isArray(e.chips)?e.chips:[],b=!!e.double_tap_action,O=Number(e.height),x=Ye(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),v=Ye(e.icon_size,28,76),S=Ye(e.graph_height,82,260),L=[Number.isFinite(O)&&O>0?`--weather-tile-h:${O}px;`:"",x?`--weather-temp-size:${x}px;`:"",v?`--weather-icon-size:${v}px;--weather-icon-bg-size:${v+16}px;`:"",S?`--weather-graph-height:${S}px;`:""].filter(Boolean).join("");return E`
    <div class="tile-wrap weather-tile-wrap" style=${L}>
      <ha-control-button
        ...
        .actionHandler=${Ie({hasHold:!0,hasDoubleClick:b})}
        role="button" tabindex="0"
      >
        <div class="weather-content">
          <div class="weather-top">
            ...
            <div class="weather-icon-wrap weather-clickable"
              ...
              @keyup=${t=>ot(i,t,e.entity)}
            >
              ${e.icon?E`<ha-icon class=${z} .icon=${e.icon}></ha-icon>`:Ge(Ze(j),z,_e(j))}
            </div>
          </div>
