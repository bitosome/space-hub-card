      ...
      <div class="sub-item">
        ...
        <div class="confirmation-settings">
          <ha-formfield label="Require confirmation on tap">
            <ha-switch
              .checked=${r}
              @change=${t=>{const e=t.target.checked;this._setSwitchConfirmation(h,e)}}
            ></ha-switch>
          </ha-formfield>
          ${r?L`
