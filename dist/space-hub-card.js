          ...
          ${!!i?E`
            ...
            <div class="side-by-side">
              ...
              <space-hub-textfield
                ...
                min="2"
                max="9"
                .value=${String(null!==(y=z.graph_horizontal_lines)&&void 0!==y?y:"")}
    ...
    <section class="weather-conditions-card weather-conditions-temp">
      ...
      <div class="weather-conditions-chart-frame">
        ...
        >
          ...
          <text class="weather-conditions-axis" x=${o.width-5} y=${o.top+(l-o.top)/2}>${p.toFixed(0)}°</text>
