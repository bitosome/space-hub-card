 ...
 */var wi;null===(wi=window.HTMLSlotElement)||void 0===wi||wi.prototype.assignedElements;var Ti="[^\\s]+";function Oi(i,e){for(var t=[],a=0,n=i.length;a<n;a++)t.push(i[a].substr(0,e));return t}var xi=function(i){return function(e,t){var a=t[i].map((function(i){return i.toLowerCase()})),n=a.indexOf(e.toLowerCase());return n>-1?n:null}};function vi(i){for(var e=[],t=1;t<arguments.length;t++)e[t-1]=arguments[t];for(var a=0,n=e;a<n.length;a++){var o=n[a];for(var r in o)i[r]=o[r]}return i}var Si=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],Li=["January","February","March","April","May","June","July","August","September","October","November","December"],ki=Oi(Li,3),Ci={dayNamesShort:Oi(Si,3),dayNames:Si,monthNamesShort:ki,monthNames:Li,amPm:["am","pm"],DoFn:function(i){return i+["th","st","nd","rd"][i%10>3?0:(i-i%10!=10?1:0)*i%10]}},_i=(vi({},Ci),function(i){return+i-1}),fi=[null,"[1-9]\\d?"],Yi=[null,Ti],Qi=["isPm",Ti,function(i,e){var t=i.toLowerCase();return t===e.amPm[0]?0:t===e.amPm[1]?1:null}],Ei=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(i){var e=(i+"").match(/([+-]|\d\d)/gi);if(e){var t=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?t:-t}return 0}];xi("monthNamesShort"),xi("monthNames");var Ui,Zi;!function(){try{(new Date).toLocaleDateString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleString("i")}catch(i){return"RangeError"===i.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(i){return"RangeError"===i.name}}(),function(i){i.language="language",i.system="system",i.comma_decimal="comma_decimal",i.decimal_comma="decimal_comma",i.space_comma="space_comma",i.none="none"}(Ui||(Ui={})),function(i){i.language="language",i.system="system",i.am_pm="12",i.twenty_four="24"}(Zi||(Zi={}));var Gi=function(i,e,t,a){a=a||{},t=null==t?{}:t;var n=new Event(e,{bubbles:void 0===a.bubbles||a.bubbles,cancelable:Boolean(a.cancelable),composed:void 0===a.composed||a.composed});return n.detail=t,i.dispatchEvent(n),n},Wi=new Set(["call-service","divider","section","weblink","cast","select"]),Pi={alert:"toggle",automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",media_player:"media-player",remote:"toggle",scene:"scene",script:"script",sensor:"sensor",timer:"timer",switch:"toggle",vacuum:"toggle",water_heater:"climate",input_datetime:"input-datetime"},$i=function(i,e){void 0===e&&(e=!1);var t=function(i,e){return a("hui-error-card",{type:"error",error:i,config:e})},a=function(i,e){var a=window.document.createElement(i);try{a.setConfig(e)}catch(a){return console.error(i,a),t(a.message,e)}return a};if(!i||"object"!=typeof i||!e&&!i.type)return t("No type defined",i);var n=i.type;if(n&&n.startsWith("custom:"))n=n.substr("custom:".length);else if(e)if(Wi.has(n))n="hui-"+n+"-row";else{if(!i.entity)return t("Invalid config given.",i);var o=i.entity.split(".",1)[0];n="hui-"+(Pi[o]||"text")+"-entity-row"}else n="hui-"+n+"-card";if(customElements.get(n))return a(n,i);var r=t("Custom element doesn't exist: "+i.type+".",i);r.style.display="None";var c=setTimeout((function(){r.style.display=""}),2e3);return customElements.whenDefined(i.type).then((function(){clearTimeout(c),Gi(r,"ll-rebuild",{},r)})),r};function Ri(i){return JSON.parse(JSON.stringify(i))}const Vi=new Set(["more-info","toggle","perform-action","navigate","url","assist","none","fire-dom-event","call-service"]),Fi=i=>!!i&&"object"==typeof i&&!Array.isArray(i),Bi=i=>!!((null==i?void 0:i.tap_action)||(null==i?void 0:i.hold_action)||(null==i?void 0:i.double_tap_action)),Hi=i=>{if(null==i||!1===i)return;if(!0===i)return!0;if("string"==typeof i){const e=i.trim();return!e||{text:e}}if(!Fi(i))return;const e={};if("string"==typeof i.text&&i.text.trim()&&(e.text=i.text),"string"==typeof i.title&&i.title.trim()&&(e.title=i.title),"string"==typeof i.confirm_text&&i.confirm_text.trim()&&(e.confirm_text=i.confirm_text),"string"==typeof i.dismiss_text&&i.dismiss_text.trim()&&(e.dismiss_text=i.dismiss_text),Array.isArray(i.exemptions)){const t=i.exemptions.filter((i=>!!i&&"object"==typeof i&&"string"==typeof i.user)).map((i=>({user:i.user})));t.length&&(e.exemptions=t)}return!Object.keys(e).length||e},Ji=i=>{if(Fi(i)&&"string"==typeof i.action&&Vi.has(i.action)){if("call-service"===i.action||"perform-action"===i.action){return Object.assign(Object.assign({},i),{action:"perform-action",perform_action:"string"==typeof i.perform_action?i.perform_action:"string"==typeof i.service?i.service:void 0,data:Fi(i.data)?i.data:Fi(i.service_data)?i.service_data:void 0,target:Fi(i.target)?i.target:void 0,confirmation:Hi(i.confirmation)})}return Object.assign(Object.assign({},i),{confirmation:Hi(i.confirmation)})}},Xi=["lock","door","presence","illuminance","gate","sliding_gate","smart_plug","custom"],Ki=["switch","smart_plug","lock"],qi=["static","pulse","none"],ie=["more-info","toggle","perform-action","navigate","url","assist","none"],ee="M4,12L5.41,13.41L11,7.83V20H13V7.83L18.59,13.42L20,12L12,4L4,12Z",te="M4,12L5.41,10.59L11,16.17V4H13V16.17L18.59,10.58L20,12L12,20L4,12Z",ae="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z";let ne=class extends ni{constructor(){super(...arguments),this.label="",this.value="",this.placeholder="",this.type="text",this.disabled=!1}_onInput(i){i.stopPropagation(),this.disabled||(this.value=i.currentTarget.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0})))}render(){return E`
    ...
    `}_renderWeatherConfig(i,e){var t,a,n,o,r,c,s,l,M,g,d,N,I,u,h,D,j;const y=i||{};return E`
      <ha-expansion-panel outlined .header=${"Weather Tile"}>
        <div class="section-content">
          ${!!i?E`
            ...
            ${this._renderForecastSourcesConfig(y,e)}
            <div class="side-by-side">
            ...
            <div class="side-by-side">
              <space-hub-textfield
                ...
                min="8"
                max="48"
                .value=${String(null!==(N=y.conditions_icon_size)&&void 0!==N?N:"")}
              ...
              <space-hub-textfield
                ...
                min="0"
                max="72"
                .value=${String(null!==(I=y.temperature_icon_count)&&void 0!==I?I:"")}
...
class pe extends ze{}pe.directiveName="unsafeSVG",pe.resultType=2;const me=ci(pe),Ae={barometer:"data:image/svg+xml;base64,","clear-day":"data:image/svg+xml;base64,","clear-night":"data:image/svg+xml;base64,",cloudy:"data:image/svg+xml;base64,",drizzle:"data:image/svg+xml;base64,",fog:"data:image/svg+xml;base64,",hail:"data:image/svg+xml;base64,","not-available":"data:image/svg+xml;base64,","partly-cloudy-day":"data:image/svg+xml;base64,","partly-cloudy-night":"data:image/svg+xml;base64,","pressure-high":"data:image/svg+xml;base64,",rain:"data:image/svg+xml;base64,",raindrop:"data:image/svg+xml;base64,",raindrops:"data:image/svg+xml;base64,",sleet:"data:image/svg+xml;base64,",snow:"data:image/svg+xml;base64,","sun-hot":"data:image/svg+xml;base64,","thermometer-colder":"data:image/svg+xml;base64,","thermometer-warmer":"data:image/svg+xml;base64,",thunderstorms:"data:image/svg+xml;base64,","thunderstorms-rain":"data:image/svg+xml;base64,","uv-index":"data:image/svg+xml;base64,","weather-alarm":"data:image/svg+xml;base64,",wind:"data:image/svg+xml;base64,","wind-alert":"data:image/svg+xml;base64,"},be=new Set(["","unknown","unavailable"]),we=["temperature","precipitation_probability"],Te=new Set(["meteocons","custom"]),Oe={temp:"temperature",temperature:"temperature",rain_chance:"precipitation_probability",precipitation_probability:"precipitation_probability",precip_probability:"precipitation_probability",probability:"precipitation_probability",pop:"precipitation_probability",rain:"precipitation",precipitation:"precipitation",humidity:"humidity",hum:"humidity",wind:"wind_speed",wind_speed:"wind_speed",gust:"wind_gust_speed",wind_gust:"wind_gust_speed",wind_gust_speed:"wind_gust_speed",uv:"uv_index",uv_index:"uv_index",cloud:"cloud_coverage",clouds:"cloud_coverage",cloud_coverage:"cloud_coverage"},xe={"clear-night":"clear-night",cloudy:"cloudy",exceptional:"weather-alarm",fog:"fog",hail:"hail",lightning:"thunderstorms","lightning-rainy":"thunderstorms-rain",partlycloudy:"partly-cloudy-day",pouring:"rain",rainy:"rain",snowy:"snow","snowy-rainy":"sleet",sunny:"clear-day",windy:"wind","windy-variant":"wind-alert"},ve=new Map;function Se(i){return i<=0?"#3aa7ff":i<=8?"#50c5d8":i<=15?"#9bd57b":i<=22?"#ffd34a":i<=28?"#ff9d24":"#ff5d38"}function Le(i,e){var t;if(e&&(null==i?void 0:i.hass))return null===(t=i.hass.states)||void 0===t?void 0:t[e]}function ke(i,e){var t,a;const n=Le(i,e),o=null===(t=null==n?void 0:n.attributes)||void 0===t?void 0:t.friendly_name;return"string"==typeof o&&o.trim()?o.trim():(null===(a=String(e||"").split(".").pop())||void 0===a?void 0:a.replace(/_/g," ").replace(/\b\w/g,(i=>i.toUpperCase())))||"Forecast"}function Ce(i){const e=void 0===(null==i?void 0:i.state)||null===(null==i?void 0:i.state)?"":String(i.state);return be.has(e.toLowerCase())?"":e}function _e(i,e){const t=Ce(Le(i,e));if(!t)return;const a=Number(t);return Number.isFinite(a)?a:void 0}function fe(i,e,t=!1){if(null==i||""===i)return"—";const a=Number(i);return Number.isFinite(a)?t&&Math.abs(a)>=1e3?`${(a/1e3).toFixed(1)}k`:a.toFixed(e):String(i)}function Ye(i,e){var t;const a=Le(i,e),n=Ce(a);if(!n)return"—";const o=(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.unit_of_measurement)||"",r=Number(n);if(!Number.isFinite(r))return o?`${n} ${o}`:n;const c=fe(r,Number.isInteger(r)?0:1);return o?`${c} ${o}`:c}function Qe(i,e){const t=_e(i,e);return void 0===t?"—°":`${t.toFixed(1)}°`}function Ee(i,e,t){const a=Number(i);if(Number.isFinite(a)&&!(a<=0))return Math.max(e,Math.min(t,a))}function Ue(i){if(!i)return"Weather";const e={"clear-night":"Clear night",partlycloudy:"Partly cloudy","lightning-rainy":"Storm rain","snowy-rainy":"Sleet","windy-variant":"Windy"};return e[i]?e[i]:i.replace(/[-_]/g," ").replace(/\b\w/g,(i=>i.toUpperCase()))}function Ze(i){return(i||"unknown").replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function Ge(i){return xe[i]||"partly-cloudy-day"}function We(i){return Ae[i]}function Pe(i,e){const t=i.replace(/\/+$/,""),a=e.replace(/^\/+/,"");return t?`${t}/${a}`:a}function $e(i,e,t,a,n="img"){const o="string"==typeof i?void 0:i,r=o?function(i){const e=String(i.icon_set||"").trim().toLowerCase();return Te.has(e)?e:"meteocons"}(o):i,c=o&&"custom"===r?function(i,e){const t=i.icon_pack||{},a=(t.icons||i.icon_map||{})[e],n=String(t.base_path||i.icon_base_path||"").trim();if(a){const i=String(a).trim();return i?function(i){return/^(data:|https?:\/\/|\/\/|\/)/i.test(i)}(i)||!n?i:Pe(n,i):""}return n?Pe(n,`${e}.${String(t.extension||i.icon_extension||"svg").trim().replace(/^\./,"")||"svg"}`):""}(o,e):"";if(c)return E`
      <img
        ...
        draggable="false"
      />
    `;const s=We(e);if("inline"===n){const i=function(i){const e=ve.get(i);if(void 0!==e)return e;const[,t]=String(We(i)||"").split("base64,");let a="";if(t&&"function"==typeof atob)try{a=atob(t)}catch(i){a=""}return ve.set(i,a),a}(e);return i?E`
    ...
    <img
      ...
      draggable="false"
    />
  `}function Re(i,e){return i&&i.includes(":")?i:e}function Ve(i,e){const t=function(i,e){const t=Number.isFinite(Number(e.rain_rate_threshold))?Number(e.rain_rate_threshold):0,a=_e(i,e.rain_rate_sensor);return void 0!==a?a>t:"on"===Ce(Le(i,e.rain_state_sensor)).toLowerCase()}(i,e),a=e.name||"Rain",n=e.rain_state_sensor||e.rain_rate_sensor,o=t?Re(e.icon_active||e.icon,"mdi:weather-rainy"):Re(e.icon_inactive||e.icon,"mdi:water-off-outline");let r;if(t){const t=function(i,e,t,a=!1){var n;const o=Le(i,e),r=Ce(o);if(!r)return"—";const c=(null===(n=null==o?void 0:o.attributes)||void 0===n?void 0:n.unit_of_measurement)||"",s=fe(r,t,a);return c?`${s} ${c}`:s}(i,e.rain_rate_sensor,1);r="—"===t?"Raining":t}else r="No rain";return{label:a,value:r,entity:n,stateEntity:n,active:t,mdi:o}}function Fe(i){return Array.isArray(i)?i.filter((i=>!!i&&"object"==typeof i)).map((i=>({condition:"string"==typeof i.condition?i.condition:void 0,datetime:"string"==typeof i.datetime?i.datetime:void 0,temperature:i.temperature,precipitation_probability:i.precipitation_probability,precipitation:i.precipitation,humidity:i.humidity,wind_speed:i.wind_speed,wind_gust_speed:i.wind_gust_speed,uv_index:i.uv_index,cloud_coverage:i.cloud_coverage,templow:i.templow}))):[]}function Be(i,e){if(!e.datetime)return"";const t=new Date(e.datetime);if(Number.isNaN(t.getTime()))return"";const{locale:a,options:n}=function(i){var e;const t=null===(e=null==i?void 0:i.hass)||void 0===e?void 0:e.locale,a=String((null==t?void 0:t.time_format)||"").toLowerCase(),n={hour:"2-digit",minute:"2-digit"};return"12"===a&&(n.hour12=!0),"24"===a&&(n.hour12=!1),{locale:null==t?void 0:t.language,options:n}}(i);return new Intl.DateTimeFormat(a,n).format(t)}function He(i,e){const t=ot(i,e.datetime),a=Be(i,e);return t?a?`${t} ${a}`:t:a}function Je(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function Xe(i){if(!i.datetime)return;const e=new Date(i.datetime).getTime();return Number.isFinite(e)?e:void 0}function Ke(i,e,t){const a=i.reduce(((i,t,a)=>{const n=Je(t,e);if(void 0===n)return i;const o=Xe(t),r={item:t,index:a,value:n};return void 0!==o&&(r.timestamp=o),i.push(r),i}),[]);if(!a.length)return{points:[],min:0,max:1};const n=a.every((i=>Number.isFinite(i.timestamp))),o=n?[...a].sort(((i,e)=>Number(i.timestamp)-Number(e.timestamp))):a,r=n?Number(o[0].timestamp):0,c=(n?Number(o[o.length-1].timestamp):0)-r,s=a.map((i=>i.value)),{min:l,max:M}=function(i,e){if("precipitation_probability"===i)return{min:0,max:100};let t=Math.min(...e),a=Math.max(...e);if("temperature"===i)t=5*Math.floor((t-2)/5),a=5*Math.ceil((a+2)/5);else{const i=Math.max(.18*(a-t),1);t=Math.max(0,t-i),a+=i}return a<=t&&(a=t+1),{min:t,max:a}}(e,s),g=t.width-t.left-t.right,d=t.height-t.top-t.bottom,N=o.map(((i,e)=>{const a=n&&c>0?t.left+(Number(i.timestamp)-r)/c*g:1===o.length?t.left+g/2:t.left+e/(o.length-1)*g,s=t.top+(M-i.value)/(M-l)*d;return Object.assign(Object.assign({},i),{x:a,y:s})}));return{points:N,min:l,max:M}}function qe(i){return i<=0?[]:Array.from(new Set([0,Math.floor((i-1)/3),Math.floor(2*(i-1)/3),i-1])).filter((e=>e>=0&&e<i))}function it(i,e,t){const a=function(i,e){if(e<=0)return[];if(i.length<=e)return i;if(1===e)return[i[0]];const t=[];let a=-1;for(let n=0;n<e;n+=1){const o=e-n-1,r=i.length-1-o,c=Math.round(n*(i.length-1)/(e-1)),s=Math.max(a+1,Math.min(r,c));t.push(i[s]),a=s}return t}(i,e);if(!a.length)return[];const n=t.width-t.left-t.right;return 1===a.length?[{point:a[0],x:t.left+n/2}]:a.map(((i,e)=>({point:i,x:t.left+e/(a.length-1)*n})))}function et(i){return i.replace(/[^a-z0-9_-]/gi,"-").toLowerCase()}function tt(i){if(!i.length)return"";if(1===i.length)return`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;let e=`M ${i[0].x.toFixed(2)} ${i[0].y.toFixed(2)}`;for(let t=0;t<i.length-1;t+=1){const a=i[t],n=i[t+1],o=i[t-1]||a,r=i[t+2]||n,c=a.x+(n.x-o.x)/6,s=a.y+(n.y-o.y)/6,l=n.x-(r.x-a.x)/6,M=n.y-(r.y-a.y)/6;e+=` C ${c.toFixed(2)} ${s.toFixed(2)}, ${l.toFixed(2)} ${M.toFixed(2)}, ${n.x.toFixed(2)} ${n.y.toFixed(2)}`}return e}function at(i,e){if(!i.length)return"";const t=i[0],a=i[i.length-1];return`${tt(i)} L ${a.x.toFixed(2)} ${e.toFixed(2)} L ${t.x.toFixed(2)} ${e.toFixed(2)} Z`}function nt(i){if(!i)return"";const e=new Date(i);if(Number.isNaN(e.getTime()))return"";return`${e.getFullYear()}-${`${e.getMonth()+1}`.padStart(2,"0")}-${`${e.getDate()}`.padStart(2,"0")}`}function ot(i,e){var t,a;if(!e)return"";const n=new Date(e);return Number.isNaN(n.getTime())?"":new Intl.DateTimeFormat(null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.locale)||void 0===a?void 0:a.language,{day:"numeric",month:"long"}).format(n)}function rt(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:void 0}function ct(i,e,t){return Math.max(0,Math.min(100,(i-e)/(t-e)*100))}function st(i){return Ee(i.graph_height,82,260)||118}function lt(i,e,t,a){const n=t.slice(0,7);if(!n.length)return G;const o=function(i){const e=new Map;return i.forEach(((i,t)=>{const a=nt(i.datetime),n=Je(i,"temperature");if(!a||void 0===n)return;const o={item:i,value:n,x:0,y:0,index:t},r=e.get(a)||{};(!r.low||n<r.low.value)&&(r.low=o),(!r.high||n>r.high.value)&&(r.high=o),e.set(a,r)})),e}(a),{min:r,max:c}=function(i,e){const t=[];if(i.forEach((i=>{const e=rt(i,"templow"),a=rt(i,"temperature");void 0!==e&&t.push(e),void 0!==a&&t.push(a)})),e.forEach((i=>{const e=Je(i,"temperature");void 0!==e&&t.push(e)})),!t.length)return{min:0,max:1};const a=5*Math.floor((Math.min(...t)-2)/5);let n=5*Math.ceil((Math.max(...t)+2)/5);return n<=a&&(n=a+1),{min:a,max:n}}(n,a),s=nt((new Date).toISOString()),l=function(i,e){return _e(i,e.temp_sensor)}(i,e);return E`
    <section class="weather-daily-forecast">
      ...
      ${n.map((t=>{var a,n,M,g;const d=nt(t.datetime),N=o.get(d),I=null!==(a=rt(t,"templow"))&&void 0!==a?a:null===(n=null==N?void 0:N.low)||void 0===n?void 0:n.value,u=null!==(M=rt(t,"temperature"))&&void 0!==M?M:null===(g=null==N?void 0:N.high)||void 0===g?void 0:g.value;if(void 0===I||void 0===u)return G;const h=ct(I,r,c),D=ct(u,r,c),j=Math.max(4,D-h),y=String(t.condition||""),z=Number(t.precipitation_probability),p=Number.isFinite(z)?`Rain ${Math.round(z)}%`:"",m=d===s&&void 0!==l?ct(l,r,c):void 0;return E`
          <div class="weather-daily-row">
            <div class="weather-daily-day">
              <span class="weather-daily-day-name">${function(i,e){var t,a;if(!e)return"";const n=new Date(e);if(Number.isNaN(n.getTime()))return"";const o=nt((new Date).toISOString()),r=new Date;r.setDate(r.getDate()+1);const c=nt(e);return c===o?"Today":c===nt(r.toISOString())?"Tomorrow":new Intl.DateTimeFormat(null===(a=null===(t=null==i?void 0:i.hass)||void 0===t?void 0:t.locale)||void 0===a?void 0:a.language,{weekday:"long"}).format(n)}(i,t.datetime)}</span>
              <span class="weather-daily-date">${ot(i,t.datetime)}</span>
            </div>
            <div class="weather-daily-condition">
              ${$e(e,Ge(y),`weather-daily-icon weather-condition-${Ze(y)}`,Ue(y))}
              ${p?E`<span title="Chance of precipitation">${p}</span>`:G}
            </div>
            <div class="weather-daily-low">
              <span>${I.toFixed(0)}°</span>
              ${(null==N?void 0:N.low)?E`<small>${Be(i,N.low.item)}</small>`:G}
            </div>
            ...
            <div class="weather-daily-high">
              ...
              ${(null==N?void 0:N.high)?E`<small>${Be(i,N.high.item)}</small>`:G}
            </div>
          </div>
        `}))}
    </section>
  `}function Mt(i,e){const t=Number(i[e]);return Number.isFinite(t)?t:0}function gt(i){return i.find((i=>{const e=Mt(i,"precipitation_probability");return Mt(i,"precipitation")>0||e>=30||(t=i.condition,["pouring","rainy","lightning-rainy","snowy","snowy-rainy","hail"].includes(String(t||"").toLowerCase()));var t}))}function dt(i,e,t){const a=Mt(e,"precipitation_probability"),n=Mt(e,"precipitation"),o=Be(i,e),r=e===t?"now":o?`around ${o}`:"later",c=function(i){const e=String(i||"").toLowerCase();return e.includes("snow")?"Snow":e.includes("hail")?"Hail":"Rain"}(e.condition),s=c.toLowerCase();return a>0?`${c} is ${a>=65?"likely":"possible"} ${r}, about a ${Math.round(a)}% chance.`:n>0?`${c} is expected ${r}, around ${n.toFixed(1)} mm.`:`${Ue(String(e.condition||s))} is expected ${r}.`}function Nt(i,e,t=[]){if(!e.length)return"";const a=e[0],n=[`${Ue(String(a.condition||""))} and ${o=a,`${fe(o.temperature,0)}°`}.`];var o;const r=function(i){if(!i)return"";const e=rt(i,"templow"),t=rt(i,"temperature");return void 0===e&&void 0===t?"":void 0!==e&&void 0!==t?`High near ${t.toFixed(0)}°, low near ${e.toFixed(0)}°.`:void 0!==t?`High near ${t.toFixed(0)}°.`:`Low near ${Number(e).toFixed(0)}°.`}(t[0]);r&&n.push(r);const c=gt(function(i,e){const t=Date.now(),a=t+60*e*60*1e3,n=i.filter((i=>{const e=Xe(i);return void 0===e||e>=t-36e5&&e<=a}));return n.length?n:i.slice(0,e)}(e,12));return c&&n.push(dt(i,c,a)),n.join(" ")}function It(i){i.stopPropagation()}function ut(i,e,t){e.preventDefault(),e.stopPropagation(),t&&"function"==typeof(null==i?void 0:i._openMoreInfo)&&i._openMoreInfo(t)}function ht(i,e,t){"Enter"!==e.key&&" "!==e.key||ut(i,e,t)}function Dt(i,e,t,a){e.preventDefault(),e.stopPropagation(),t&&a&&"function"==typeof(null==i?void 0:i._setWeatherForecastSourceSelection)&&i._setWeatherForecastSourceSelection(t,a)}function jt(i,e,t,a,n){if(e.stopPropagation(),!a.length||"function"!=typeof(null==i?void 0:i._setWeatherForecastGraphSelection))return;const o=e.currentTarget.getBoundingClientRect();if(!o.width)return;const r=(e.clientX-o.left)/o.width,c=Math.max(0,Math.min(n.width,r*n.width)),s=a.reduce(((i,e,t)=>{const n=a[i];return Math.abs(e.x-c)<Math.abs(n.x-c)?t:i}),0);t.forEach((e=>i._setWeatherForecastGraphSelection(e,s)))}function yt(i,e,t){const a="function"==typeof(null==i?void 0:i._getWeatherForecastGraphSelection)?i._getWeatherForecastGraphSelection(e):void 0,n=function(i){const e=Date.now();let t=0,a=Number.POSITIVE_INFINITY;return i.forEach(((i,n)=>{const o=i.item.datetime?new Date(i.item.datetime).getTime():Number.NaN;if(!Number.isFinite(o))return;const r=Math.abs(o-e);r<a&&(a=r,t=n)})),t}(t);return t[Math.max(0,Math.min(t.length-1,Number.isFinite(Number(a))?Number(a):n))]||t[0]}function zt(i,e,t,a){const n=e.height-e.bottom;return[...[0,1,2].map((i=>{const t=e.top+i*((n-e.top)/2);return U`<line class="weather-conditions-grid-line" x1=${e.left} x2=${e.width-e.right} y1=${t} y2=${t}></line>`})),...t.map((t=>{const o=a[t],r=0===t?" weather-conditions-time-label-start":t===a.length-1?" weather-conditions-time-label-end":"";return U`
        <line class="weather-conditions-time-line" x1=${o.x} x2=${o.x} y1=${e.top} y2=${n}></line>
        <text class=${`weather-conditions-time-label${r}`} x=${o.x} y=${e.height-6}>${He(i,o.item)}</text>
      `}))]}function pt(i,e,t,a,n){const o={width:360,height:st(e),left:14,right:30,top:15,bottom:24},{points:r,min:c,max:s}=Ke(t,"temperature",o);if(r.length<2)return G;const l=o.height-o.bottom,M=yt(i,a,r),g=r.reduce(((i,e)=>e.value<i.value?e:i),r[0]),d=r.reduce(((i,e)=>e.value>i.value?e:i),r[0]),N=qe(r.length),I=it(r,function(i){const e=Number(i.temperature_icon_count);return Number.isFinite(e)?Math.max(0,Math.min(72,Math.floor(e))):8}(e),o),u=tt(r),h=at(r,l),D=et(a),j=`weather-conditions-temp-line-${D}`,y=`weather-conditions-temp-fill-${D}`,z=(c+s)/2;return E`
    <section class="weather-conditions-card weather-conditions-temp">
        ...
        <div class="weather-conditions-icons">
          ${I.map((i=>{const t=String(i.point.item.condition||""),a=i.x/o.width*100;return E`
              <span class="weather-conditions-icon-slot" style=${`left:${a.toFixed(2)}%;`}>
                ${$e(e,Ge(t),`weather-conditions-icon weather-condition-${Ze(t)}`,Ue(t))}
              </span>
            `}))}
        </div>
      `:G}
      ...
      <div class="weather-conditions-chart-frame">
        <svg
          ...
          @pointerdown=${It}
          @pointermove=${e=>jt(i,e,n,r,o)}
          @click=${e=>jt(i,e,n,r,o)}
        >
          <defs>
  ...
  `}function mt(i,e,t,a,n,o){if(t.length<2)return G;const r=`${n}-temperature`,c=`${n}-precipitation`,s=o?[r,c]:null,l=a.includes("temperature")?pt(i,e,t,r,s||[r]):G,M=a.includes("precipitation_probability")?function(i,e,t,a,n){const o={width:360,height:st(e),left:14,right:30,top:10,bottom:22},{points:r}=Ke(t,"precipitation_probability",o);if(r.length<2)return G;const c=o.height-o.bottom,s=yt(i,a,r),l=qe(r.length),M=tt(r),g=at(r,c),d=`weather-conditions-rain-fill-${et(a)}`;return E`
  ...
  `}function At(i,e){var t,a;const n=Array.isArray(e.forecast_sources)?e.forecast_sources.filter((i=>null==i?void 0:i.entity)):[],o=e.selected_forecast_entity||e.forecast_entity||e.entity,r=n.find((i=>i.entity===o)),c=(null==r?void 0:r.name)||ke(i,o),s=Ce(Le(i,o)).toLowerCase(),l=e.name||"Weather",M=Qe(i,e.temp_sensor),g=function(i,e){const t=_e(i,e);return void 0===t?"—%":`${t.toFixed(0)}%`}(i,e.humidity_sensor),d=Qe(i,e.feels_like_sensor),N=function(i,e){const t=Array.isArray(e.metrics)&&e.metrics.length?e.metrics:function(i){const e=[{entity:i.wind_speed_sensor,name:"Wind"},{entity:i.wind_gust_sensor,name:"Gust"},{entity:i.temp_min_24h_sensor,name:"24h Min"},{entity:i.temp_max_24h_sensor,name:"24h Max"},{entity:i.uv_sensor,name:"UV"},{entity:i.solar_lux_sensor,name:"Solar"},{entity:i.pressure_sensor,name:"Pressure"}].filter((i=>i.entity));return(i.rain_state_sensor||i.rain_rate_sensor)&&e.splice(4,0,{type:"rain",name:"Rain",rain_state_sensor:i.rain_state_sensor,rain_rate_sensor:i.rain_rate_sensor,rain_rate_threshold:i.rain_rate_threshold}),e}(e);return t.filter((i=>i&&("rain"===i.type?i.rain_state_sensor||i.rain_rate_sensor:i.entity))).map((e=>{var t;if("rain"===e.type)return Ve(i,e);const a=Le(i,e.entity);return{label:e.name||(null===(t=null==a?void 0:a.attributes)||void 0===t?void 0:t.friendly_name)||e.entity||"",value:Ye(i,e.entity),entity:e.entity,mdi:e.icon||void 0,stateEntity:e.entity}}))}(i,e),I=!1===e.show_forecast?[]:Fe(e.forecast),u=!1===e.show_forecast?[]:Fe(e.daily_forecast),h=!1!==e.show_forecast&&n.length>1,D=Number(e.forecast_slots),j=Number.isFinite(D)&&D>0?Math.min(Math.floor(D),72):8,y=function(i){const e=Array.isArray(i)?i:"string"==typeof i?i.split(","):we,t=[];return e.forEach((i=>{const e=Oe[String(i||"").trim().toLowerCase().replace(/[-\s]/g,"_")];e&&!t.includes(e)&&t.push(e)})),t.length?t:we}(e.forecast_fields),z=I.slice(0,j),p=Nt(i,I,u),m=String((null===(t=I[0])||void 0===t?void 0:t.condition)||s||"").toLowerCase(),A=m||s,b=`weather-icon weather-condition-${Ze(A)}`,w=p||Ue(m||s),T=h?`${c}: ${w}`:w,O=E`<span class="weather-source-badge" title=${`Forecast data: ${c}`} aria-label=${`Forecast data: ${c}`}></span>`,x=e.forecast_graph_key||`weather-${e.entity||l}`,v=!1!==e.sync_graphs,S=mt(i,e,z,y,x,v),L=lt(i,e,u,I),k=Array.isArray(e.chips)?e.chips:[],C=Ee(null!==(a=e.temp_size)&&void 0!==a?a:e.temperature_size,18,56),_=Ee(e.icon_size,28,160),f=Ee(e.graph_height,82,260),Y=Number(e.icon_offset_x),Q=Number(e.icon_offset_y),U=Ee(e.conditions_icon_size,8,48),Z=Ee(e.daily_icon_size,8,48),W=Number(e.metric_columns),P=Number.isFinite(W)&&W>0?Math.max(1,Math.min(4,Math.round(W))):3,$=function(i,e){const t=Number(e.stale_minutes);if(!Number.isFinite(t)||t<=0)return!1;const a=[e.entity,e.temp_sensor,e.humidity_sensor,e.feels_like_sensor].filter(Boolean);let n=0;return a.forEach((e=>{const t=Le(i,e),a=(null==t?void 0:t.last_updated)?Date.parse(t.last_updated):NaN;Number.isFinite(a)&&(n=Math.max(n,a))})),!!n&&Date.now()-n>6e4*t}(i,e),R=[C?`--weather-temp-size:${C}px;`:"",_?`--weather-icon-size:${_}px;--weather-icon-bg-size:${_+16}px;`:"",Number.isFinite(Y)?`--weather-icon-x:${Y}px;`:"",Number.isFinite(Q)?`--weather-icon-y:${Q}px;`:"",U?`--weather-conditions-icon-size:${U}px;`:"",Z?`--weather-daily-icon-size:${Z}px;`:"",f?`--weather-graph-height:${f}px;`:"",`--weather-metric-columns:${P};`].filter(Boolean).join("");return E`
    <div class=${"tile-wrap weather-tile-wrap"+($?" weather-tile-stale":"")} style=${R}>
      <div class="weather-tile">
          ...
          <div class="weather-top">
            <div class="weather-heading">
              <div
                ...
                role="button"
                tabindex="0"
                aria-label=${`Open ${c} weather forecast details`}
                @pointerdown=${It}
                @pointerup=${It}
                @click=${e=>ut(i,e,o)}
                @keyup=${e=>ht(i,e,o)}
              >
                <div class="weather-name">${w}</div>
                ${I.length?O:G}
              </div>
              ${h?E`
                <div class="weather-source-picker" role="tablist" aria-label="Weather forecast source">
                  ${n.map((t=>{const a=t.entity===o,n=t.name||ke(i,t.entity);return E`
                      <button
              ...
              <div class="weather-primary">
                ...
                <span
                  ...
                  @keyup=${t=>ht(i,t,e.humidity_sensor)}
                >${g}</span>
              </div>
              <div
                ...
                @keyup=${t=>ht(i,t,e.feels_like_sensor)}
              >Feels like ${d}</div>
            </div>
            <div class="weather-icon-wrap" aria-hidden="true">
              ${e.icon?E`<ha-icon class=${b} .icon=${e.icon}></ha-icon>`:$e(e,Ge(A),b,Ue(A),"inline")}
            </div>
          </div>
          ...
          <div class="weather-grid">
            ${N.map((e=>E`
              <div
                ...
                @pointerdown=${It}
                @pointerup=${It}
                @click=${t=>ut(i,t,e.entity)}
                @keyup=${t=>ht(i,t,e.entity)}
              >
        ...
        ${k.length?E`<div class="weather-chips-bottom-right">
              ${k.map((e=>E`
                <div
                  ...
                  @keyup=${t=>ht(i,t,(null==e?void 0:e.entity)||(null==e?void 0:e.tap_entity))}
                >
                  ${Ne(i,e)}
                </div>
              `))}
